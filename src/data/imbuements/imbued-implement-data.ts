...
export class ImbuedImplementData {
	static berserking: ImbuementInterface = ElementFactory.createImbuement({
	...
	static displacingI: ImbuementInterface = ElementFactory.createImbuement({
		type: ItemType.ImbuedImplement,
		crafting: ElementFactory.createProject({
	...
	static elemental: ImbuementInterface = ElementFactory.createImbuement({
		type: ItemType.ImbuedImplement,
		crafting: ElementFactory.createProject({
	...
	static forcefulI: ImbuementInterface = ElementFactory.createImbuement({
		type: ItemType.ImbuedImplement,
		crafting: ElementFactory.createProject({
	...
	static ratForm: ImbuementInterface = ElementFactory.createImbuement({
		type: ItemType.ImbuedImplement,
		crafting: ElementFactory.createProject({
			...
			ability: ElementFactory.createAbility({
				...
				sections: [
					ElementFactory.createAbilitySectionText(
						'You transform into a rat. Your equipment transforms with you. As a rat, you have speed 5 and can automatically climb at full speed while moving, your size is 1T, and you can see in the dark. You can speak and keep your skills while in rat form, but your Might is −5 and you lose all your regular abilities, features, and benefits. You can revert to your natural form as a maneuver, and do so automatically if you take any damage.'
					),
				],
			}),
		}),
	...
	static rejuvenatingI: ImbuementInterface = ElementFactory.createImbuement({
		type: ItemType.ImbuedImplement,
		crafting: ElementFactory.createProject({
	...
	static seeking: ImbuementInterface = ElementFactory.createImbuement({
		type: ItemType.ImbuedImplement,
		crafting: ElementFactory.createProject({
	...
	static thoughtSending: ImbuementInterface = ElementFactory.createImbuement({
		type: ItemType.ImbuedImplement,
		crafting: ElementFactory.createProject({
	...
	static wardingI: ImbuementInterface = ElementFactory.createImbuement({
		type: ItemType.ImbuedImplement,
		crafting: ElementFactory.createProject({
	...
	static celerity: ImbuementInterface = ElementFactory.createImbuement({
		type: ItemType.ImbuedImplement,
		crafting: ElementFactory.createProject({
	...
	static celestine: ImbuementInterface = ElementFactory.createImbuement({
		type: ItemType.ImbuedImplement,
		crafting: ElementFactory.createProject({
	...
	static displacingII: ImbuementInterface = ElementFactory.createImbuement({
		type: ItemType.ImbuedImplement,
		crafting: ElementFactory.createProject({
		...
		feature: ElementFactory.FeatureFactory.create({
			...
			name: 'Displacing II',
			description:
				'When you use the implement’s Displacing I enhancement, you can teleport the creature up to 4 squares. Additionally, the creature takes a bane on their next power roll made before the end of their next turn',
		}),
	});

	static eruptingI: ImbuementInterface = ElementFactory.createImbuement({
		type: ItemType.ImbuedImplement,
		crafting: ElementFactory.createProject({
	...
	static forcefulII: ImbuementInterface = ElementFactory.createImbuement({
		type: ItemType.ImbuedImplement,
		crafting: ElementFactory.createProject({
		...
		feature: ElementFactory.FeatureFactory.create({
			...
			name: 'Forceful II',
			description:
				'Whenever you use a magic or psionic ability to push or pull a creature, you can move that creature an additional 3 squares. This replaces the benefit of Forceful I.',
		}),
	});

	static hallucinatory: ImbuementInterface = ElementFactory.createImbuement({
		type: ItemType.ImbuedImplement,
		crafting: ElementFactory.createProject({
		...
		feature: ElementFactory.FeatureFactory.createAbility({
			ability: ElementFactory.createAbility({
				...
				sections: [
					ElementFactory.createAbilitySectionText(
						'You create an area of sensory instability in a 2 aura centered on yourself. The area is difficult terrain for your enemies until the end of the encounter.'
					),
				],
			}),
		}),
	...
	static lingeringI: ImbuementInterface = ElementFactory.createImbuement({
		type: ItemType.ImbuedImplement,
		crafting: ElementFactory.createProject({
	...
	static rejuvenatingII: ImbuementInterface = ElementFactory.createImbuement({
		type: ItemType.ImbuedImplement,
		crafting: ElementFactory.createProject({
		...
		feature: ElementFactory.FeatureFactory.create({
			...
			description:
				'Whenever you use an ability that costs 1 or more of your Heroic Resource, roll a d10. On an 8 or higher, you gain 1 Heroic Resource and you can spend a Recovery. This replaces the benefit of Rejuvenating I.',
		}),
	});

	static wardingII: ImbuementInterface = ElementFactory.createImbuement({
		type: ItemType.ImbuedImplement,
		crafting: ElementFactory.createProject({
		...
		feature: ElementFactory.FeatureFactory.createMultiple({
			...
			features: [
				...
				ElementFactory.FeatureFactory.create({
					...
					name: 'Warding II',
					description:
						'Your characteristic scores are considered 1 higher for the purpose of resisting potencies.',
				}),
			],
		}),
	});

	static anathema: ImbuementInterface = ElementFactory.createImbuement({
		type: ItemType.ImbuedImplement,
		crafting: ElementFactory.createProject({
	...
	static displacingIII: ImbuementInterface = ElementFactory.createImbuement({
		type: ItemType.ImbuedImplement,
		crafting: ElementFactory.createProject({
		...
		feature: ElementFactory.FeatureFactory.create({
			...
			name: 'Displacing III',
			description:
				'When you use the implement’s Displacing I enhancement, you can teleport the creature up to 5 squares. Additionally, the creature takes a bane on their next power roll made before the end of their next turn.',
		}),
	});

	static eruptingII: ImbuementInterface = ElementFactory.createImbuement({
		type: ItemType.ImbuedImplement,
		crafting: ElementFactory.createProject({
	...
	static forcefulIII: ImbuementInterface = ElementFactory.createImbuement({
		type: ItemType.ImbuedImplement,
		crafting: ElementFactory.createProject({
		...
		feature: ElementFactory.FeatureFactory.create({
			...
			name: 'Forceful III',
			description:
				'Whenever you use a magic or psionic ability to push or pull a creature, you can move that creature an additional 3 squares and that movement can be vertical. This replaces the benefit of Forceful II.',
		}),
	});

	static lingeringII: ImbuementInterface = ElementFactory.createImbuement({
		type: ItemType.ImbuedImplement,
		crafting: ElementFactory.createProject({
	...
	static piercing: ImbuementInterface = ElementFactory.createImbuement({
		type: ItemType.ImbuedImplement,
		crafting: ElementFactory.createProject({
	...
	static psionicSiphon: ImbuementInterface = ElementFactory.createImbuement({
		type: ItemType.ImbuedImplement,
		crafting: ElementFactory.createProject({
	...
	static rejuvenatingIII: ImbuementInterface = ElementFactory.createImbuement({
		type: ItemType.ImbuedImplement,
		crafting: ElementFactory.createProject({
		...
		feature: ElementFactory.FeatureFactory.create({
			...
			description:
				'Whenever you use an ability that costs 1 or more of your Heroic Resource, roll a d10. On a 7 or higher, you gain 1 Heroic Resource, and you or a creature of your choice within 3 squares can spend a Recovery. This replaces the benefit of Rejuvenating II.',
		}),
	});

	static wardingIII: ImbuementInterface = ElementFactory.createImbuement({
		type: ItemType.ImbuedImplement,
		crafting: ElementFactory.createProject({
		...
		feature: ElementFactory.FeatureFactory.createMultiple({
			...
			features: [
				...
				ElementFactory.FeatureFactory.create({
					...
					name: 'Warding III',
					description:
						'You and each ally within 3 squares of you has their characteristic scores considered 1 higher for the purpose of resisting potencies. This replaces the benefit of Warding II.',
				}),
			],
		}),
	});
