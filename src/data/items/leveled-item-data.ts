...
export class LeveledItemData {
	static bloodboundBand: ItemInterface = ElementFactory.createItem({
		...
		featuresByLevel: [
			{
				...
				features: [
					ElementFactory.FeatureFactory.create({
						...
						name: '',
						description:
							'During a respite, you can touch the ring to any number of other Bloodbound Bands worn by willing creatures to form a bond among all of you. Creatures related by blood can’t form bonds in this way. Bonded creatures can each use the highest recovery value of any bonded creature in place of their own, and can spend each other’s Recoveries as if they were their own. Whenever any other bonded creature takes damage, each bonded creature takes 1 damage that can’t be reduced in any way. Your bond ends if you remove the ring, use it to bond with one or more other creatures, or die, but other rings continue to be bonded to each other.',
					}),
			...
			},
			{
				...
				features: [
					ElementFactory.FeatureFactory.create({
						...
						name: '',
						description:
							'If a creature bonded with you dies, you can choose to die in their place. Your sacrifice twists fate to remove the creature from danger, and they regain Stamina equal to their winded value. Your ring then teleports into their possession and ceases to be magic.',
					}),
					ElementFactory.FeatureFactory.createBonus({
	...
	static bloodyHandWraps: ItemInterface = ElementFactory.createItem({
		...
		featuresByLevel: [
			{
				...
				features: [
					ElementFactory.FeatureFactory.create({
						...
						name: '',
						description:
							"Once per turn, you can take 5 damage that can't be reduced in any way to use the Grab maneuver (no action required).",
					}),
			...
			},
			{
				...
				features: [
					ElementFactory.FeatureFactory.create({
						...
						name: '',
						description:
							"Once per turn, you can take 10 damage that can't be reduced in any way to make a melee free strike (no action required). On your turn, you can use the wraps’ melee free strike option or Grab maneuver option, but only one.",
					}),
					ElementFactory.FeatureFactory.createAbilityDamage({
			...
			},
			{
				...
				features: [
					ElementFactory.FeatureFactory.create({
						...
						name: '',
						description:
							"Once per turn, you can take 15 damage that can't be reduced in any way to use a signature ability (no action required). On your turn, you can use the wraps’ signature ability option, melee free strike option, or Grab maneuver option, but only one.",
					}),
					ElementFactory.FeatureFactory.createAbilityDamage({
	...
	static lightningTreads: ItemInterface = ElementFactory.createItem({
			...
			},
			{
				...
				features: [
					ElementFactory.FeatureFactory.create({
						...
						name: '',
						description:
							'Any damage-dealing weapon ability using your unarmed strike deals 1 extra lightning damage for each square you move this turn before you use the ability to a maximum bonus of +2.',
					}),
					ElementFactory.FeatureFactory.createAbilityDamage({
			...
			},
			{
				...
				features: [
					ElementFactory.FeatureFactory.create({
						...
						name: '',
						description:
							'The maximum total damage bonus you can earn including movement increase to +3. Additionally, you can use a maneuver to perform a flying lightning kick on one adjacent creature. That target is pushed up to 5 squares, and you can move to any square adjacent to the target after the push.',
					}),
					ElementFactory.FeatureFactory.createAbilityDamage({
						...
						ability: ElementFactory.createAbility({
							...
							sections: [
								ElementFactory.createAbilitySectionText(
									'One adjacent creature is pushed up to 5 squares, and you can move to any square adjacent to the target after the push.'
								),
							],
						}),
					}),
	...
	static revengersWrap: ItemInterface = ElementFactory.createItem({
		...
		featuresByLevel: [
			{
				...
				features: [
					ElementFactory.FeatureFactory.create({
						...
						name: '',
						description:
							'While you wear this cloak, any creature who damages you is marked for revenge until the end of your next turn or until another creature damages you. Any strike you make against a creature marked for revenge deals extra damage equal to your highest characteristic score, and whenever you damage a creature marked for revenge, they are also bleeding until the end of their next turn.',
					}),
				],
			},
			{
				...
				features: [
					ElementFactory.FeatureFactory.create({
						...
						name: '',
						description:
							'Each creature who damages you is marked for revenge until the end of your next turn. Whenever you damage a creature marked for revenge, they are also bleeding (save ends).',
					}),
				],
			},
			{
				...
				features: [
					ElementFactory.FeatureFactory.create({
						...
						name: '',
						description:
							'When you have three or more creatures marked for revenge and you target one of them with an ability that targets only one creature, you target all the creatures marked for revenge, regardless of their distance from you and even if you don’t have line of effect to them.',
					}),
				],
			},
		],
	...
	static thiefOfJoy: ItemInterface = ElementFactory.createItem({
				...
				features: [
					...
					ElementFactory.FeatureFactory.createAbility({
						ability: ElementFactory.createAbility({
							...
							sections: [
								ElementFactory.createAbilitySectionText(
									'You expend your envy or disdain. If you expend envy, you deal damage equal to the triggering damage to a creature adjacent to you. If you expend disdain, you reduce the triggering damage by half. At the end of the encounter, you lose any envy or disdain granted by the torque.'
								),
							],
						}),
					}),
			...
			},
			{
				...
				features: [
					ElementFactory.FeatureFactory.createPackageContent({
						...
						name: '5th',
						description:
							'When the target creature is the same level as you, you gain your choice of envy or disdain.',
