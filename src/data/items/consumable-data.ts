...
export class ConsumableData {
	...
	static blackAshDart: ItemInterface = ElementFactory.createItem({
...
* 17+: You can teleport the target up to 6 squares.`,
	...
	static bloodEssenceVial: ItemInterface = ElementFactory.createItem({
	...
	static buzzBalm: ItemInterface = ElementFactory.createItem({
		id: 'item-buzz-balm',
		name: 'Buzz Balm',
	...
	static catapultDust: ItemInterface = ElementFactory.createItem({
	...
	static giantsBloodFlame: ItemInterface = ElementFactory.createItem({
...
Any fire caused by the oil is extinguished after burning for 1 hour.`,
	...
	static growthPotion: ItemInterface = ElementFactory.createItem({
	...
	static healingPotion: ItemInterface = ElementFactory.createItem({
	...
	static impsTongue: ItemInterface = ElementFactory.createItem({
		id: 'item-imps-tongue',
		name: "Imp's Tongue",
	...
	static lachompTooth: ItemInterface = ElementFactory.createItem({
...
* 17+: You can affect up to seven additional targets with this strike.`,
	...
	static mirrorToken: ItemInterface = ElementFactory.createItem({
	...
	static pocketHomunculus: ItemInterface = ElementFactory.createItem({
...
While you have line of effect to your homunculus, you can use a maneuver to issue them a telepathic command. The homunculus performs the command to the best of their ability. If not commanded, the homunculus mimics your movements and speech. When you move, the homunculus moves with you, matching your pace. The homunculus crumbles to dust after 1 hour or if reduced to 0 Stamina.`,
	...
	static portableCloud: ItemInterface = ElementFactory.createItem({
	...
	static noxiousCloud: ItemInterface = ElementFactory.createItem({
...
Filled with a green or putrid yellow haze, this sphere spreads a choking, foul-smelling mist when broken. Each creature who enters the cloud for the first time in a combat round or starts their turn there takes 5 poison damage. Additionally, any creature is weakened while in the fog.`,
	...
	static thunderheadCloud: ItemInterface = ElementFactory.createItem({
...
Small lightning bolts arc around the black cloud in this sphere, which creates a 3 cube of cloud and lightning when broken. Each creature who enters the cloud for the first time in a combat round or starts their turn there takes 5 lightning damage. Additionally, any creature is slowed while in the cloud`,
	...
	static veratismo: ItemInterface = ElementFactory.createItem({
		id: 'item-veratismo',
	...
	static snapdragon: ItemInterface = ElementFactory.createItem({
		id: 'item-snapdragon',
		name: 'Snapdragon',
	...
	static breathofDawn: ItemInterface = ElementFactory.createItem({
	...
	static bullShot: ItemInterface = ElementFactory.createItem({
		id: 'item-bull-shot',
		name: 'Bull Shot',
	...
	static chocolateofImmovability: ItemInterface = ElementFactory.createItem({
	...
	static concealmentPotion: ItemInterface = ElementFactory.createItem({
	...
	static floatPowder: ItemInterface = ElementFactory.createItem({
	...
	static purifiedJelly: ItemInterface = ElementFactory.createItem({
	...
	static scrollofResurrection: ItemInterface = ElementFactory.createItem({
...
A creature with a willing soul returns to life at the end of the respite with full Stamina and half their Recoveries. You regain only half your Recoveries at the end of the respite, and the scroll is consumed.`,
	...
	static elemagnet: ItemInterface = ElementFactory.createItem({
		id: 'item-telemagnet',
		name: 'Telemagnet',
...
If you pull a size 1T object adjacent to you, you can catch it.`,
	...
	static vialofetherealAttack: ItemInterface = ElementFactory.createItem({
	...
	static anamorphicLarva: ItemInterface = ElementFactory.createItem({
...
At the start of each of your turns, each creature adjacent to the wall takes psychic damage equal to three times their Intuition score, and you can add 1 square to the wall for each creature who takes this damage. If no creature takes damage at the start of your turn, the larva dies and the wall disappears.`,
	...
	static bottledParadox: ItemInterface = ElementFactory.createItem({
	...
	static galliosvisitingCard: ItemInterface = ElementFactory.createItem({
	...
	static personalEffigy: ItemInterface = ElementFactory.createItem({
	...
	static stygianLiquor: ItemInterface = ElementFactory.createItem({
	...
	static timesplitter: ItemInterface = ElementFactory.createItem({
...
* 17+: The target and each creature within 8 squares of them a slowed (save ends).`,
	...
	static wardToken: ItemInterface = ElementFactory.createItem({
		id: 'item-ward-token',
		name: 'Ward Token',
	...
	static wellnessTonic: ItemInterface = ElementFactory.createItem({
	...
	static breathofCreation: ItemInterface = ElementFactory.createItem({
...
Each time you use another Breath of Creation, you can create a new demiplane or expand a demiplane you have already created or visited. The size of an expanded demiplane increases by 20, and you create a second portal to the demiplane with a corresponding portal inside.`,
	...
	static elixirofsaintElspeth: ItemInterface = ElementFactory.createItem({
	...
	static solaris: ItemInterface = ElementFactory.createItem({
		id: 'item-solaris',
	...
	static brightCourt: ItemInterface = ElementFactory.createItem({
		...
		crafting: ElementFactory.createProject({
			prerequisites:
				'A year’s lifespan from the creator or another willing creature, the laughter of a young hero',
			source: 'Texts or lore in Khelt',
