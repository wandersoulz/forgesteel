...
export class CraftingPerkData {
	static areaOfExpertise: PerkInterface = {
	...
	static expertArtisan: PerkInterface = {
	...
	static improvisationCreation: PerkInterface = {
	...
	static inspiredArtisan: PerkInterface = {
	...
	static travellingArtisan: PerkInterface = {
