...
export class InterpersonalPerkData {
	static charmingLiar: PerkInterface = {
	...
	static engrossingMonologue: PerkInterface = {
	...
	static harmonizer: PerkInterface = {
		id: 'perk-harmonizer',
		name: 'Harmonizer',
		description:
	...
	static lieDetector: PerkInterface = {
	...
	static pardonMyFriend: PerkInterface = {
	...
	static powerPlayer: PerkInterface = {
	...
	static spotTheTell: PerkInterface = {
	...
	static peopleSense: PerkInterface = {
		id: 'perk-people-sense',
		name: 'People Sense',
		description:
			'(Beastheart only) While you are within 5 squares of your companion, when you or your companion makes a test to determine a creature’s motives, emotions, or body language, their partner can make the same test as a free triggered action. You both use the higher result.',
		type: FeatureType.Text,
		data: null,
		list: PerkList.Interpersonal,
	};

	static voiceOfTheWild: PerkInterface = {
	...
	static youCanPetThem: PerkInterface = {
		id: 'perk-you-can-pet-them',
		name: "You Can Pet Them, They're Friendly",
		description:
			'(Beastheart only) While you are within 5 squares of your companion, when you make a Presence test to interact with a creature, you can use your companion’s Presence instead of your own.',
		type: FeatureType.Text,
		data: null,
		list: PerkList.Interpersonal,
	};
