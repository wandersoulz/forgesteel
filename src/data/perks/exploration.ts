...
export class ExplorationPerkData {
	...
	static camouflageHunter: PerkInterface = {
	...
	static dangerSense: PerkInterface = {
	...
	static friendCatapult: PerkInterface = {
	...
	static iveGotYou: PerkInterface = {
		id: 'perk-ive-got-you',
		name: "I've Got You",
		...
		data: {
			ability: ElementFactory.createAbility({
				...
				type: ElementFactory.AbilityTypeFactory.createTrigger(
					'A willing ally lands on you or adjacent to you when they fall.',
					{ free: true }
				),
				distance: [ElementFactory.DistanceFactory.createSelf()],
				target: 'Self',
				sections: [
					ElementFactory.createAbilitySectionText(
						'You catch your ally. Neither of you takes damage from the fall.'
					),
				],
			}),
		},
	...
	static monsterWhisperer: PerkInterface = {
	...
	static putYourBackIntoIt: PerkInterface = {
	...
	static teamLeader: PerkInterface = {
		id: 'perk-team-leader',
		name: 'Team Leader',
		description:
	...
	static bornTracker: PerkInterface = {
	...
	static rideAlong: PerkInterface = {
		id: 'perk-ride-along',
		name: 'Ride Along',
...
While riding along with your companion, you can’t act, except to spend a free maneuver to regain your body. You also regain your body if your companion dies or chooses to eject you. When you regain your body, you reappear in a space adjacent to your companion.`),
	...
	static wildRumpus: PerkInterface = {
		id: 'perk-wild-rumpus',
		name: 'Wild Rumpus',
		description: '(Beastheart only)',
		type: FeatureType.Ability,
	...
	static wildsExplorer: PerkInterface = {
		id: 'perk-wilds-explorer',
		name: 'Wilds Explorer',
		description:
			'(Beastheart only) You and your companion have an edge on tests made to overcome environmental cold, heat, weather, unsteady ground, or challenging terrain. During your turn each of you can ignore the extra cost for the first square of difficult terrain you enter.',
		type: FeatureType.Text,
		data: null,
		list: PerkList.Exploration,
	};
