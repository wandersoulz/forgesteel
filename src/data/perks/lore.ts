...
export class LorePerkData {
	static butIKnowWhoDoes: PerkInterface = {
	...
	static eideticMemory: PerkInterface = {
	...
	static expertSage: PerkInterface = {
		id: 'perk-expert-sage',
		name: 'Expert Sage',
		description:
	...
	static iveReadAboutThisPlace: PerkInterface = {
...
If the Director doesn’t have an answer to the question you ask, or doesn’t want to answer, you can instead ask a different question.`,
	...
	static linguist: PerkInterface = {
		id: 'perk-linguist',
		name: 'Linguist',
		description:
			'You have an ear for languages. You automatically learn two new languages, as long as you have regularly heard those languages spoken or seen them written before.',
	...
	static specialist: PerkInterface = {
		id: 'perk-specialist',
		name: 'Specialist',
		description:
	...
	static travellingSage: PerkInterface = {
