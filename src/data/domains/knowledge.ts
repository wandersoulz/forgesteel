...
export const knowledge: DomainInterface = {
	id: 'domain-knowledge',
	name: 'Knowledge',
				...
				ElementFactory.FeatureFactory.createMultiple({
					...
					features: [
						ElementFactory.FeatureFactory.create({
							...
							description:
								'You can interpret diagrams and charts even if you don’t understand the language associated with them. You are considered fluent in all languages for the purpose of understanding the project source for any research or crafting project.',
						}),
					...
					ability: ElementFactory.createAbility({
						...
						sections: [
							...
							ElementFactory.createAbilitySectionText(
								'You can choose to have this ability deal damage to and push objects, and to deal damage to buildings.'
							),
						],
					}),
				}),
		...
		},
		{
			...
			features: [
				ElementFactory.FeatureFactory.create({
					...
					name: 'Gods’ Library',
					description:
						'You can gain access to information you need through prayer, so that you no longer require research materials for crafting and research projects. Additionally, you add your level to project rolls you make for crafting and research projects. You also have any skills in the lore skill group you don’t already have, and you gain a number of skills from any other skill groups equal to the number of skills you had in the lore skill group before you gained this feature.',
				}),
			],
		},
		{
	...
	defaultFeatures: [
		ElementFactory.FeatureFactory.createPackageContent({
			...
			description:
				'Choose up to five allies within 10 squares of you, or choose yourself instead of one ally. Each target gains 1 surge.',
			tag: 'conduit-prayer',
		}),
	],
};
