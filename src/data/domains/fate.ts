...
export const fate: DomainInterface = {
	id: 'domain-fate',
	name: 'Fate',
				...
				ElementFactory.FeatureFactory.createAbility({
					ability: ElementFactory.createAbility({
						...
						sections: [
							...
							ElementFactory.createAbilitySectionText(
								'If this damage kills the target, you and each ally within distance can spend a Recovery.'
							),
						],
					}),
				}),
	...
	resourceGains: [
		{
			...
			tag: '',
			trigger:
				'The first time in an encounter that an ally within 10 squares of you obtains a tier 3 outcome on a power roll or an enemy within 10 squares of you obtains a tier 1 outcome on a power roll',
			value: '2',
		},
	],
	defaultFeatures: [
		ElementFactory.FeatureFactory.createPackageContent({
			...
			description:
				'You call on the forces of fate to create a reliable future. Choose a creature within 10 squares. That creature automatically gets a tier 1 or tier 3 outcome (your choice) on their next power roll made before the end of the encounter.',
			tag: 'conduit-prayer',
		}),
	],
};
