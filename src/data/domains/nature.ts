...
export const nature: DomainInterface = {
	id: 'domain-nature',
	name: 'Nature',
	...
	resourceGains: [
		{
			...
			tag: '',
			trigger:
				'The first time in an encounter that you or a creature within 10 squares takes acid, cold, fire, lightning, poison, or sonic damage',
			value: '2',
		},
	],
	defaultFeatures: [
		ElementFactory.FeatureFactory.createPackageContent({
			...
			description:
				'Vines whip up from the floor or ground within 10 squares, wrapping around a number of creatures of your choice equal to your Intuition score. You can slide each creature up to a number of squares equal to your Intuition score. The vines then fade away.',
			tag: 'conduit-prayer',
		}),
	],
};
