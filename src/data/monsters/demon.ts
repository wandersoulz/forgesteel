...
export const demon: MonsterGroupInterface = {
...
• **Aurumvas** (FIK-ten) (or-UM-vahs) the demon king stands alone among named demons for craving not only wealth, but highly avaricious souls. A towering figure with a stack of crowns atop his ophidian head, he is a vision of opulence, excess, and absolute debasement. He lords over other powerful demons by virtue of the wealth held in his vast vaults in the Abyssal Wasteland, acquired through the slaughter of countless creatures. But even as he gazes upon his riches and supernatural treasures, Aurumvas wants for more. He draws lesser demons and wicked mortals to his service with the promise of minor treasures, knowing full well that one needs to spend wealth to make it. If left unchecked, Aurumvas’s servile armies and glittering hoards might one day encompass the entire timescape.`,
	...
	malice: [
		ElementFactory.FeatureFactory.createMalice({
			...
			sections: ['Each demon acting this turn has a double edge on their abilities.'],
		}),
		ElementFactory.FeatureFactory.createMalice({
			...
			sections: ['A demon minion of your choice transforms into a non-minion horde demon of the same level.'],
		}),
		ElementFactory.FeatureFactory.createMalice({
	...
	monsters: [
		ElementFactory.createMonster({
			...
			characteristics: ElementFactory.createCharacteristics(2, 0, -1, -1, -1),
			features: [
					...
					ability: ElementFactory.createAbility({
						...
						sections: [
							...
							ElementFactory.createAbilitySectionText(
								'If the target is pulled adjacent to the ensarer, the ensnarer makes a free strike against them.'
							),
						],
					}),
				}),
		...
		ElementFactory.createMonster({
			...
			characteristics: ElementFactory.createCharacteristics(0, 2, -1, -1, -1),
			features: [
				ElementFactory.FeatureFactory.createAbility({
					ability: ElementFactory.createAbility({
		...
		ElementFactory.createMonster({
			...
			freeStrikeDamage: 2,
			withCaptain: '+2 bonus to speed',
			characteristics: ElementFactory.createCharacteristics(-2, 2, -2, -2, -2),
			features: [
				ElementFactory.FeatureFactory.createAbility({
					ability: ElementFactory.createAbility({
			...
			features: [
				...
				ElementFactory.FeatureFactory.createAbility({
					ability: ElementFactory.createAbility({
						...
						sections: [
							ElementFactory.createAbilitySectionText('The muceron pulls each target up to 5 squares.'),
						],
					}),
				}),
				ElementFactory.FeatureFactory.create({
		...
		ElementFactory.createMonster({
			...
			stability: 0,
			freeStrikeDamage: 3,
			characteristics: ElementFactory.createCharacteristics(0, 2, 0, 0, 2),
			features: [
				ElementFactory.FeatureFactory.createAbility({
					ability: ElementFactory.createAbility({
			...
			features: [
				...
				ElementFactory.FeatureFactory.createAbility({
					ability: ElementFactory.createAbility({
						...
						target: 'Three creatures',
						sections: [
							ElementFactory.createAbilitySectionText('The torlas pulls each target up to 3 squares.'),
						],
					}),
				}),
				ElementFactory.FeatureFactory.create({
		...
		ElementFactory.createMonster({
			...
			freeStrikeDamage: 2,
			withCaptain: '+2 bonus to speed',
			characteristics: ElementFactory.createCharacteristics(-1, 3, 1, 0, -1),
			features: [
				ElementFactory.FeatureFactory.createAbility({
					ability: ElementFactory.createAbility({
		...
		ElementFactory.createMonster({
			...
			freeStrikeDamage: 3,
			withCaptain: '+2 damage bonus to strikes',
			characteristics: ElementFactory.createCharacteristics(1, 3, 1, 2, 1),
			features: [
				ElementFactory.FeatureFactory.createAbility({
					ability: ElementFactory.createAbility({
		...
		ElementFactory.createMonster({
			...
			keywords: ['Abyssal', 'Demon'],
			encounterValue: 7,
			size: ElementFactory.createSize(4),
			speed: ElementFactory.createSpeed(6, 'fly'),
			stamina: 30,
			stability: 2,
			freeStrikeDamage: 3,
			characteristics: ElementFactory.createCharacteristics(0, 0, 3, 3, 3),
			features: [
				ElementFactory.FeatureFactory.createAbility({
					ability: ElementFactory.createAbility({
						...
						sections: [
							...
							ElementFactory.createAbilitySectionText('The target has corruption weakness 5 (EoT).'),
							ElementFactory.createAbilitySectionSpend({
								value: 2,
		...
		ElementFactory.createMonster({
			...
			stability: 0,
			freeStrikeDamage: 3,
			characteristics: ElementFactory.createCharacteristics(2, 2, 2, 1, 3),
			features: [
				ElementFactory.FeatureFactory.createAbility({
					ability: ElementFactory.createAbility({
		...
		ElementFactory.createMonster({
			...
			stability: 0,
			freeStrikeDamage: 2,
			characteristics: ElementFactory.createCharacteristics(3, 2, 1, 2, -1),
			features: [
				ElementFactory.FeatureFactory.createAbility({
					ability: ElementFactory.createAbility({
		...
		ElementFactory.createMonster({
			...
			stability: 2,
			freeStrikeDamage: 4,
			characteristics: ElementFactory.createCharacteristics(3, 0, 2, 1, 2),
			features: [
				ElementFactory.FeatureFactory.createAbility({
					ability: ElementFactory.createAbility({
		...
		ElementFactory.createMonster({
			...
			stability: 3,
			freeStrikeDamage: 7,
			characteristics: ElementFactory.createCharacteristics(4, -1, 1, 2, 2),
			features: [
				ElementFactory.FeatureFactory.createAbility({
					ability: ElementFactory.createAbility({
				...
				ElementFactory.FeatureFactory.createAbility({
					ability: ElementFactory.createAbility({
						...
						sections: [
							ElementFactory.createAbilitySectionText(
								'Four level 1 demon minions (most commonly **ensnarers**, **frenzieds**, and **pitlings**) burst forth from the egress and appear in unoccupied squares in the area.'
							),
							ElementFactory.createAbilitySectionSpend({
								value: 2,
				...
				ElementFactory.FeatureFactory.createAbility({
					ability: ElementFactory.createAbility({
						...
						target: 'Special',
						sections: [
							ElementFactory.createAbilitySectionText('Eight **ensnarers** appear anywhere in the area.'),
						],
					}),
				}),
				ElementFactory.FeatureFactory.create({
		...
		ElementFactory.createMonster({
			...
			characteristics: ElementFactory.createCharacteristics(2, 4, 1, 0, -1),
			features: [
				ElementFactory.FeatureFactory.createAbility({
					ability: ElementFactory.createAbility({
		...
		ElementFactory.createMonster({
			...
			freeStrikeDamage: 4,
			withCaptain: 'Gain an edge on strikes',
			characteristics: ElementFactory.createCharacteristics(0, -1, 4, 4, 0),
			features: [
				ElementFactory.FeatureFactory.createAbility({
					ability: ElementFactory.createAbility({
		...
		ElementFactory.createMonster({
			...
			stability: 0,
			freeStrikeDamage: 3,
			characteristics: ElementFactory.createCharacteristics(0, 0, 4, 3, 4),
			features: [
				ElementFactory.FeatureFactory.createAbility({
					ability: ElementFactory.createAbility({
		...
		ElementFactory.createMonster({
			...
			stability: 2,
			freeStrikeDamage: 5,
			characteristics: ElementFactory.createCharacteristics(4, 0, 2, 1, 2),
			features: [
				ElementFactory.FeatureFactory.createAbility({
					ability: ElementFactory.createAbility({
				...
				ElementFactory.FeatureFactory.createAbility({
					ability: ElementFactory.createAbility({
						...
						distance: [ElementFactory.DistanceFactory.createSelf()],
						target: 'Self',
						sections: [ElementFactory.createAbilitySectionText('The chimeron halves the damage.')],
					}),
				}),
				ElementFactory.FeatureFactory.create({
		...
		ElementFactory.createMonster({
			...
			stability: 1,
			freeStrikeDamage: 3,
			characteristics: ElementFactory.createCharacteristics(2, 4, 0, 2, 0),
			features: [
				ElementFactory.FeatureFactory.createAbility({
					ability: ElementFactory.createAbility({
						...
						cost: 'signature',
						keywords: [AbilityKeyword.Melee, AbilityKeyword.Strike, AbilityKeyword.Weapon],
						distance: [ElementFactory.DistanceFactory.createMelee(4)],
						target: 'One creature or object',
						sections: [
							ElementFactory.createAbilitySectionRoll(
								ElementFactory.createPowerRoll({
				...
				ElementFactory.FeatureFactory.createAbility({
					ability: ElementFactory.createAbility({
						...
						keywords: [AbilityKeyword.Area],
						distance: [
							ElementFactory.DistanceFactory.create({ type: AbilityDistanceType.Burst, value: 4 }),
						],
						target: 'Each enemy in the area',
						sections: [
							ElementFactory.createAbilitySectionRoll(
			...
			features: [
				...
				ElementFactory.FeatureFactory.createAbility({
					ability: ElementFactory.createAbility({
						...
						type: ElementFactory.AbilityTypeFactory.createTrigger('A creature ends the praetorian’s grab.'),
						cost: 2,
						keywords: [],
						distance: [ElementFactory.DistanceFactory.createSelf()],
		...
		ElementFactory.createMonster({
			...
			stability: 0,
			freeStrikeDamage: 4,
			characteristics: ElementFactory.createCharacteristics(3, 0, 2, 2, 4),
			features: [
				ElementFactory.FeatureFactory.create({
...
The Find a Cure downtime project in *Draw Steel: Heroes* can be used to find a cure that removes a handmaiden from a host. The cure kills the handmaiden when consumed.`,
		...
		ElementFactory.createMonster({
			...
			stability: 2,
			freeStrikeDamage: 9,
			characteristics: ElementFactory.createCharacteristics(5, -1, 3, 3, 2),
			features: [
				ElementFactory.FeatureFactory.createAbility({
					ability: ElementFactory.createAbility({
				...
				ElementFactory.FeatureFactory.createAbility({
					ability: ElementFactory.createAbility({
						...
						target: 'Special',
						sections: [
							ElementFactory.createAbilitySectionText('Two soulraker minions appear within distance.'),
							ElementFactory.createAbilitySectionSpend({
								value: 2,
				...
				ElementFactory.FeatureFactory.createAbility({
					ability: ElementFactory.createAbility({
						...
						sections: [
							...
							ElementFactory.createAbilitySectionText('The hivequeen shifts up to her speed.'),
						],
					}),
				}),
				ElementFactory.FeatureFactory.createAbility({
					ability: ElementFactory.createAbility({
						...
						type: ElementFactory.AbilityTypeFactory.createVillainAction(3),
						keywords: [AbilityKeyword.Area, AbilityKeyword.Magic, AbilityKeyword.Ranged],
						distance: [ElementFactory.DistanceFactory.createSpecial('Four 2 cubes within 10')],
						target: 'Each enemy in the area',
						sections: [
							ElementFactory.createAbilitySectionRoll(
								ElementFactory.createPowerRoll({
		...
		ElementFactory.createMonster({
			...
			characteristics: ElementFactory.createCharacteristics(1, 3, 1, 5, 1),
			features: [
				ElementFactory.FeatureFactory.createAbility({
					ability: ElementFactory.createAbility({
		...
		ElementFactory.createMonster({
			...
			encounterValue: 12,
			size: ElementFactory.createSize(2),
			speed: ElementFactory.createSpeed(8, 'swim'),
			stamina: 15,
			stability: 0,
			freeStrikeDamage: 4,
			withCaptain: '+4 damage bonus to strikes',
			characteristics: ElementFactory.createCharacteristics(2, 5, 0, 3, -1),
			features: [
				ElementFactory.FeatureFactory.createAbility({
					ability: ElementFactory.createAbility({
		...
		ElementFactory.createMonster({
			...
			characteristics: ElementFactory.createCharacteristics(5, 5, -1, -1, -1),
			features: [
				ElementFactory.FeatureFactory.createAbility({
					ability: ElementFactory.createAbility({
		...
		ElementFactory.createMonster({
			...
			stability: 0,
			freeStrikeDamage: 4,
			characteristics: ElementFactory.createCharacteristics(0, 0, 5, 2, 4),
			features: [
				ElementFactory.FeatureFactory.createAbility({
					ability: ElementFactory.createAbility({
		...
		ElementFactory.createMonster({
			...
			encounterValue: 12,
			size: ElementFactory.createSize(1, 'M'),
			speed: ElementFactory.createSpeed(9),
			stamina: 60,
			stability: 0,
			freeStrikeDamage: 4,
			characteristics: ElementFactory.createCharacteristics(4, 5, -1, -2, -3),
			features: [
				ElementFactory.FeatureFactory.createAbility({
					ability: ElementFactory.createAbility({
		...
		ElementFactory.createMonster({
			...
			stability: 2,
			freeStrikeDamage: 10,
			characteristics: ElementFactory.createCharacteristics(5, 2, 5, 3, 5),
			features: [
				ElementFactory.FeatureFactory.create({
