...
export const rival: MonsterGroupInterface = {
...
Rivals are NPCs built around the mechanics of seven of the classes in Draw Steel: Heroes—the conduit, elementalist, fury, null, shadow, tactician, and talent (see Chapter 5: Classes in that book). Their stat blocks are streamlined and modular, meant to be easy to adjust on the fly with ancestral traits or signature abilities. Examples of each type of rival are presented at every tier, capturing their foray into renown as they inevitably cross, clash with, and impede the player characters’ own heroic journey.`,
	...
	monsters: [
		ElementFactory.createMonster({
			...
			stability: 1,
			freeStrikeDamage: 5,
			characteristics: ElementFactory.createCharacteristics(1, 0, 0, 2, 0),
			features: [
			...
			features: [
				...
				ElementFactory.FeatureFactory.createAbility({
					ability: ElementFactory.createAbility({
						...
						type: ElementFactory.AbilityTypeFactory.createTrigger('The elementalist takes damage.'),
		...
		ElementFactory.createMonster({
			...
			stability: 3,
			freeStrikeDamage: 5,
			characteristics: ElementFactory.createCharacteristics(0, 2, 1, 2, 0),
			features: [
				ElementFactory.FeatureFactory.createAbility({
					ability: ElementFactory.createAbility({
		...
		ElementFactory.createMonster({
			...
			stability: 2,
			freeStrikeDamage: 5,
			characteristics: ElementFactory.createCharacteristics(2, 0, 1, 0, 0),
			features: [
				ElementFactory.FeatureFactory.createAbility({
					ability: ElementFactory.createAbility({
		...
		ElementFactory.createMonster({
			...
			stability: 2,
			freeStrikeDamage: 5,
			characteristics: ElementFactory.createCharacteristics(0, 0, 2, 0, 1),
			features: [
				ElementFactory.FeatureFactory.createAbility({
					ability: ElementFactory.createAbility({
				...
				ElementFactory.FeatureFactory.createAbility({
					ability: ElementFactory.createAbility({
						...
						type: ElementFactory.AbilityTypeFactory.createTrigger('A creature deals damage to the talent.'),
		...
		ElementFactory.createMonster({
			...
			stability: 1,
			freeStrikeDamage: 6,
			characteristics: ElementFactory.createCharacteristics(2, 0, 0, 3, 1),
			features: [
				ElementFactory.FeatureFactory.createAbility({
					ability: ElementFactory.createAbility({
		...
		ElementFactory.createMonster({
			...
			stability: 1,
			freeStrikeDamage: 6,
			characteristics: ElementFactory.createCharacteristics(0, 2, 3, 2, 0),
			features: [
				ElementFactory.FeatureFactory.createAbility({
					ability: ElementFactory.createAbility({
		...
		ElementFactory.createMonster({
			...
			stability: 3,
			freeStrikeDamage: 6,
			characteristics: ElementFactory.createCharacteristics(0, 3, 2, 3, 0),
			features: [
				ElementFactory.FeatureFactory.createAbility({
					ability: ElementFactory.createAbility({
		...
		ElementFactory.createMonster({
			...
			stability: 1,
			freeStrikeDamage: 7,
			characteristics: ElementFactory.createCharacteristics(0, 3, 1, 0, 2),
			features: [
				ElementFactory.FeatureFactory.createAbility({
					ability: ElementFactory.createAbility({
		...
		ElementFactory.createMonster({
			...
			stability: 2,
			freeStrikeDamage: 7,
			characteristics: ElementFactory.createCharacteristics(3, 0, 2, 0, 1),
			features: [
				ElementFactory.FeatureFactory.createAbility({
					ability: ElementFactory.createAbility({
		...
		ElementFactory.createMonster({
			...
			stability: 2,
			freeStrikeDamage: 6,
			characteristics: ElementFactory.createCharacteristics(0, 0, 3, 0, 1),
			features: [
				ElementFactory.FeatureFactory.createAbility({
					ability: ElementFactory.createAbility({
		...
		ElementFactory.createMonster({
			...
			stability: 1,
			freeStrikeDamage: 8,
			characteristics: ElementFactory.createCharacteristics(3, 0, 1, 4, 2),
			features: [
				ElementFactory.FeatureFactory.createAbility({
					ability: ElementFactory.createAbility({
		...
		ElementFactory.createMonster({
			...
			stability: 1,
			freeStrikeDamage: 8,
			characteristics: ElementFactory.createCharacteristics(0, 2, 4, 3, 0),
			features: [
				ElementFactory.FeatureFactory.createAbility({
					ability: ElementFactory.createAbility({
				...
				ElementFactory.FeatureFactory.createAbility({
					ability: ElementFactory.createAbility({
						...
						sections: [
							ElementFactory.createAbilitySectionText(
								'The elementalist can teleport up to 4 squares. Each creature adjacent to the space they leave takes 4 corruption damage.'
							),
						],
					}),
				}),
		...
		ElementFactory.createMonster({
			...
			stability: 3,
			freeStrikeDamage: 9,
			characteristics: ElementFactory.createCharacteristics(4, 3, 0, 1, 2),
			features: [
				ElementFactory.FeatureFactory.createAbility({
					ability: ElementFactory.createAbility({
		...
		ElementFactory.createMonster({
			...
			stability: 3,
			freeStrikeDamage: 8,
			characteristics: ElementFactory.createCharacteristics(2, 4, 3, 4, 0),
			features: [
				ElementFactory.FeatureFactory.createAbility({
					ability: ElementFactory.createAbility({
		...
		ElementFactory.createMonster({
			...
			stability: 1,
			freeStrikeDamage: 9,
			characteristics: ElementFactory.createCharacteristics(0, 4, 2, 0, 3),
			features: [
				ElementFactory.FeatureFactory.createAbility({
					ability: ElementFactory.createAbility({
		...
		ElementFactory.createMonster({
			...
			stability: 2,
			freeStrikeDamage: 9,
			characteristics: ElementFactory.createCharacteristics(4, 1, 3, 0, 2),
			features: [
				ElementFactory.FeatureFactory.createAbility({
					ability: ElementFactory.createAbility({
		...
		ElementFactory.createMonster({
			...
			stability: 2,
			freeStrikeDamage: 8,
			characteristics: ElementFactory.createCharacteristics(0, 0, 4, 0, 1),
			features: [
				ElementFactory.FeatureFactory.createAbility({
					ability: ElementFactory.createAbility({
		...
		ElementFactory.createMonster({
			...
			stability: 1,
			freeStrikeDamage: 10,
			characteristics: ElementFactory.createCharacteristics(4, 1, 1, 5, 3),
			features: [
				ElementFactory.FeatureFactory.createAbility({
					ability: ElementFactory.createAbility({
		...
		ElementFactory.createMonster({
			...
			stability: 1,
			freeStrikeDamage: 10,
			characteristics: ElementFactory.createCharacteristics(1, 3, 5, 4, 1),
			features: [
				ElementFactory.FeatureFactory.createAbility({
					ability: ElementFactory.createAbility({
				...
				ElementFactory.FeatureFactory.createAbility({
					ability: ElementFactory.createAbility({
						...
						sections: [
							ElementFactory.createAbilitySectionText(
								'The area becomes overgrown with caustic vines until the end of the encounter. While in the area, any enemy has acid weakness 5 and is slowed. Any enemy who ends their turn in the area and has <code>M < 4</code> is restrained (save ends).'
							),
						],
					}),
				}),
		...
		ElementFactory.createMonster({
			...
			stability: 3,
			freeStrikeDamage: 10,
			characteristics: ElementFactory.createCharacteristics(5, 4, 0, 2, 3),
			features: [
				ElementFactory.FeatureFactory.createAbility({
					ability: ElementFactory.createAbility({
		...
		ElementFactory.createMonster({
			...
			stability: 3,
			freeStrikeDamage: 10,
			characteristics: ElementFactory.createCharacteristics(3, 5, 4, 5, 0),
			features: [
				ElementFactory.FeatureFactory.createAbility({
					ability: ElementFactory.createAbility({
		...
		ElementFactory.createMonster({
			...
			stability: 1,
			freeStrikeDamage: 10,
			characteristics: ElementFactory.createCharacteristics(0, 5, 3, 2, 4),
			features: [
				ElementFactory.FeatureFactory.createAbility({
					ability: ElementFactory.createAbility({
		...
		ElementFactory.createMonster({
			...
			stability: 2,
			freeStrikeDamage: 10,
			characteristics: ElementFactory.createCharacteristics(5, 2, 4, 0, 3),
			features: [
				ElementFactory.FeatureFactory.createAbility({
					ability: ElementFactory.createAbility({
				...
				ElementFactory.FeatureFactory.createAbility({
					ability: ElementFactory.createAbility({
						...
						sections: [
							...
							ElementFactory.createAbilitySectionText('Each ally in the area regains 10 Stamina'),
						],
					}),
				}),
				ElementFactory.FeatureFactory.createAbility({
		...
		ElementFactory.createMonster({
			...
			stability: 2,
			freeStrikeDamage: 10,
			characteristics: ElementFactory.createCharacteristics(0, 0, 5, 0, 1),
			features: [
				ElementFactory.FeatureFactory.createAbility({
					ability: ElementFactory.createAbility({
	...
	addOns: [
		ElementFactory.FeatureFactory.createAddOn({
			id: 'ancestry-1',
			name: 'Devil',
			description: `
- **Size Adjustment:** 1M
