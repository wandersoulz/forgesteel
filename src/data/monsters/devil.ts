...
export const devil: MonsterGroupInterface = {
...
- Wealth: Each hero can earn 1 wealth in exchange for a small favor`,
	...
	monsters: [
		ElementFactory.createMonster({
			...
			characteristics: ElementFactory.createCharacteristics(3, 0, 1, 1, 2),
			features: [
		...
		ElementFactory.createMonster({
			...
			characteristics: ElementFactory.createCharacteristics(0, 1, 3, 1, 2),
			features: [
				ElementFactory.FeatureFactory.createAbility({
					ability: ElementFactory.createAbility({
		...
		ElementFactory.createMonster({
			...
			characteristics: ElementFactory.createCharacteristics(0, 3, 1, 1, 2),
			features: [
				ElementFactory.FeatureFactory.createAbility({
					ability: ElementFactory.createAbility({
						...
						sections: [
							...
							ElementFactory.createAbilitySectionText('The scrivener can shift 1 square'),
						],
					}),
				}),
				ElementFactory.FeatureFactory.create({
		...
		ElementFactory.createMonster({
			...
			stability: 1,
			freeStrikeDamage: 7,
			characteristics: ElementFactory.createCharacteristics(0, 1, 2, 1, 3),
			features: [
				ElementFactory.FeatureFactory.createAbility({
					ability: ElementFactory.createAbility({
				...
				ElementFactory.FeatureFactory.createAbility({
					ability: ElementFactory.createAbility({
						...
						target: 'One creature',
						sections: [
							ElementFactory.createAbilitySectionText('The target makes a **Presence test**.'),
							ElementFactory.createAbilitySectionRoll(
								ElementFactory.createPowerRoll({
				...
				ElementFactory.FeatureFactory.create({
					...
					description:
						'Any creature within 10 squares of the adjudicator who has <code>P < 3</code> takes a −2 penalty to saving throws.',
				}),
				ElementFactory.FeatureFactory.create({
		...
		ElementFactory.createMonster({
			...
			stability: 0,
			freeStrikeDamage: 7,
			characteristics: ElementFactory.createCharacteristics(0, 2, 1, 1, 3),
			features: [
				ElementFactory.FeatureFactory.createAbility({
					ability: ElementFactory.createAbility({
				...
				ElementFactory.FeatureFactory.createAbility({
					ability: ElementFactory.createAbility({
						...
						sections: [
							...
							ElementFactory.createAbilitySectionText(
								'If the target has <code>M < 2</code>, the forced distance movement gains a +3 bonus.'
							),
						],
					}),
				}),
		...
		ElementFactory.createMonster({
			...
			stability: 2,
			freeStrikeDamage: 6,
			characteristics: ElementFactory.createCharacteristics(3, 1, 0, 1, 2),
			features: [
				ElementFactory.FeatureFactory.createAbility({
					ability: ElementFactory.createAbility({
		...
		ElementFactory.createMonster({
			...
			stability: 2,
			freeStrikeDamage: 6,
			characteristics: ElementFactory.createCharacteristics(1, 3, 2, 1, 4),
			features: [
				ElementFactory.FeatureFactory.createAbility({
					ability: ElementFactory.createAbility({
