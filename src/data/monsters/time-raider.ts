...
export const timeRaider: MonsterGroupInterface = {
...
Time raiders also have two sets of arms, allowing them to wield melee weapons at the same time as ranged weapons. A single well-trained kuran’zoi is like a squad unto themself.`,
	...
	malice: [
		ElementFactory.FeatureFactory.createMaliceAbility({
			ability: ElementFactory.createAbility({
				...
				distance: [
					ElementFactory.DistanceFactory.create({ type: AbilityDistanceType.Cube, value: 5, within: 3 }),
				],
				target: 'Special',
				sections: [
	...
	monsters: [
		ElementFactory.createMonster({
			...
			characteristics: ElementFactory.createCharacteristics(2, 2, 2, 1, -1),
			features: [
		...
		ElementFactory.createMonster({
			...
			freeStrikeDamage: 3,
			withCaptain: '+1 damage bonus to strikes',
			characteristics: ElementFactory.createCharacteristics(2, 1, 2, 1, 1),
			features: [
				ElementFactory.FeatureFactory.createAbility({
					ability: ElementFactory.createAbility({
				...
				ElementFactory.FeatureFactory.createAbility({
					ability: ElementFactory.createAbility({
						...
						sections: [
							...
							ElementFactory.createAbilitySectionText(
								'A layer of ground of floor beneath the area that is 1 square deep is destroyed.'
							),
						],
					}),
				}),
		...
		ElementFactory.createMonster({
			...
			stability: 0,
			freeStrikeDamage: 5,
			characteristics: ElementFactory.createCharacteristics(0, 2, 2, 2, 2),
			features: [
				ElementFactory.FeatureFactory.createAbility({
					ability: ElementFactory.createAbility({
				...
				ElementFactory.FeatureFactory.createAbility({
					ability: ElementFactory.createAbility({
						...
						sections: [
							ElementFactory.createAbilitySectionText(
								'The area is a psionically charged treadmill that pushes creatures and objects at high speed in one direction of the helix’s choice. Any creature who enters the area or starts their turn there slides 3 squares toward the end of the area in the chosen direction. Each ene- my in the area when it first appears takes 3 damage before they slide.'
							),
							ElementFactory.createAbilitySectionSpend({
								value: 3,
		...
		ElementFactory.createMonster({
			...
			stability: 0,
			freeStrikeDamage: 5,
			characteristics: ElementFactory.createCharacteristics(0, 2, 2, 2, 1),
			features: [
				ElementFactory.FeatureFactory.createAbility({
					ability: ElementFactory.createAbility({
		...
		ElementFactory.createMonster({
			...
			stability: 2,
			freeStrikeDamage: 5,
			characteristics: ElementFactory.createCharacteristics(2, 0, 2, 2, 1),
			features: [
				ElementFactory.FeatureFactory.createAbility({
					ability: ElementFactory.createAbility({
		...
		ElementFactory.createMonster({
			...
			stability: 0,
			freeStrikeDamage: 5,
			characteristics: ElementFactory.createCharacteristics(1, 2, 2, 1, 0),
			features: [
				ElementFactory.FeatureFactory.createAbility({
					ability: ElementFactory.createAbility({
		...
		ElementFactory.createMonster({
			...
			stability: 2,
			freeStrikeDamage: 5,
			characteristics: ElementFactory.createCharacteristics(1, 1, 2, 1, 0),
			features: [
				ElementFactory.FeatureFactory.createAbility({
					ability: ElementFactory.createAbility({
				...
				ElementFactory.FeatureFactory.createAbility({
					ability: ElementFactory.createAbility({
						...
						sections: [
							ElementFactory.createAbilitySectionText('Each target shifts up to half their speed.'),
						],
					}),
				}),
				ElementFactory.FeatureFactory.create({
		...
		ElementFactory.createMonster({
			...
			encounterValue: 20,
			size: ElementFactory.createSize(2),
			speed: ElementFactory.createSpeed(10, 'hover, teleport'),
			stamina: 120,
			stability: 2,
			freeStrikeDamage: 5,
			characteristics: ElementFactory.createCharacteristics(0, 3, 3, 1, 0),
			features: [
				ElementFactory.FeatureFactory.createAbility({
					ability: ElementFactory.createAbility({
