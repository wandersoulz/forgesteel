...
export const angulotl: MonsterGroupInterface = {
...
Pinna, Hedge Witch, Gravesford`,
	...
	monsters: [
		ElementFactory.createMonster({
			...
			speed: ElementFactory.createSpeed(6, 'swim, climb'),
			stamina: 4,
			stability: 0,
			freeStrikeDamage: 2,
		...
		ElementFactory.createMonster({
			...
			encounterValue: 3,
			size: ElementFactory.createSize(1, 'S'),
			speed: ElementFactory.createSpeed(5, 'swim, climb'),
			stamina: 3,
			stability: 0,
			freeStrikeDamage: 2,
		...
		ElementFactory.createMonster({
			...
			characteristics: ElementFactory.createCharacteristics(0, 2, -3, -2, 1),
			features: [
				ElementFactory.FeatureFactory.createAbility({
					ability: ElementFactory.createAbility({
		...
		ElementFactory.createMonster({
			...
			stability: 0,
			freeStrikeDamage: 1,
			characteristics: ElementFactory.createCharacteristics(0, 0, 0, 2, 2),
			features: [
				ElementFactory.FeatureFactory.createAbility({
					ability: ElementFactory.createAbility({
		...
		ElementFactory.createMonster({
			...
			stability: 1,
			freeStrikeDamage: 4,
			characteristics: ElementFactory.createCharacteristics(3, 2, 0, 2, 0),
			features: [
				ElementFactory.FeatureFactory.createAbility({
					ability: ElementFactory.createAbility({
				...
				ElementFactory.FeatureFactory.createAbility({
					ability: ElementFactory.createAbility({
						...
						distance: [
							ElementFactory.DistanceFactory.create({ type: AbilityDistanceType.Burst, value: 8 }),
						],
