...
export const orc: MonsterGroupInterface = {
...
When an orc community has exceptional gratitude for the deeds of one of their own or an outsider, they bestow the companionship of a mohler upon the individual. Treated kindly, mohlers make steadfast companions, protecting their caregivers with their lives. If mistreated, a mohler returns to their original den, and the orcs hunt the responsible party.`,
	...
	monsters: [
		ElementFactory.createMonster({
			...
			characteristics: ElementFactory.createCharacteristics(0, 2, -4, 1, -3),
			features: [
					...
					ability: ElementFactory.createAbility({
						...
						sections: [
							...
							ElementFactory.createAbilitySectionText(
								'The distance increases to melee 2. If the mohler is 1 or more squares beneath the target before they use this ability, a target who has <code>M < 1</code> is also knocked prone.'
							),
						],
					}),
				}),
		...
		ElementFactory.createMonster({
			...
			stability: 0,
			freeStrikeDamage: 5,
			characteristics: ElementFactory.createCharacteristics(2, 2, 0, 1, 1),
			features: [
				ElementFactory.FeatureFactory.createAbility({
					ability: ElementFactory.createAbility({
						id: 'orc-6-feature-1',
		...
		ElementFactory.createMonster({
			...
			stability: 2,
			freeStrikeDamage: 3,
			characteristics: ElementFactory.createCharacteristics(2, 2, 1, 0, 0),
			features: [
				ElementFactory.FeatureFactory.createAbility({
					ability: ElementFactory.createAbility({
						id: 'orc-7-feature-1',
		...
		ElementFactory.createMonster({
			...
			stability: 0,
			freeStrikeDamage: 4,
			characteristics: ElementFactory.createCharacteristics(1, 2, 0, 1, -1),
			features: [
				ElementFactory.FeatureFactory.createAbility({
					ability: ElementFactory.createAbility({
						id: 'orc-9-feature-1',
		...
		ElementFactory.createMonster({
			...
			stability: 0,
			freeStrikeDamage: 3,
			characteristics: ElementFactory.createCharacteristics(1, 0, 0, 1, 2),
			features: [
				ElementFactory.FeatureFactory.createAbility({
					ability: ElementFactory.createAbility({
						id: 'orc-10-feature-1',
			...
			features: [
				...
				ElementFactory.FeatureFactory.createAbility({
					ability: ElementFactory.createAbility({
						id: 'orc-11-feature-2',
						name: 'Hrraaaaaagh!',
						type: ElementFactory.AbilityTypeFactory.createTrigger('The juggernaut takes damage.', {
							free: true,
						}),
						cost: 1,
		...
		ElementFactory.createMonster({
			...
			stability: 2,
			freeStrikeDamage: 4,
			characteristics: ElementFactory.createCharacteristics(1, 1, 0, 1, 2),
			features: [
				ElementFactory.FeatureFactory.createAbility({
					ability: ElementFactory.createAbility({
						id: 'orc-13-feature-1',
		...
		ElementFactory.createMonster({
			...
			stability: 2,
			freeStrikeDamage: 5,
			characteristics: ElementFactory.createCharacteristics(3, 2, 1, 2, 2),
			features: [
				ElementFactory.FeatureFactory.createAbility({
					ability: ElementFactory.createAbility({
						id: 'orc-14-feature-1',
		...
		ElementFactory.createMonster({
			...
			stability: 3,
			freeStrikeDamage: 5,
			characteristics: ElementFactory.createCharacteristics(2, -1, -4, 0, -1),
			features: [
				ElementFactory.FeatureFactory.createAbility({
					ability: ElementFactory.createAbility({
						id: 'orc-15-feature-1',
						...
						sections: [
							...
							ElementFactory.createAbilitySectionText(
								'The scyza roars, and if the target has <code>I < 2</code>, they are frightened (save ends).'
							),
						],
					}),
				}),
