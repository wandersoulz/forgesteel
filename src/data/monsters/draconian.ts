...
export const draconian: MonsterGroupInterface = {
...
Six individual draconians are presented in this section—not an adventuring party, but six warriors whose reputations precede them. All are likely to be found serving in various military forces as high-ranking commanders.`,
	...
	malice: [
		...
		ElementFactory.FeatureFactory.createMaliceAbility({
			ability: ElementFactory.createAbility({
				...
				type: ElementFactory.AbilityTypeFactory.createMain({ free: true }),
				cost: 7,
				keywords: [AbilityKeyword.Area, AbilityKeyword.Magic],
	...
	monsters: [
		ElementFactory.createMonster({
			...
			stability: 2,
			freeStrikeDamage: 7,
			characteristics: ElementFactory.createCharacteristics(-1, 2, 2, 3, 1),
			features: [
		...
		ElementFactory.createMonster({
			...
			stability: 2,
			freeStrikeDamage: 7,
			characteristics: ElementFactory.createCharacteristics(1, 3, 1, 2, 2),
			features: [
				ElementFactory.FeatureFactory.createAbility({
					ability: ElementFactory.createAbility({
						...
						sections: [
							...
							ElementFactory.createAbilitySectionText(
								'Locratix deals 6 damage to each creature or object in a 2 × 1 line behind the target.'
							),
						],
					}),
				}),
				...
				ElementFactory.FeatureFactory.createAbility({
					ability: ElementFactory.createAbility({
						...
						name: 'Stay Back!',
						type: ElementFactory.AbilityTypeFactory.createTrigger(
							'A creature within distance moves or is forced moved.'
						),
		...
		ElementFactory.createMonster({
			...
			stability: 2,
			freeStrikeDamage: 7,
			characteristics: ElementFactory.createCharacteristics(-1, 3, 3, 3, 1),
			features: [
				ElementFactory.FeatureFactory.createAbility({
					ability: ElementFactory.createAbility({
		...
		ElementFactory.createMonster({
			...
			stability: 2,
			freeStrikeDamage: 7,
			characteristics: ElementFactory.createCharacteristics(-1, 3, 2, 2, 1),
			features: [
				ElementFactory.FeatureFactory.createAbility({
					ability: ElementFactory.createAbility({
				...
				ElementFactory.FeatureFactory.createAbility({
					ability: ElementFactory.createAbility({
						...
						target: 'One ally',
						sections: [
							ElementFactory.createAbilitySectionText('Myxovidan and the target shift to swap places.'),
						],
					}),
				}),
				ElementFactory.FeatureFactory.createAbility({
		...
		ElementFactory.createMonster({
			...
			stability: 3,
			freeStrikeDamage: 7,
			characteristics: ElementFactory.createCharacteristics(3, 2, 0, 0, 3),
			features: [
				ElementFactory.FeatureFactory.createAbility({
					ability: ElementFactory.createAbility({
		...
		ElementFactory.createMonster({
			...
			stability: 3,
			freeStrikeDamage: 7,
			characteristics: ElementFactory.createCharacteristics(4, 1, 1, 2, 3),
			features: [
				ElementFactory.FeatureFactory.createAbility({
					ability: ElementFactory.createAbility({
