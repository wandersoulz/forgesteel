...
export const giant: MonsterGroupInterface = {
...
Stone giants are made of the same kinds of rocks that form their homes—sandstone, marble, granite, and even basalt. Their stone bodies not only protect them from attack, but also provide them with an additional outlet for self-expression. They often carve runes into their skin, which serve a wide variety of artistic and cultural purposes.`,
	...
	monsters: [
		ElementFactory.createMonster({
			...
			characteristics: ElementFactory.createCharacteristics(4, 2, 0, 2, 1),
			features: [
		...
		ElementFactory.createMonster({
			...
			characteristics: ElementFactory.createCharacteristics(4, 2, 0, 3, 0),
			features: [
				ElementFactory.FeatureFactory.createAbility({
					ability: ElementFactory.createAbility({
		...
		ElementFactory.createMonster({
			...
			characteristics: ElementFactory.createCharacteristics(3, -1, -1, 4, 2),
			features: [
				ElementFactory.FeatureFactory.createDamageModifier({
					id: 'giant-3-1',
					modifiers: [
		...
		ElementFactory.createMonster({
			...
			freeStrikeDamage: 4,
			withCaptain: '+3 damage bonus to strikes',
			characteristics: ElementFactory.createCharacteristics(4, -1, -1, -1, -1),
			features: [
				ElementFactory.FeatureFactory.createDamageModifier({
					id: 'giant-4-1',
					modifiers: [
		...
		ElementFactory.createMonster({
			...
			stability: 10,
			freeStrikeDamage: 8,
			characteristics: ElementFactory.createCharacteristics(4, 2, 1, 2, 1),
			features: [
				ElementFactory.FeatureFactory.createAbility({
					ability: ElementFactory.createAbility({
				...
				ElementFactory.FeatureFactory.createAbility({
					ability: ElementFactory.createAbility({
						...
						distance: [
							ElementFactory.DistanceFactory.createMelee(3),
							ElementFactory.DistanceFactory.createRanged(12),
						],
				...
				ElementFactory.FeatureFactory.createAbility({
					ability: ElementFactory.createAbility({
						...
						name: 'Resonate Rune',
						type: ElementFactory.AbilityTypeFactory.createTrigger('The basalt stone giant takes damage.'),
		...
		ElementFactory.createMonster({
			...
			stability: 5,
			freeStrikeDamage: 9,
			characteristics: ElementFactory.createCharacteristics(4, 3, 0, 4, 1),
			features: [
				ElementFactory.FeatureFactory.createDamageModifier({
					id: 'giant-6-1',
					modifiers: [
				...
				ElementFactory.FeatureFactory.createAbility({
					ability: ElementFactory.createAbility({
						...
						cost: 'signature',
						keywords: [AbilityKeyword.Magic, AbilityKeyword.Melee, AbilityKeyword.Strike],
						distance: [ElementFactory.DistanceFactory.createMelee(6)],
						target: 'Two creatures or objects',
						sections: [
							ElementFactory.createAbilitySectionRoll(
								ElementFactory.createPowerRoll({
				...
				ElementFactory.FeatureFactory.createAbility({
					ability: ElementFactory.createAbility({
						...
						type: ElementFactory.AbilityTypeFactory.createTrigger('The lightbearer takes damage.'),
						distance: [ElementFactory.DistanceFactory.createSelf()],
						target: 'Self',
						sections: [
							ElementFactory.createAbilitySectionText(
		...
		ElementFactory.createMonster({
			...
			stability: 5,
			freeStrikeDamage: 9,
			characteristics: ElementFactory.createCharacteristics(4, -1, 0, 0, 0),
			features: [
				ElementFactory.FeatureFactory.createDamageModifier({
					id: 'giant-8-1',
					modifiers: [
		...
		ElementFactory.createMonster({
			...
			stability: 5,
			freeStrikeDamage: 8,
			characteristics: ElementFactory.createCharacteristics(4, 4, -1, 0, 0),
			features: [
				ElementFactory.FeatureFactory.createDamageModifier({
					id: 'giant-9-1',
					modifiers: [
				...
				ElementFactory.FeatureFactory.createAbility({
					ability: ElementFactory.createAbility({
						...
						type: ElementFactory.AbilityTypeFactory.createTrigger('The wind sprinter takes damage.'),
						distance: [ElementFactory.DistanceFactory.createSelf()],
						target: 'Self',
						sections: [
							ElementFactory.createAbilitySectionText(
		...
		ElementFactory.createMonster({
			...
			stability: 10,
			freeStrikeDamage: 8,
			characteristics: ElementFactory.createCharacteristics(4, 1, 1, 2, 1),
			features: [
				ElementFactory.FeatureFactory.createAbility({
					ability: ElementFactory.createAbility({
				...
				ElementFactory.FeatureFactory.createAbility({
					ability: ElementFactory.createAbility({
						...
						sections: [
							...
							ElementFactory.createAbilitySectionText(
								'The area is difficult terrain. Whenever a creature enters a square in the area, they take 3 damage'
							),
						],
					}),
				}),
			...
			features: [
				...
				ElementFactory.FeatureFactory.createAbility({
					ability: ElementFactory.createAbility({
						...
						sections: [
							ElementFactory.createAbilitySectionText(
								'Each target must make either a **Might** or **Agility** test.'
							),
							ElementFactory.createAbilitySectionRoll(
								ElementFactory.createPowerRoll({
				...
				ElementFactory.FeatureFactory.createAbility({
					ability: ElementFactory.createAbility({
						...
						target: 'The triggering creature',
						sections: [
							ElementFactory.createAbilitySectionText('The target makes an **Agility** test.'),
							ElementFactory.createAbilitySectionRoll(
								ElementFactory.createPowerRoll({
		...
		ElementFactory.createMonster({
			...
			encounterValue: 40,
			size: ElementFactory.createSize(4),
			speed: ElementFactory.createSpeed(6, 'burrow'),
			stamina: 207,
			stability: 10,
			freeStrikeDamage: 8,
			characteristics: ElementFactory.createCharacteristics(4, 3, 0, 3, 0),
			features: [
				ElementFactory.FeatureFactory.createAbility({
					ability: ElementFactory.createAbility({
				...
				ElementFactory.FeatureFactory.createAbility({
					ability: ElementFactory.createAbility({
						...
						name: 'Break Armor',
						cost: 1,
						type: ElementFactory.AbilityTypeFactory.createTrigger('The marble stone giant takes damage'),
						distance: [ElementFactory.DistanceFactory.createSelf()],
						target: 'Self',
						sections: [
							ElementFactory.createAbilitySectionText(
		...
		ElementFactory.createMonster({
			...
			stability: 10,
			freeStrikeDamage: 9,
			characteristics: ElementFactory.createCharacteristics(5, 3, 0, 2, 3),
			features: [
				ElementFactory.FeatureFactory.createDamageModifier({
					id: 'giant-13-1',
					modifiers: [
				...
				ElementFactory.FeatureFactory.createAbility({
					ability: ElementFactory.createAbility({
						...
						sections: [
							ElementFactory.createAbilitySectionText(
								'The chief shifts up to 10 squares. Five **fire giant fireballers** then arrive in unoccupied spaces within distance.'
							),
						],
					}),
				}),
