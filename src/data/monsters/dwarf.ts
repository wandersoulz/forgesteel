...
export const dwarf: MonsterGroupInterface = {
...
Legends speak of stone singers, dwarves who could move mountains with their song. However, those same legends tell a tale of two stone singers who harmonized their voices and nearly ended the world. This is why today’s stone whisperers stay quiet, afraid of their own potential.`,
	...
	monsters: [
				...
				ElementFactory.FeatureFactory.createAbility({
					ability: ElementFactory.createAbility({
						...
						sections: [
							...
							ElementFactory.createAbilitySectionText(
								'target restrained by a dwarf can be force moved by this ability. This forced movement doesn’t end the restrained condition unless the Director determines otherwise.'
							),
						],
					}),
				}),
		...
		ElementFactory.createMonster({
			...
			stability: 2,
			freeStrikeDamage: 5,
			characteristics: ElementFactory.createCharacteristics(1, 0, 2, 2, 0),
			features: [
				ElementFactory.FeatureFactory.createAbility({
					ability: ElementFactory.createAbility({
		...
		ElementFactory.createMonster({
			...
			stability: 4,
			freeStrikeDamage: 5,
			characteristics: ElementFactory.createCharacteristics(3, 0, 2, 1, 0),
			features: [
				ElementFactory.FeatureFactory.createAbility({
					ability: ElementFactory.createAbility({
		...
		ElementFactory.createMonster({
			...
			stability: 2,
			freeStrikeDamage: 4,
			characteristics: ElementFactory.createCharacteristics(2, 0, -2, 0, -2),
			features: [
				ElementFactory.FeatureFactory.createAbility({
					ability: ElementFactory.createAbility({
