...
export const animal: MonsterGroupInterface = {
...
`,
	...
	monsters: [
		ElementFactory.createMonster({
			...
			stability: 0,
			freeStrikeDamage: 4,
			characteristics: ElementFactory.createCharacteristics(0, 2, -2, 1, -2),
			features: [
					...
					ability: ElementFactory.createAbility({
						...
						sections: [
							...
							ElementFactory.createAbilitySectionText(
								'The animal can shift 2 between striking the first and second target.'
							),
						],
					}),
				}),
				ElementFactory.FeatureFactory.createAbility({
					ability: ElementFactory.createAbility({
						...
						target: 'Self',
						sections: [ElementFactory.createAbilitySectionText('The animal moves up to their speed.')],
					}),
				}),
		...
		ElementFactory.createMonster({
			...
			stability: 1,
			freeStrikeDamage: 4,
			characteristics: ElementFactory.createCharacteristics(-2, 1, -3, 2, -3),
			features: [
				ElementFactory.FeatureFactory.createAbility({
					ability: ElementFactory.createAbility({
						...
						sections: [
							...
							ElementFactory.createAbilitySectionText(
								'The target can be pulled into the swarm without inflicting damage.'
							),
						],
					}),
				}),
				ElementFactory.FeatureFactory.createAbility({
					ability: ElementFactory.createAbility({
						...
						sections: [
							ElementFactory.createAbilitySectionText(
								'The swarm forces themselves in the way of their foes. The affected area is considered difficult terrain for enemies until the start of the swarm’s next turn.'
							),
						],
					}),
				}),
		...
		ElementFactory.createMonster({
			...
			stability: 1,
			freeStrikeDamage: 4,
			characteristics: ElementFactory.createCharacteristics(1, 2, -2, 1, -2),
			features: [
				ElementFactory.FeatureFactory.createAbility({
					ability: ElementFactory.createAbility({
			...
			features: [
				...
				ElementFactory.FeatureFactory.createAbility({
					ability: ElementFactory.createAbility({
						...
						name: 'Animal Rally',
						type: ElementFactory.AbilityTypeFactory.createTrigger('The target is knocked prone.'),
		...
		ElementFactory.createMonster({
			...
			stability: 0,
			freeStrikeDamage: 5,
			characteristics: ElementFactory.createCharacteristics(1, 2, -2, 1, 1),
			features: [
				ElementFactory.FeatureFactory.createAbility({
					ability: ElementFactory.createAbility({
			...
			features: [
				...
				ElementFactory.FeatureFactory.createAbility({
					ability: ElementFactory.createAbility({
						...
						distance: [ElementFactory.DistanceFactory.createMelee()],
						target: 'The triggering creature or object',
						sections: [ElementFactory.createAbilitySectionText('The target is pushed up to 5 squares.')],
					}),
				}),
				ElementFactory.FeatureFactory.create({
