...
export const troll: MonsterGroupInterface = {
	...
	monsters: [
		ElementFactory.createMonster({
			...
			characteristics: ElementFactory.createCharacteristics(3, 1, -2, -1, -1),
			features: [
		...
		ElementFactory.createMonster({
			...
			characteristics: ElementFactory.createCharacteristics(3, 1, -1, 0, 0),
			features: [
				ElementFactory.FeatureFactory.createDamageModifier({
		...
		ElementFactory.createMonster({
			...
			stability: 4,
			freeStrikeDamage: 5,
			characteristics: ElementFactory.createCharacteristics(4, 1, -1, 0, 2),
