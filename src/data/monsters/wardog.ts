...
export const warDog: MonsterGroupInterface = {
...
These monstrous war dogs are developed to fulfill specific roles and combat niches, and are often fused with inorganic materials after their rebirth as living war machines. Monstrous war dogs are uniformly respected for having been chosen for greatness, and they consider their unnatural forms a badge of honor bestowed by Ajax.`,
	...
	malice: [
		...
		ElementFactory.FeatureFactory.createMaliceAbility({
			ability: ElementFactory.createAbility({
				...
				sections: [
					ElementFactory.createAbilitySectionText(
						'A bank of choking chemicals sweeps across the area of the enácounter map. Each enemy in the encounter makes a **Might test**.'
					),
					ElementFactory.createAbilitySectionRoll(
						ElementFactory.createPowerRoll({
	...
	monsters: [
		...
		ElementFactory.createMonster({
			...
			freeStrikeDamage: 1,
			withCaptain: '+1 damage bonus to strikes',
			characteristics: ElementFactory.createCharacteristics(2, 0, 0, 0, 0),
			features: [
				ElementFactory.FeatureFactory.createAbility({
					ability: ElementFactory.createAbility({
				...
				ElementFactory.FeatureFactory.createAbility({
					ability: ElementFactory.createAbility({
						...
						sections: [
							...
							ElementFactory.createAbilitySectionText('This ability ignores cover and concealment. '),
						],
					}),
				}),
				ElementFactory.FeatureFactory.create({
			...
			features: [
				...
				ElementFactory.FeatureFactory.createAbility({
					ability: ElementFactory.createAbility({
						...
						sections: [
							ElementFactory.createAbilitySectionText(
								'A detonator attaches to the target. At the end of each round, roll a die. On an odd result, the detonator explodes, triggering the power roll.'
							),
							ElementFactory.createAbilitySectionRoll(
								ElementFactory.createPowerRoll({
									bonus: 2,
		...
		ElementFactory.createMonster({
			...
			encounterValue: 3,
			size: ElementFactory.createSize(1, 'M'),
			speed: ElementFactory.createSpeed(5, 'teleport'),
			stamina: 15,
			stability: 0,
			freeStrikeDamage: 2,
			characteristics: ElementFactory.createCharacteristics(0, 2, 0, 0, 0),
		...
		ElementFactory.createMonster({
			...
			stability: 2,
			freeStrikeDamage: 5,
			characteristics: ElementFactory.createCharacteristics(3, 2, 3, 2, 2),
			features: [
				ElementFactory.FeatureFactory.createAbility({
					ability: ElementFactory.createAbility({
				...
				ElementFactory.FeatureFactory.createAbility({
					ability: ElementFactory.createAbility({
						...
						sections: [
							ElementFactory.createAbilitySectionText(
								'Each ally within 5 squares of the target moves up to their speed and can make a free strike against the target. If the target has <code>I < 2</code>, they are frightened of the ground commander (save ends).'
							),
						],
					}),
				}),
		...
		ElementFactory.createMonster({
			...
			characteristics: ElementFactory.createCharacteristics(0, 0, 3, 0, 2),
			features: [
				ElementFactory.FeatureFactory.createAbility({
					ability: ElementFactory.createAbility({
		...
		ElementFactory.createMonster({
			...
			freeStrikeDamage: 2,
			withCaptain: 'Gain an edge on strikes',
			characteristics: ElementFactory.createCharacteristics(0, 3, 0, 2, 0),
			features: [
				ElementFactory.FeatureFactory.createAbility({
					ability: ElementFactory.createAbility({
		...
		ElementFactory.createMonster({
			...
			speed: ElementFactory.createSpeed(5, 'Climb, swim'),
			stamina: 8,
			stability: 0,
			freeStrikeDamage: 3,
			withCaptain: '+2 bonus to speed',
			characteristics: ElementFactory.createCharacteristics(-1, 3, 0, 2, 0),
			features: [
				ElementFactory.FeatureFactory.createAbility({
					ability: ElementFactory.createAbility({
						...
						distance: [
							ElementFactory.DistanceFactory.createMelee(1),
							ElementFactory.DistanceFactory.createRanged(4),
						],
		...
		ElementFactory.createMonster({
			...
			stability: 0,
			freeStrikeDamage: 4,
			characteristics: ElementFactory.createCharacteristics(0, 3, 2, 2, -1),
			features: [
				ElementFactory.FeatureFactory.createAbility({
					ability: ElementFactory.createAbility({
		...
		ElementFactory.createMonster({
			...
			stability: 0,
			freeStrikeDamage: 3,
			characteristics: ElementFactory.createCharacteristics(3, -1, 0, 3, 1),
			features: [
				ElementFactory.FeatureFactory.create({
		...
		ElementFactory.createMonster({
			...
			stability: 2,
			freeStrikeDamage: 3,
			characteristics: ElementFactory.createCharacteristics(3, 3, -1, -2, 0),
			features: [
				ElementFactory.FeatureFactory.create({
				...
				ElementFactory.FeatureFactory.createAbility({
					ability: ElementFactory.createAbility({
						...
						sections: [
							...
							ElementFactory.createAbilitySectionText('This ability gains an edge while charging.'),
							ElementFactory.createAbilitySectionSpend({
								value: 2,
		...
		ElementFactory.createMonster({
			...
			stability: 0,
			freeStrikeDamage: 3,
			characteristics: ElementFactory.createCharacteristics(1, 3, 0, 0, 2),
			features: [
				ElementFactory.FeatureFactory.create({
				...
				ElementFactory.FeatureFactory.createAbility({
					ability: ElementFactory.createAbility({
						...
						name: 'Feign Death',
						cost: 2,
						type: ElementFactory.AbilityTypeFactory.createTrigger('The hypokrite takes damage'),
		...
		ElementFactory.createMonster({
			...
			stability: 0,
			freeStrikeDamage: 3,
			characteristics: ElementFactory.createCharacteristics(1, 1, 2, 3, 1),
			features: [
				ElementFactory.FeatureFactory.create({
		...
		ElementFactory.createMonster({
			...
			stability: 0,
			freeStrikeDamage: 3,
			characteristics: ElementFactory.createCharacteristics(0, 0, 2, 3, 0),
			features: [
				ElementFactory.FeatureFactory.create({
		...
		ElementFactory.createMonster({
			...
			stability: 1,
			freeStrikeDamage: 3,
			characteristics: ElementFactory.createCharacteristics(0, 1, 3, 2, 0),
			features: [
				ElementFactory.FeatureFactory.createAbility({
					ability: ElementFactory.createAbility({
				...
				ElementFactory.FeatureFactory.createAbility({
					ability: ElementFactory.createAbility({
						...
						cost: 1,
						type: ElementFactory.AbilityTypeFactory.createTrigger('One ally within distance dies'),
						keywords: [AbilityKeyword.Magic, AbilityKeyword.Ranged],
						distance: [ElementFactory.DistanceFactory.createRanged(15)],
						target: 'Special',
						sections: [
		...
		ElementFactory.createMonster({
			...
			stability: 2,
			freeStrikeDamage: 7,
			characteristics: ElementFactory.createCharacteristics(4, 3, 2, 3, 4),
			features: [
				ElementFactory.FeatureFactory.create({
				...
				ElementFactory.FeatureFactory.createAbility({
					ability: ElementFactory.createAbility({
						...
						distance: [ElementFactory.DistanceFactory.createSpecial('Five 2 cubes within 20')],
						target: 'Each creature and object in the area',
						sections: [
							ElementFactory.createAbilitySectionRoll(
								ElementFactory.createPowerRoll({
		...
		ElementFactory.createMonster({
			...
			characteristics: ElementFactory.createCharacteristics(4, 1, -2, -1, 2),
			features: [
				ElementFactory.FeatureFactory.createAbility({
					ability: ElementFactory.createAbility({
		...
		ElementFactory.createMonster({
			...
			freeStrikeDamage: 4,
			withCaptain: '+5 bonus to ranged distance',
			characteristics: ElementFactory.createCharacteristics(-1, 2, 4, 3, 1),
			features: [
				ElementFactory.FeatureFactory.createAbility({
					ability: ElementFactory.createAbility({
		...
		ElementFactory.createMonster({
			...
			freeStrikeDamage: 4,
			withCaptain: 'Gain an edge on strikes',
			characteristics: ElementFactory.createCharacteristics(1, 4, 3, 1, 1),
			features: [
				ElementFactory.FeatureFactory.createAbility({
					ability: ElementFactory.createAbility({
		...
		ElementFactory.createMonster({
			...
			stability: 0,
			freeStrikeDamage: 3,
			characteristics: ElementFactory.createCharacteristics(0, 4, 1, 3, 1),
			features: [
				ElementFactory.FeatureFactory.createAbility({
					ability: ElementFactory.createAbility({
				...
				ElementFactory.FeatureFactory.createAbility({
					ability: ElementFactory.createAbility({
						...
						cost: 2,
						keywords: [AbilityKeyword.Area, AbilityKeyword.Magic, AbilityKeyword.Ranged],
						distance: [ElementFactory.DistanceFactory.create({ type: AbilityDistanceType.Cube, value: 5 })],
		...
		ElementFactory.createMonster({
			...
			encounterValue: 10,
			size: ElementFactory.createSize(1, 'L'),
			speed: ElementFactory.createSpeed(0),
			stamina: 72,
			stability: 5,
			freeStrikeDamage: 4,
			characteristics: ElementFactory.createCharacteristics(4, -2, 2, 3, 2),
			features: [
				ElementFactory.FeatureFactory.createAbility({
					ability: ElementFactory.createAbility({
						...
						sections: [
							...
							ElementFactory.createAbilitySectionText(
								'Any target pushed into an obstacle is knocked prone, and if they have <code>M < 3</code> they are restrained (save ends).'
							),
						],
					}),
				}),
		...
		ElementFactory.createMonster({
			...
			encounterValue: 9,
			size: ElementFactory.createSize(1, 'M'),
			speed: ElementFactory.createSpeed(6, 'Teleport'),
			stamina: 45,
			stability: 0,
			freeStrikeDamage: 4,
			characteristics: ElementFactory.createCharacteristics(1, 4, 4, 2, 0),
			features: [
				ElementFactory.FeatureFactory.createAbility({
					ability: ElementFactory.createAbility({
				...
				ElementFactory.FeatureFactory.createAbility({
					ability: ElementFactory.createAbility({
						...
						sections: [ElementFactory.createAbilitySectionText('Each target makes a free strike.')],
					}),
				}),
				ElementFactory.FeatureFactory.create({
				...
				ElementFactory.FeatureFactory.create({
					...
					description:
						'When the blackcap or any of their ash clones is reduced to 0 Stamina, that creature’s loyalty collar explodes, dealing 3d6 poison damage to each adjacent enemy and object. If any adjacent enemy has <code>A < 3</code> they are also weakened (save ends).',
				}),
			],
		}),
		ElementFactory.createMonster({
			...
			stability: 4,
			freeStrikeDamage: 7,
			characteristics: ElementFactory.createCharacteristics(4, 2, 1, 1, 3),
			features: [
				ElementFactory.FeatureFactory.createAbility({
					ability: ElementFactory.createAbility({
				...
				ElementFactory.FeatureFactory.createAbility({
					ability: ElementFactory.createAbility({
						...
						sections: [
							ElementFactory.createAbilitySectionText(
								'Until the start of their next turn, the breaker has a double edge on abilities and is automatically affected by all potency effects.'
							),
						],
					}),
				}),
		...
		ElementFactory.createMonster({
			...
			stability: 0,
			freeStrikeDamage: 3,
			characteristics: ElementFactory.createCharacteristics(0, 2, 3, 4, 1),
			features: [
				ElementFactory.FeatureFactory.createAbility({
					ability: ElementFactory.createAbility({
		...
		ElementFactory.createMonster({
			...
			stability: 3,
			freeStrikeDamage: 3,
			characteristics: ElementFactory.createCharacteristics(2, 1, 4, 4, 2),
			features: [
				ElementFactory.FeatureFactory.createAbility({
					ability: ElementFactory.createAbility({
				...
				ElementFactory.FeatureFactory.createAbility({
					ability: ElementFactory.createAbility({
						...
						keywords: [AbilityKeyword.Area, AbilityKeyword.Magic, AbilityKeyword.Ranged],
						distance: [
							ElementFactory.DistanceFactory.create({ type: AbilityDistanceType.Wall, value: 10 }),
						],
						target: 'Special',
						sections: [
							ElementFactory.createAbilitySectionText(
		...
		ElementFactory.createMonster({
			...
			stability: 0,
			freeStrikeDamage: 3,
			characteristics: ElementFactory.createCharacteristics(2, 1, 1, 4, 4),
			features: [
				ElementFactory.FeatureFactory.createAbility({
					ability: ElementFactory.createAbility({
				...
				ElementFactory.FeatureFactory.createAbility({
					ability: ElementFactory.createAbility({
						...
						repeatable: true,
						keywords: [AbilityKeyword.Area, AbilityKeyword.Magic],
						distance: [ElementFactory.DistanceFactory.create({ type: AbilityDistanceType.Aura, value: 4 })],
						target: 'Special',
						sections: [
							ElementFactory.createAbilitySectionText(` For every 2 Malice spent, each target gains one of the following effects until the start of the iron priest’s next turn.
...
- The target has a +3 bonus to speed.`),
		...
		ElementFactory.createMonster({
			...
			stability: 2,
			freeStrikeDamage: 3,
			characteristics: ElementFactory.createCharacteristics(4, 0, 4, 2, 3),
			features: [
				ElementFactory.FeatureFactory.createAbility({
					ability: ElementFactory.createAbility({
		...
		ElementFactory.createMonster({
			...
			stability: 1,
			freeStrikeDamage: 9,
			characteristics: ElementFactory.createCharacteristics(1, 3, 5, 4, 3),
			features: [
				ElementFactory.FeatureFactory.createAbility({
					ability: ElementFactory.createAbility({
				...
				ElementFactory.FeatureFactory.createAbility({
					ability: ElementFactory.createAbility({
						...
						sections: [
							ElementFactory.createAbilitySectionText(
								'Slide 5, and if the the target has <code>M < 4</code>, they fall prone.'
							),
						],
					}),
				}),
		...
		ElementFactory.createMonster({
			...
			characteristics: ElementFactory.createCharacteristics(5, 4, 2, 3, 2),
			features: [
				ElementFactory.FeatureFactory.createAbility({
					ability: ElementFactory.createAbility({
		...
		ElementFactory.createMonster({
			...
			characteristics: ElementFactory.createCharacteristics(1, 5, 3, 5, 2),
			features: [
				ElementFactory.FeatureFactory.createAbility({
					ability: ElementFactory.createAbility({
		...
		ElementFactory.createMonster({
			...
			freeStrikeDamage: 4,
			withCaptain: 'Gain an edge on strikes',
			characteristics: ElementFactory.createCharacteristics(2, 2, 4, 3, 5),
			features: [
				ElementFactory.FeatureFactory.createAbility({
					ability: ElementFactory.createAbility({
		...
		ElementFactory.createMonster({
			...
			stability: 3,
			freeStrikeDamage: 10,
			characteristics: ElementFactory.createCharacteristics(5, 2, 4, 3, 4),
			features: [
				ElementFactory.FeatureFactory.createAbility({
					ability: ElementFactory.createAbility({
				...
				ElementFactory.FeatureFactory.createAbility({
					ability: ElementFactory.createAbility({
						...
						sections: [
							ElementFactory.createAbilitySectionText(
								'Hoplon teleports to an unoccupied space adjacent to the enemy and becomes the new target of the ability. He can then make a free strike against the enemy, and if that enemy has <code>R < 4</code> they are taunted until the end of their next turn.'
							),
						],
					}),
				}),
		...
		ElementFactory.createMonster({
			...
			stability: 2,
			freeStrikeDamage: 10,
			characteristics: ElementFactory.createCharacteristics(5, 4, 1, 4, 2),
			features: [
				ElementFactory.FeatureFactory.createAbility({
					ability: ElementFactory.createAbility({
		...
		ElementFactory.createMonster({
			...
			stability: 3,
			freeStrikeDamage: 10,
			characteristics: ElementFactory.createCharacteristics(2, 1, 5, 4, 1),
			features: [
				ElementFactory.FeatureFactory.createAbility({
					ability: ElementFactory.createAbility({
				...
				ElementFactory.FeatureFactory.createAbility({
					ability: ElementFactory.createAbility({
						...
						sections: [
							...
							ElementFactory.createAbilitySectionText(
								'The area is difficult terrain. Any creature who enters the area for the first time in a round or starts their turn there takes 10 fire damage. Until the end of the encounter, the size of the area increases by 1 at the start of each round.'
							),
						],
					}),
				}),
		...
		ElementFactory.createMonster({
			...
			encounterValue: 48,
			size: ElementFactory.createSize(1, 'M'),
			speed: ElementFactory.createSpeed(10, 'Fly, hover'),
			stamina: 220,
			stability: 1,
			freeStrikeDamage: 10,
			characteristics: ElementFactory.createCharacteristics(1, 3, 3, 4, 5),
			features: [
				ElementFactory.FeatureFactory.createAbility({
					ability: ElementFactory.createAbility({
				...
				ElementFactory.FeatureFactory.createAbility({
					ability: ElementFactory.createAbility({
						...
						sections: [
							ElementFactory.createAbilitySectionText(
								'Each target takes 5 damage from a self-inflicted wound, and if they have <code>M < 4</code> Psyche slides them up to 5 squares.'
							),
						],
					}),
				}),
				...
				ElementFactory.FeatureFactory.createAbility({
					ability: ElementFactory.createAbility({
						...
						distance: [ElementFactory.DistanceFactory.createRanged(10)],
						target: 'One creature or object',
						sections: [ElementFactory.createAbilitySectionText('The target takes 10 psychic damage.')],
					}),
				}),
			],
		}),
		ElementFactory.createMonster({
			...
			stability: 2,
			freeStrikeDamage: 10,
			characteristics: ElementFactory.createCharacteristics(4, 4, 5, 5, 5),
			features: [
				ElementFactory.FeatureFactory.createAbility({
					ability: ElementFactory.createAbility({
						...
						sections: [
							...
							ElementFactory.createAbilitySectionText('Each target loses 1d3 Recoveries.'),
							ElementFactory.createAbilitySectionSpend({
								value: 2,
