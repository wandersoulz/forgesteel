...
export const dragonCrucible: MonsterGroupInterface = {
...
All crucible dragons manage to accrue large amounts of armaments and armor in their hoards. They care little for gems and gold, other than for melting down as filigree or embossing the weapons and armor they forge.`,
	...
	monsters: [
		ElementFactory.createMonster({
			...
			stability: 6,
			freeStrikeDamage: 7,
			characteristics: ElementFactory.createCharacteristics(4, -1, 3, 3, 2),
			features: [
				...
				ElementFactory.FeatureFactory.createAbility({
					ability: ElementFactory.createAbility({
						...
						cost: 'signature',
						sections: [
							ElementFactory.createAbilitySectionText('Each target makes a **Agility test**.'),
