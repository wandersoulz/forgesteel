...
export const dwarfFury = new Hero({
	id: 'ojZeuF7Jjqw66Di1',
	name: 'Keth',
	picture: null,
	folder: '',
					...
					options: [
						{
							feature: {
								...
								name: 'Grounded',
								description:
									'Your heavy stone body and connection to the earth make it difficult for others to move you.',
								type: 'Bonus',
								data: {
									field: 'Stability',
									value: 1,
	...
	class: {
		...
		subclassCount: 1,
		primaryCharacteristicsOptions: [['Might', 'Agility']],
		...
		featuresByLevel: [
			{
				...
				features: [
					...
					},
					{
						...
						data: {
							options: [],
							listOptions: ['Exploration', 'Intrigue'],
							count: 2,
							selected: ['Jump', 'Navigate'],
						},
					},
					{
						id: 'fury-1-4',
				...
				features: [
					{
						...
						type: 'Perk',
						data: {
							lists: ['Crafting', 'Exploration', 'Intrigue'],
							count: 1,
							selected: [],
						},
					},
		...
		subclasses: [
						...
						features: [
							{
								...
								description:
									'**8 Ferocity:** The first time you push a creature on a turn, you gain 2 surges.',
								type: 'Text',
								data: null,
							},
						],
						...
						features: [
							{
								...
								name: 'Growing Ferocity Improvement',
								description:
									'**10 Ferocity:** You have a double edge on Might tests and the Knockback maneuver.',
								type: 'Text',
								data: null,
							},
						],
			...
			},
			{
				...
				name: 'Reaver',
				description:
					'You channel your rage into instinct and cunning, challenging the false order of civilization.',
				featuresByLevel: [
					{
						level: 1,
						features: [
						...
						features: [
							{
								...
								name: 'Growing Ferocity Improvement',
								description:
									'**8 Ferocity:** The first time you slide a creature on a turn, you gain 2 surges.',
								type: 'Text',
								data: null,
							},
						],
												...
												data: {
													ability: {
														...
														type: {
															...
															free: true,
															trigger:
																'You reduce a creature to 0 Stamina with a strike.',
															time: '',
															qualifiers: [],
															freeStrike: false,
														},
														keywords: ['Magic', 'Strike', 'Weapon'],
														distance: [
															{
																type: 'Melee',
																value: 1,
						...
						features: [
							{
								...
								name: 'Growing Ferocity Improvement',
								description:
									'**10 Ferocity:** You have a double edge on Agility tests and the Knockback maneuver.',
								type: 'Text',
								data: null,
							},
						],
						...
						features: [
							{
								...
								name: 'Growing Ferocity Improvement',
								description:
									'**12 Ferocity:** Whenever you use a heroic ability, you gain 10 temporary Stamina. Additionally, whenever you make a power roll that imposes forced movement on a target, the forced movement distance gains a bonus equal to your Agility score.',
								type: 'Text',
								data: null,
							},
						],
	...
	career: {
		...
		name: 'Warden',
		description:
			'You protected a wild region from those who sought to harm it, such as poachers and cultists bent on the destruction of the natural world. Knowing your land well, you could also serve as a guide or the leader of a rescue party for those wandering the wilds.',
		features: [
			{
		...
		incitingIncidents: {
			options: [
				...
				},
				{
					...
					name: 'Corruption',
					description:
						'A disease has infected the lands you protect, causing animals to become violent and twisting plants into something dark and sinister. You’ve tried everything, magical and mundane, to stop the scourge, but it continues to spread. As such, you’ve set out in search of a cure or an unblighted land to protect.',
				},
				{
					id: 'career-warden-ii-3',
					name: 'Exiled',
					description:
						'You made a mistake that could not be forgiven. The other wardens of the region decided your fate, exiling you from your lands with an order never to return.',
				},
				{
					id: 'career-warden-ii-4',
					name: 'Honor the Fallen',
					description:
						'A group of heroes arrived in your territory with trouble close on their heels. You fought alongside them to turn back the evil, but it was too much. The heroes fell, and your wilderness was forever altered. Though your lands are beyond saving, there are other lands you can help.',
				},
				{
					id: 'career-warden-ii-5',
					name: 'Portents',
					description:
						'There were signs. You tried to ignore them, but when a great beast died at your feet, you had to recognize the truth. You were meant to leave your home territory, meant to fight a battle for the fate of all lands - and so you gave up the only life you’ve ever known.',
				},
				{
					id: 'career-warden-ii-6',
					name: 'Theft',
					description:
						'You were responsible for guarding something precious, something vital to your region’s survival. But you let someone in, and they betrayed your trust by stealing the thing you were meant to guard. You left your chosen territory to atone for your mistake.',
				},
			],
			selected: {
				id: 'career-warden-ii-4',
