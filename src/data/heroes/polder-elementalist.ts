...
export const polderElementalist = new Hero({
	id: 'mr3vxPGN0NkoVsZe',
	name: 'Bethell',
	picture: null,
	folder: '',
	...
	class: {
		...
		subclassCount: 1,
		primaryCharacteristicsOptions: [['Reason']],
		primaryCharacteristics: ['Reason'],
		featuresByLevel: [
			{
				level: 1,
				features: [
					...
					},
					{
						...
						data: {
							...
							count: 3,
							selected: ['Blacksmithing', 'Tailoring', 'Alchemy'],
						},
					},
					{
						id: 'elementalist-1-4',
									...
									feature: {
										...
										data: {
											ability: {
												...
												name: 'Ward of Surprising Reactivity',
												description:
													'You use the magic of fire to create a ward of explosive energy.',
												type: {
													usage: 'Triggered Action',
													free: true,
					...
					},
					{
						...
						data: {
							...
							minLevel: 1,
							count: 2,
							selectedIDs: ['elementalist-ability-2', 'elementalist-ability-8'],
						},
					},
					{
						...
						data: {
							...
							minLevel: 1,
							count: 1,
							selectedIDs: ['elementalist-ability-10'],
						},
					},
					{
						...
						data: {
							...
							minLevel: 1,
							count: 1,
							selectedIDs: ['elementalist-ability-13'],
						},
					},
				],
			},
			...
			},
			{
				...
				features: [
					...
					},
					{
						...
						type: 'Perk',
						data: {
							lists: ['Interpersonal', 'Crafting', 'Lore', 'Supernatural', 'Intrigue', 'Exploration'],
							count: 1,
							selected: [],
						},
					},
				...
				features: [
					{
						...
						type: 'Perk',
						data: {
							lists: ['Exploration', 'Interpersonal', 'Intrigue', 'Crafting', 'Lore', 'Supernatural'],
							count: 1,
							selected: [],
						},
					},
		...
		abilities: [
			...
			},
			{
				...
				keywords: ['Area', 'Magic', 'Earth', 'Ranged'],
				distance: [
					{
						type: 'Cube',
						value: 4,
			...
			},
			{
				...
				keywords: ['Void', 'Magic', 'Ranged', 'Strike'],
				distance: [
					{
						type: 'Ranged',
						value: 10,
			...
			},
			{
				...
				keywords: ['Area', 'Magic', 'Green', 'Ranged'],
				distance: [
					{
						type: 'Cube',
						value: 4,
			...
			},
			{
				...
				keywords: ['Fire', 'Green', 'Magic', 'Ranged', 'Earth'],
				distance: [
					{
						type: 'Ranged',
						value: 10,
			...
			},
			{
				...
				keywords: ['Earth', 'Fire', 'Magic', 'Void', 'Ranged'],
				distance: [
					{
						type: 'Ranged',
						value: 10,
			...
			},
			{
				...
				keywords: ['Area', 'Green', 'Magic', 'Earth', 'Void'],
				distance: [
					{
						type: 'Burst',
						value: 4,
			...
			},
			{
				...
				keywords: ['Area', 'Magic', 'Void', 'Ranged'],
				distance: [
					{
						type: 'Ranged',
						value: 10,
			...
			},
			{
				...
				keywords: ['Fire', 'Magic', 'Strike', 'Ranged'],
				distance: [
					{
						type: 'Ranged',
						value: 10,
			...
			options: [
				{
					...
					description:
						'While practicing a spell, your inexperience caused the magic to backfire and your memories were wiped, leaving you with only fragments of who you once were. Determined to recall your past, you now dedicate yourself to helping others, hoping your actions will spark some remembrance or lead you to a way to reverse the magic.',
				},
				{
					id: 'career-mages-apprentice-ii-2',
					name: 'Magic of Friendship',
					description:
						'As a sign of your status as star pupil, your mentor gifted you a familiar as a magic pet. Another jealous apprentice captured the familiar and slipped away in the night. Haunted by your pet’s absence, you adventure to find your kidnapped friend and prevent others from feeling your loss.',
				},
				{
					id: 'career-mages-apprentice-ii-3',
					name: 'Missing Mage',
					description:
						'One day you woke up and the mage you worked for was just gone. They didn’t take any of their belongings and there was no sign of any foul play - just the scent of sulfur in their bedchamber. You set out on your heroic journey in the aftermath and have been looking for them ever since.',
				},
				{
					id: 'career-mages-apprentice-ii-4',
					name: 'Nightmares Made Flesh',
					description:
						'Your attempts at magic have always been unpredictable. A powerful mage promised to help you gain control. During your training, a terrible nightmare caused your body to flare with magic and pull the monster of your nightmare into the waking world. The horror escaped. You left, seeking to vanquish their terrible vileness.',
				},
				{
					id: 'career-mages-apprentice-ii-5',
					name: 'Otherworldly',
					description:
						'While studying magic, you accidentally sent yourself from your original world to this one. Now you’re stranded here, hoping to find ancient texts or powerful magic treasures that might transport you back home. A life of adventure it is!',
				},
				{
