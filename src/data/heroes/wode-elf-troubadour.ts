...
export const wodeElfTroubadour = new Hero({
	id: 'HVPFufs9Uv4PWrKi',
	name: 'Lliarion',
	picture: null,
	folder: '',
	...
	class: {
		...
		subclassCount: 1,
		primaryCharacteristicsOptions: [['Agility', 'Presence']],
							...
							options: [
								...
								},
								{
									feature: {
										...
										data: {
											tag: '',
											trigger:
												'The first time the Director deals damage to a hero using a Villain action or an ability that costs Malice.',
											value: '2',
											replacesTags: [],
										},
									},
								...
								},
								{
									feature: {
										...
										description:
											'You can forgo choosing a new event to choose one event you already have (including an event gained with this feature). Whenever the chosen event grants you drama, you gain 1 additional drama.',
										type: 'Text',
										data: null,
									},
									value: 1,
			...
			},
			{
				...
				sections: [
					...
					},
					{
						type: 'roll',
						roll: {
							characteristic: ['Agility', 'Presence'],
							bonus: 0,
		...
		subclasses: [
			...
			},
			{
				...
				name: 'Duelist',
				description:
					'Drama infuses your every movement done in tandem with another. You perform dances of death, putting trust in your opponent to return your passion in kind.',
				featuresByLevel: [
					{
						level: 1,
						features: [
			...
			},
			{
				...
				name: 'Virtuoso',
				description:
					'You find drama in music and song, weaving magic between vibrations and filling the audience with your pathos.',
				featuresByLevel: [
					{
						level: 1,
						features: [
							...
							},
							{
								...
								description:
									'You have the following performance abilities, which are usable with\nyour Routines feature.',
											...
											feature: {
												...
												data: {
													ability: {
														...
														keywords: ['Melee', 'Magic', 'Ranged', 'Strike'],
														distance: [
															{
																type: 'Melee',
																value: 1,
			...
			options: [
				{
					...
					description:
						'During a performance, you watched in horror as the audience was suddenly overcome by a curse that caused them to disintegrate before your eyes. You aren’t sure what happened, but seeking an answer quickly led you to places where only heroes dare to go.',
				},
				{
