...
export const humanNull = new Hero({
	id: '75cnGojH6jMwHJQq',
	name: 'Ashley',
	picture: null,
	folder: '',
	...
	class: {
		...
		subclassCount: 1,
		primaryCharacteristicsOptions: [['Agility', 'Intuition']],
		...
		featuresByLevel: [
			{
				...
				features: [
						...
						data: {
							...
							gains: [
								...
								},
								{
									tag: 'action',
									trigger:
										'The first time each combat round that an enemy in the area of your Null Field ability uses a main action',
									value: '1',
								},
								{
									tag: 'malice',
									trigger:
										'The first time each combat round that the Director uses an ability that costs Malice',
									value: '1',
								},
							],
							details: '',
					...
					},
					{
						...
						description:
							'Your training has turned your body into the perfect psionic weapon, shaping pathways in your mind that enhance your physical form. Choose one of the following augmentations. You can change your augmentation by undergoing a psionic meditation as a respite activity.',
						type: 'Choice',
						data: {
							options: [
								{
					...
					},
					{
						...
						data: {
							...
							minLevel: 1,
							count: 2,
							selectedIDs: ['null-ability-2', 'null-ability-3'],
						},
					},
					{
						id: 'null-1-10',
		...
		subclasses: [
			...
			},
			{
				...
				name: 'Cryokinetic',
				description:
					'You can tap into absolute cold, the most essential energy of myriad manifolds, and manifest its effects in your body.',
				featuresByLevel: [
					{
						level: 1,
						features: [
						...
						features: [
							{
								...
								description:
									'You ignore difficult terrain related to cold and ice, and you can automatically climb at full speed while moving.',
								type: 'Text',
								data: null,
							},
							{
									...
									modifiers: [
										{
											...
											type: 'Immunity',
											value: 0,
											valueCharacteristics: ['Intuition'],
			...
			},
			{
				...
				name: 'Metakinetic',
				description:
					'You learn to see through the illusions of the universe to more fully understand your body and its psionic potential.',
				featuresByLevel: [
					{
						level: 1,
						features: [
