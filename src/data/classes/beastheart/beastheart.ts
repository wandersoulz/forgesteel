...
export const beastheart: HeroClassInterface = {
	id: 'class-beastheart',
	name: 'Beastheart',
	description: `
...
Play a beastheart if you want to face the world’s dangers with your mighty wild companion by your side, rushing into the thick of combat to challenge enemy champions or prowling around the outskirts to pick off vulnerable foes.`,
	...
	subclassCount: 1,
	primaryCharacteristicsOptions: [[Characteristic.Might, Characteristic.Intuition]],
	...
	featuresByLevel: [
		{
			...
			features: [
				...
				ElementFactory.FeatureFactory.createSummonChoice({
					id: 'beastheart-1-2a',
					name: 'Companion',
					description:
						'You gain the companionship of a wild animal that shares your travels. Your companion isn’t your pet—rather, they share a mystical bond with you, a bond that allows you to share your companion’s senses and primal instincts.',
					options: [
						ElementFactory.createSummon({
							monster: ElementFactory.createMonster({
								...
								name: 'Basilisk',
								level: 0,
								role: ElementFactory.createMonsterRole(MonsterOrganizationType.Companion),
								keywords: ['Animal'],
								encounterValue: 0,
								...
								stability: 2,
								freeStrikeDamage: 1,
								characteristics: ElementFactory.createCharacteristics(2, 1, -1, 2, 2),
								features: [
									ElementFactory.FeatureFactory.createBonus({
									...
									ElementFactory.FeatureFactory.createAbility({
										ability: ElementFactory.createAbility({
											...
											name: 'Turn to Stone',
											description:
												'Transfixed by the basilisk’s magical gaze or poisoned claws, the foe’s body begins to calcify.',
											...
											sections: [
												ElementFactory.createAbilitySectionText(
													'2 + M corruption damage; stoned (Save Ends)'
												),
							...
							level3: [
								ElementFactory.FeatureFactory.create({
									...
									description:
										'When the basilisk hits a creature with a strike while rampaging, the creature is stoned (save ends).',
								}),
							],
							level6: [
								ElementFactory.FeatureFactory.create({
									...
									name: 'Rock Smasher',
									description:
										'While the basilisk is rampaging, when you deal rolled damage to a stoned creature you deal extra damage equal to twice your Might score.',
								}),
							],
							level10: [
								ElementFactory.FeatureFactory.create({
									...
									name: 'Heart of Stone',
									description:
										'While the basilisk is rampaging, you and the basilisk become living statues, impervious to most damage. You and the basilisk have damage immunity 10.',
								}),
							],
						}),
						ElementFactory.createSummon({
								...
								features: [
									...
									ElementFactory.FeatureFactory.createAbility({
										ability: ElementFactory.createAbility({
											...
											sections: [
												ElementFactory.createAbilitySectionText('3 + M damage; push 2'),
												ElementFactory.createAbilitySectionSpend({
							...
							level3: [
								ElementFactory.FeatureFactory.create({
									...
									name: 'Foe Thresher',
									description:
										'When the bear hits a creature with a strike while rampaging, the bear can push the creature up to a number of squares equal to the bear’s Might score if the strike doesn’t otherwise force move the target.',
								}),
							],
							level6: [
								ElementFactory.FeatureFactory.create({
									...
									name: 'Ursine Form',
									description:
										'While the bear is rampaging, you have damage immunity 5 and your size changes to match the bear’s size (maximum 2). If there is not enough unoccupied space for your size to increase, it increases as soon as there is sufficient space.',
								}),
							],
							level10: [
								ElementFactory.FeatureFactory.create({
									...
									name: 'Twin Colossi',
									description:
										'While the bear is rampaging, the distance of your melee and weapon abilities increases by 1, your size changes to match the bear’s size (maximum 3), and your strikes deal an extra 5 damage.',
								}),
							],
						}),
						ElementFactory.createSummon({
								...
								features: [
									...
									ElementFactory.FeatureFactory.createAbility({
										ability: ElementFactory.createAbility({
											...
											sections: [
												ElementFactory.createAbilitySectionText(
													'The boar moves up to their speed in a straight line, and can then deal 2 + M damage to an adjacent target. If the boar moved closer to the target as part of this ability’s movement, the boar deals extra damage equal to their Might score.'
												),
												ElementFactory.createAbilitySectionSpend({
									...
									ElementFactory.FeatureFactory.create({
										...
										description:
											'While the boar is winded, they gain damage immunity equal to their Might score and they ignore damage from the Bleeding condition.',
									}),
								],
							}),
							isSignature: false,
							...
							level3: [
								ElementFactory.FeatureFactory.create({
									...
									name: 'Greased Pig',
									description:
										'While the boar is rampaging, the boar has a +2 bonus to speed and has a double edge on the Escape Grab maneuver.',
								}),
							],
							level6: [
								ElementFactory.FeatureFactory.create({
									...
									name: 'Wild Rush',
									description:
										'While the boar is rampaging, you can use the Gore maneuver, and when either of you uses the Charge action or the Gore maneuver you can shift instead of move.',
								}),
							],
							level10: [
								ElementFactory.FeatureFactory.create({
									...
									name: 'Immortal Rage',
									description:
										'While the boar is rampaging, when one of you uses an ability that deals damage you gain 10 temporary Stamina.',
								}),
							],
						}),
						ElementFactory.createSummon({
								...
								features: [
									...
									ElementFactory.FeatureFactory.createAbility({
										ability: ElementFactory.createAbility({
											...
											sections: [
												ElementFactory.createAbilitySectionText(
													'2 + M damage; until the end of your next turn, enemies are weakened while adjacent to the condor.'
												),
												ElementFactory.createAbilitySectionSpend({
									...
									ElementFactory.FeatureFactory.create({
										...
										name: 'Moving Target',
										description:
											'Ranged attacks against the condor have a bane while the condor is flying and has a speed greater than 0.',
									}),
								],
							}),
							isSignature: false,
							...
							level3: [
								ElementFactory.FeatureFactory.create({
									...
									name: 'Dive Bomb',
									description:
										'When the condor makes a strike while rampaging, they deal extra damage equal to the number of squares they already moved on their turn, up to a maximum of 5.',
								}),
							],
							level6: [
								ElementFactory.FeatureFactory.create({
									...
									name: 'Borne Aloft',
									description:
										'While the condor is rampaging, you gain wings. You can fly, and you have a +2 bonus to your speed while flying. When this flight ends, you descend harmlessly.',
								}),
							],
							level10: [
								ElementFactory.FeatureFactory.create({
						...
						ElementFactory.createSummon({
								...
								features: [
									...
									ElementFactory.FeatureFactory.createAbility({
										ability: ElementFactory.createAbility({
											...
											name: 'Terrible Claw',
											description:
												'The deinonychus kicks their prey, slashing them with their wicked claws.',
											type: ElementFactory.AbilityTypeFactory.createManeuver(),
											keywords: [
												AbilityKeyword.Companion,
												AbilityKeyword.Melee,
											...
											target: 'One enemy',
											sections: [
												ElementFactory.createAbilitySectionText('2 + M damage; bleeding (EoT)'),
												ElementFactory.createAbilitySectionSpend({
									...
									ElementFactory.FeatureFactory.create({
										...
										name: 'Blood Frenzy',
										description:
											'The deinonychus gains a surge when they deal damage to a bleeding creature.',
									}),
								],
							}),
							isSignature: false,
							...
							level3: [
								ElementFactory.FeatureFactory.create({
									...
									description:
										'When the deinonychus strikes a creature while rampaging, the creature is bleeding (save ends). Until the condition ends, the target is also slowed.',
								}),
							],
							level6: [
								ElementFactory.FeatureFactory.create({
									...
									description:
										'While the deinonychus is rampaging, when you use an action that deals rolled damage to a bleeding creature you gain 2 surges.',
								}),
							],
							level10: [
								ElementFactory.FeatureFactory.create({
									...
									name: 'Reaping Scythe',
									description:
										'The deinonychus’s claws slash at creatures underfoot. While rampaging, the first time on a turn the deinonycus moves adjacent to each enemy or enters their space, the deinonychus deals damage to the enemy equal to the deinonychus’s Might score.',
								}),
							],
						}),
						ElementFactory.createSummon({
								...
								features: [
									...
									ElementFactory.FeatureFactory.createAbility({
										ability: ElementFactory.createAbility({
											...
											sections: [
												ElementFactory.createAbilitySectionText(
													'M damage of the attuned damage type (see Elementally Attuned)'
												),
												ElementFactory.createAbilitySectionSpend({
													repeatable: true,
									...
									ElementFactory.FeatureFactory.create({
										...
										description:
											'When you gain this companion, choose a damage type from acid, cold, corruption, fire, lightning, poison, or sonic. The drake is attuned to that damage type. Their attuned damage type affects their other features.',
									}),
									ElementFactory.FeatureFactory.create({
							...
							level3: [
								ElementFactory.FeatureFactory.create({
									...
									name: 'Endless Breath',
									description:
										'When the drake uses Drake Breath, they don’t need to spend ferocity to change its size and damage.',
								}),
							],
							level6: [
								ElementFactory.FeatureFactory.create({
...
Additionally, you can use Drake Breath. You don’t need to spend ferocity to change its size and damage.`,
							...
							level10: [
								ElementFactory.FeatureFactory.create({
									...
									description:
										'While the drake is rampaging, you and your companion gain immunity to the drake’s attuned damage type, and when you or the drake hit a creature with an attack the creature is dragonsealed (save ends). While dragonsealed, the creature has weakness 10 against the drake’s attuned damage type.',
								}),
							],
						}),
						ElementFactory.createSummon({
								...
								features: [
									...
									ElementFactory.FeatureFactory.createAbility({
										ability: ElementFactory.createAbility({
											...
											name: 'Absorb',
											description:
												'With a sickening squelch, the sphere oozes around their hapless prey.',
											type: ElementFactory.AbilityTypeFactory.createManeuver(),
											keywords: [
												AbilityKeyword.Companion,
												AbilityKeyword.Melee,
											...
											sections: [
												ElementFactory.createAbilitySectionText(
													'2 + M acid damage; A < [average], the sphere moves into the target’s space. If the target is completely within the sphere’s space, the target is grabbed.'
												),
												ElementFactory.createAbilitySectionSpend({
									...
									ElementFactory.FeatureFactory.create({
										...
										name: 'Gelatinous',
										description:
											'The sphere can share a creature’s space. While sharing a creature’s space, the sphere has line of effect to the creature. If the creature is completely within the sphere’s space, the creature has line of effect only to the sphere. The sphere’s space is difficult terrain.',
									}),
									ElementFactory.FeatureFactory.create({
										id: 'beastheart-1-2a-7-6',
										name: 'Roll With It',
										description:
											'When the sphere would gain the prone condition, they can instead shift one square.',
									}),
									ElementFactory.FeatureFactory.create({
							...
							level3: [
								ElementFactory.FeatureFactory.create({
									...
									name: 'Suck it Up',
									description:
										'When the sphere strikes a creature while rampaging, the creature is pulled up to 3 squares into the sphere’s space. If the creature ends this movement completely within the sphere, the creature is grabbed.',
								}),
							],
							level6: [
								ElementFactory.FeatureFactory.create({
									...
									name: 'A Burning Inside Me',
									description:
										'While the sphere is rampaging, your arms and legs become viscous and stretchy. Your speed and melee distance gain a +2 bonus.',
								}),
							],
							level10: [
								ElementFactory.FeatureFactory.create({
						...
						ElementFactory.createSummon({
								...
								features: [
									...
									ElementFactory.FeatureFactory.createAbility({
										ability: ElementFactory.createAbility({
											...
											target: 'One creature or object',
											sections: [
												ElementFactory.createAbilitySectionText('2 + M fire damage'),
												ElementFactory.createAbilitySectionSpend({
							...
							level3: [
								ElementFactory.FeatureFactory.create({
									...
									description:
										'When the hellhound strikes a creature while rampaging, a target who has P < [average] is frightened.',
								}),
							],
							level6: [
								ElementFactory.FeatureFactory.create({
									...
									name: 'Mad Dog',
									description:
										'While the hellhound is rampaging, your jaws slaver with acidic foam. When you strike a creature, you deal extra acid damage equal to your Might score.',
								}),
							],
							level10: [
								ElementFactory.FeatureFactory.create({
									...
									description:
										'While the hellhound is rampaging, you and the hellhound are surrounded by an aura of flames. Enemies that start their turn adjacent to you or the hellhound take fire damage equal to the hellhound’s Might score.',
								}),
							],
						}),
						ElementFactory.createSummon({
...
A dazzled creature can’t have line of effect to targets who aren’t adjacent to them.`),
							...
							level3: [
								ElementFactory.FeatureFactory.create({
									...
									name: 'Hit and Run',
									description:
										'When the lightbender strikes a creature while rampaging, the lightbender can teleport up to 5 squares and use the Hide maneuver.',
								}),
							],
							level6: [
								ElementFactory.FeatureFactory.create({
									...
									name: 'Lightbearer',
									description:
										'While the lightbender is rampaging, you can use a free maneuver to glow with blinding light or to extinguish the glow. The glow is extinghished when the rampage ends. While glowing, your skin sheds light for 10 squares and strikes against you take a bane.',
								}),
							],
							level10: [
								ElementFactory.FeatureFactory.create({
						...
						ElementFactory.createSummon({
								...
								features: [
									...
									ElementFactory.FeatureFactory.createAbility({
										ability: ElementFactory.createAbility({
											...
											name: 'Pounce',
											description:
												'The panther bunches themself up and then uncoils into a deadly leap.',
											type: ElementFactory.AbilityTypeFactory.createManeuver(),
											keywords: [
												AbilityKeyword.Companion,
												AbilityKeyword.Melee,
									...
									ElementFactory.FeatureFactory.create({
										...
										name: 'Mighty Spring',
										description:
											'When the panther takes the Advance move action or takes the Charge action, as part of the movement they can jump up to their speed in any direction, including vertically.',
									}),
								],
							}),
							isSignature: false,
							...
							level3: [
								ElementFactory.FeatureFactory.create({
									...
									description:
										'When the panther strikes a creature while rampaging, the creature is knocked prone.',
								}),
							],
							level6: [
								ElementFactory.FeatureFactory.create({
									...
									name: 'Single Bound',
									description:
										'While the panther is rampaging, once on your turn you can use a free maneuver to jump up to a number of squares equal to your speed.',
								}),
							],
							level10: [
								ElementFactory.FeatureFactory.create({
									...
									name: 'Panther Spirit',
									description:
										'While the panther is rampaging, you and the panther are invisible and can pass through objects and terrain as if they were difficult terrain. A creature that ends their turn inside a solid object in this way is teleported to the last empty space they occupied.',
								}),
							],
						}),
						ElementFactory.createSummon({
							monster: ElementFactory.createMonster({
								...
								features: [
									...
									ElementFactory.FeatureFactory.create({
										...
										description:
											'When the spider strikes a restrained creature, the spider deals extra poison damage equal to twice the spider’s Intuition score.',
									}),
								],
							}),
							isSignature: false,
							...
							level3: [
								ElementFactory.FeatureFactory.create({
									...
									name: 'Dripping Fangs',
									description:
										'When the spider hits a creature with a strike while rampaging, the creature takes poison damage equal to the spider’s Might score.',
								}),
							],
							level6: [
								ElementFactory.FeatureFactory.create({
									...
									name: 'Web Slinger',
									description:
										'While the spider is rampaging, once on your turn you can use a free maneuver to shoot a web to a ceiling, wall, or sturdy object above you within 5 squares. You can then fly in a straight line to any space within 5 squares of that object.',
								}),
							],
							level10: [
								ElementFactory.FeatureFactory.create({
									...
									name: 'Life Drinker',
									description:
										'While the spider is rampaging, when you or the spider attack with a maneuver that deals damage, the attacker regains Stamina equal to the damage dealt.',
								}),
							],
						}),
						ElementFactory.createSummon({
								...
								features: [
									...
									ElementFactory.FeatureFactory.createAbility({
										ability: ElementFactory.createAbility({
											...
											sections: [
												ElementFactory.createAbilitySectionText(
													'2 + M poison damage; the sporeling is invisible to the enemy until the end of the sporeling’s next turn or the sporeling deals damage to the enemy.'
												),
												ElementFactory.createAbilitySectionSpend({
									...
									ElementFactory.FeatureFactory.create({
										...
										name: 'Skulker',
										description:
											'The sporeling can end their movement in allies’ spaces. While in an ally’s space, the sporeling has cover.',
									}),
								],
							}),
							isSignature: false,
							...
							level3: [
								ElementFactory.FeatureFactory.create({
									...
									name: 'Slowing Spores',
									description:
										'When the sporeling hits a creature with a strike while rampaging, the creature is slowed (EoT).',
								}),
							],
							level6: [
								ElementFactory.FeatureFactory.create({
									...
									name: 'Plant Walk',
									description:
										'While the sporeling is rampaging, once on your turn can use a free maneuver to teleport to a space within 15 squares, provided the space or an adjacent space contains your companion or size 1S or larger plants or fungus. You then gain an edge on the next strike you make before the end of your turn.',
								}),
							],
							level10: [
								ElementFactory.FeatureFactory.create({
									...
									description:
										'While the sporeling is rampaging, your and the sporeling’s limbs sprout rootlike, gripping mycelia. While the sporeling is rampaging, you and the sporeling can’t be force moved or knocked prone, and when you or the sporeling strike a creature who is M < [strong] the creature is grabbed.',
								}),
							],
						}),
						ElementFactory.createSummon({
								...
								features: [
									...
									ElementFactory.FeatureFactory.createAbility({
										ability: ElementFactory.createAbility({
											...
											name: 'Clamping Jaws',
											description:
												'With an unnerving growl, the wolf sinks powerful teeth onto their quarry.',
											type: ElementFactory.AbilityTypeFactory.createManeuver(),
											keywords: [
												AbilityKeyword.Companion,
												AbilityKeyword.Melee,
							...
							level3: [
								ElementFactory.FeatureFactory.create({
									...
									description:
										'When the wolf hits a creature with a strike while rampaging, the creature is grabbed.',
								}),
							],
							level6: [
								ElementFactory.FeatureFactory.create({
									...
									description:
										'While the wolf is rampaging, both of you have a +2 bonus to speed and creatures within 5 squares can’t be hidden or concealed from you or your companion.',
								}),
							],
							level10: [
								ElementFactory.FeatureFactory.create({
									...
									name: 'Dire Wolf',
									description:
										'While the wolf is rampaging, you and the wolf are surrounded by an aura of dread. Enemies that start their turn adjacent to you or the wolf who have P < [strong] are frightened (EoT).',
								}),
							],
						}),
					],
...
**One Hero**. You and your companion count as one hero for determining the difficulty of combats, montage tests, and so on.`,
				...
				ElementFactory.FeatureFactory.createAbility({
					ability: ElementFactory.createAbility({
						...
						sections: [
							ElementFactory.createAbilitySectionText(
								'You spend a Recovery as your partner rips their way out of your chest or climbs from your unnaturally wide jaws. Your partner teleports to your space over any distance, even if they don’t have line of effect to you. Your partner gains temporary Stamina equal to their recovery value.'
							),
							ElementFactory.createAbilitySectionSpend({
				...
				ElementFactory.FeatureFactory.createAbility({
					ability: ElementFactory.createAbility({
						...
						sections: [
							ElementFactory.createAbilitySectionText(
								'Before taking this action, your companion moves a number of squares equal to their Intuition score straight toward the closest enemy they are aware of, avoiding damaging terrain and ending the movement when they are adjacent to an enemy. If they are within distance of the enemy at the end of this movement, they make the following power roll.'
							),
							...
							ElementFactory.createAbilitySectionPackage('feral-strike'),
						],
					}),
				}),
				ElementFactory.FeatureFactory.createPackage({
					id: 'beastheart-1-5',
					name: 'Rampage',
					description: `
		...
		},
		{
			...
			features: [
				...
				ElementFactory.FeatureFactory.createHeroicResource({
					...
					description:
						'You can spend 1 primordial power as a free maneuver to allow you each to take a main action on your turn, instead of a main action and a maneuver. For that turn, the ferocity cost of heroic abilities is reduced by 1.',
				}),
				ElementFactory.FeatureFactory.createSkillChoice({
					id: 'beastheart-10-5',
					name: 'Skill',
	...
	abilities: [
		ElementFactory.createAbility({
			...
			sections: [
				...
				ElementFactory.createAbilitySectionText(
					'You can spend a surge to allow your partner to use this ability as a free triggered action, targeting a different target with the same power roll and not using this effect.'
				),
			],
		}),
		ElementFactory.createAbility({
			...
			sections: [
				...
				ElementFactory.createAbilitySectionText(
					'If the target is not prone, they must use a free triggered action to fall prone or take extra damage equal to twice your Intuition score. Your companion can shift up to a number of spaces equal to their Intuition score.'
				),
			],
		}),
		ElementFactory.createAbility({
			...
			sections: [
				...
				ElementFactory.createAbilitySectionText(
					'Your companion makes a free strike. You both shift up to a number of squares equal to your Intuition score.'
				),
			],
		}),
		ElementFactory.createAbility({
			...
			name: 'Tag Me In',
			description:
				'Drawing on your primordial magic, you magically switch places with an ally, giving them a breather while you deliver a surprise attack.',
			type: ElementFactory.AbilityTypeFactory.createMain(),
			keywords: [
				AbilityKeyword.Beastheart,
				AbilityKeyword.Magic,
			...
			sections: [
				ElementFactory.createAbilitySectionText(
					'If you and a willing ally are standing on the ground within 10 squares of each other, you can teleport, swapping places. If you do so, you gain an edge on this ability’s power roll.'
				),
				ElementFactory.createAbilitySectionRoll(
					ElementFactory.createPowerRoll({
						characteristic: Characteristic.Intuition,
		...
		ElementFactory.createAbility({
			...
			sections: [
				...
				ElementFactory.createAbilitySectionText(
					'You and your companion can shift up to a number of squares equal to the number of squares the target was moved.'
				),
			],
		}),
		ElementFactory.createAbility({
			...
			sections: [
				...
				ElementFactory.createAbilitySectionText(
					'This ability’s push can pass through your space but not end there. If it passes through your space, the target falls prone and takes extra damage equal to your Intuition score.'
				),
			],
		}),
		ElementFactory.createAbility({
		...
		ElementFactory.createAbility({
			...
			sections: [
				...
				ElementFactory.createAbilitySectionText(
					'If the target is winded or bleeding after the attack, you gain two surges.'
				),
			],
		}),
		ElementFactory.createAbility({
			...
			sections: [
				ElementFactory.createAbilitySectionText(
					'You can spend a Recovery. Each enemy in the area is taunted (EoT). You gain 3 temporary Stamina for each enemy in the area.'
				),
				ElementFactory.createAbilitySectionSpend({
		...
		ElementFactory.createAbility({
			...
			distance: [ElementFactory.DistanceFactory.create({ type: AbilityDistanceType.Cube, value: 3, within: 5 })],
			target: 'Each enemy in the area',
			cost: 5,
			sections: [
				ElementFactory.createAbilitySectionRoll(
				...
				ElementFactory.createAbilitySectionText(
					'If your companion is in the area, your companion deals fire damage equal to their Intuition score to each enemy in the area.'
				),
			],
		}),
		ElementFactory.createAbility({
			...
			sections: [
				...
				ElementFactory.createAbilitySectionText(
					'If you grab the target while your companion is adjacent to the target, your companion can make a melee free strike against the target.'
				),
			],
		}),
		ElementFactory.createAbility({
			...
			type: ElementFactory.AbilityTypeFactory.createTrigger(
				'You use an ability that reduces the creature to 0 Stamina.'
			),
		...
		ElementFactory.createAbility({
			...
			sections: [
				...
				ElementFactory.createAbilitySectionText(
					'You are bleeding (save ends). Until you are no longer bleeding, your companion has an edge on power rolls.'
				),
			],
		}),
		ElementFactory.createAbility({
			...
			description:
				'The spectral jaws of a trap clamp on a foe, chaining them to you and draining their life essence.',
			type: ElementFactory.AbilityTypeFactory.createMain(),
			...
			sections: [
				...
				ElementFactory.createAbilitySectionText(
					'When a target weakened by this ability fails their saving throw against this ability while more than 3 squares from you, as a free triggered action you can pull the target up to a number of squares equal to your Intuition score.'
				),
			],
		}),
		ElementFactory.createAbility({
			...
			sections: [
				...
				ElementFactory.createAbilitySectionText(
					'The next creature to damage the target before the start of your next turn gains three surges.'
				),
			],
		}),
		ElementFactory.createAbility({
			...
			sections: [
				...
				ElementFactory.createAbilitySectionText(
					'Each ally adjacent to the target can use a triggered free action to deal damage to the target equal to the ally’s highest characteristic.'
				),
			],
		}),
		ElementFactory.createAbility({
			...
			sections: [
				...
				ElementFactory.createAbilitySectionText('If you are hidden, you remain hidden after the attack.'),
			],
		}),
		ElementFactory.createAbility({
			...
			sections: [
				...
				ElementFactory.createAbilitySectionText(
					'If your companion is adjacent to the target, you can ignore the target’s Stability.'
				),
			],
		}),
		ElementFactory.createAbility({
			...
			name: 'Rend in Two',
			description:
				'In a gruesome display, you and your companion rip off a pinioned enemy’s limb or other body part and toss it away.',
			type: ElementFactory.AbilityTypeFactory.createMain(),
			...
			sections: [
				...
				ElementFactory.createAbilitySectionText(
					'If the target is grabbed by your partner, the target takes extra damage equal to your Might score plus your companion’s Might score. If this ability reduces a target to 0 Stamina, each enemy within 2 squares who has P < average is frightened (save ends).'
				),
			],
		}),
		ElementFactory.createAbility({
			...
			sections: [
				...
				ElementFactory.createAbilitySectionText(
					'Your companion can repeat the attack as a melee attack, making their own power roll. Both power rolls have an edge if either of you is bleeding, dying, or winded, and your power roll has a double edge if your companion is dead or otherwise unable to act.'
				),
			],
		}),
		ElementFactory.createAbility({
			...
			description:
				'Wrenching power from your primordial bond, you unleash elemental power in a devastating conflagration that you can’t control.',
			type: ElementFactory.AbilityTypeFactory.createMain(),
		...
		ElementFactory.createAbility({
			...
			sections: [
				ElementFactory.createAbilitySectionText(
					'You each use a different ability that costs 9 or less ferocity and that uses a maneuver or an action. These abilities cost no ferocity. If an ability lets you spend extra ferocity for an enhanced effect, you can’t do so.'
				),
			],
		}),
		ElementFactory.createAbility({
			...
			sections: [
				...
				ElementFactory.createAbilitySectionText(
					'Up to three creatures within 2 squares of the target gain temporary Stamina equal to half the damage you dealt.'
				),
			],
		}),
	],
