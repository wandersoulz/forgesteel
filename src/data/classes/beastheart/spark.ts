...
export const spark: SubClassInterface = {
	id: 'beastheart-sub-4',
	name: 'Spark',
	description:
		'Your connection with nature has imbued you and your companion with the raging magic of the elemental storm. Flame, frost, and lightning crackle from your hands and claws.',
	featuresByLevel: [
		{
			level: 1,
			features: [
					...
					ability: ElementFactory.createAbility({
						...
						sections: [
							ElementFactory.createAbilitySectionText(
								'You teleport up to 5 spaces and halve the triggering damage.'
							),
		...
		},
		{
			...
			features: [
				...
				ElementFactory.FeatureFactory.create({
					...
					name: 'Elemental Core',
					description:
						'Whenever you or your companion deals damage with no type or deals cold, fire, lightning, or sonic damage, you can change the damage type to cold, fire, lightning, or sonic damage.',
				}),
					...
					options: [
						{
							feature: ElementFactory.FeatureFactory.createAbility({
								ability: ElementFactory.createAbility({
									...
									name: 'Burning Lash',
									description:
										'A blazing whip of energy lashes out to curl around a foe’s legs and burn them to a crisp.',
							...
							feature: ElementFactory.FeatureFactory.createAbility({
								ability: ElementFactory.createAbility({
									...
									sections: [
										...
										ElementFactory.createAbilitySectionText(
											'Until the end of your next turn, you and your companion can fly and both of your speed increases by 3.'
										),
									],
								}),
							}),
						...
						},
						{
							feature: ElementFactory.FeatureFactory.createAbility({
								ability: ElementFactory.createAbility({
									...
									name: 'Killing Frost',
									description:
										'Black frost freezes boots to the floor and creeps up trapped victims until they are completely encased in ice.',
									type: ElementFactory.AbilityTypeFactory.createMain(),
									keywords: [AbilityKeyword.Area, AbilityKeyword.Companion, AbilityKeyword.Magic],
									distance: [
										ElementFactory.DistanceFactory.create({
									...
									sections: [
										...
										ElementFactory.createAbilitySectionText(
											'While restrained by this ability, a creature takes 5 cold damage at the start of each of your turns. A creature killed by this ability becomes an ice statue; their space is difficult terrain.'
										),
									],
								}),
							}),
					...
					options: [
						{
							feature: ElementFactory.FeatureFactory.createAbility({
								ability: ElementFactory.createAbility({
									...
									description:
										'They’d tell stories in hushed tones of your companion’s last stand—if any of them were left to tell the tale.',
									...
									sections: [
										ElementFactory.createAbilitySectionText(
											'Your companion makes a power roll, which affects each enemy in a 5 burst.'
										),
										ElementFactory.createAbilitySectionRoll(
											ElementFactory.createPowerRoll({
												characteristic: Characteristic.Might,
										...
										ElementFactory.createAbilitySectionText(
											'Your companion dies. If you are dead and in the area, you are restored to life with 1 Stamina. You and each ally in the area can spend 1 or 2 Recoveries.'
										),
									],
								}),
							}),
