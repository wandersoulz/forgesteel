...
export const blackAsh: SubClassInterface = {
	id: 'shadow-sub-1',
			...
			features: [
				...
				ElementFactory.FeatureFactory.createAbility({
					ability: ElementFactory.createAbility({
						...
						sections: [
							ElementFactory.createAbilitySectionText(
								'You halve the damage, then can teleport up to 4 squares after the triggering effect resolves.'
							),
							ElementFactory.createAbilitySectionSpend({
								repeatable: true,
								effect: 'You teleport 1 additional square for each insight spent.',
							...
							feature: ElementFactory.FeatureFactory.createAbility({
								ability: ElementFactory.createAbility({
									...
									type: ElementFactory.AbilityTypeFactory.createTrigger(
										'You use your In All This Confusion ability.',
										{ free: true }
									),
									keywords: [
										AbilityKeyword.Melee,
									...
									sections: [
										ElementFactory.createAbilitySectionText(
											'You ignore any effects associated with the damage that triggered your In All This Confusion ability. Before you teleport, you can make a free strike against a creature who damaged you to trigger In All This Confusion. After you teleport, you can spend a Recovery.'
										),
									],
								}),
							}),
