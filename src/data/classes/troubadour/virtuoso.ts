...
export const virtuoso: SubClassInterface = {
	id: 'tWBfpTKQXZ12jGsU',
	name: 'Virtuoso',
	description:
					...
					features: [
						...
						ElementFactory.FeatureFactory.createAbility({
							ability: ElementFactory.createAbility({
								...
								distance: [
									ElementFactory.DistanceFactory.create({ type: AbilityDistanceType.Aura, value: 5 }),
								],
					...
					options: [
						{
							feature: ElementFactory.FeatureFactory.createAbility({
								ability: ElementFactory.createAbility({
									...
									type: ElementFactory.AbilityTypeFactory.createMain(),
									keywords: [AbilityKeyword.Area, AbilityKeyword.Magic],
									distance: [ElementFactory.DistanceFactory.createSpecial('Three 3 cubes within 1')],
									target: 'Each enemy in the area',
									cost: 9,
									sections: [
										ElementFactory.createAbilitySectionText('A prone target ignores this ability.'),
										ElementFactory.createAbilitySectionRoll(
											ElementFactory.createPowerRoll({
												characteristic: [Characteristic.Presence],
