...
export const troubadour: HeroClassInterface = {
	id: '9y3Jx3koKZipiPh1',
	name: 'Troubadour',
...
Jackson Bootblack`,
	...
	subclassCount: 1,
	primaryCharacteristicsOptions: [[Characteristic.Agility, Characteristic.Presence]],
...
You can have a number of bonds active equal to your level. When you form a bond with a new NPC that would exceed the limit, you must choose which of your active bonds to lose.`,
				...
				ElementFactory.FeatureFactory.createAbility({
					ability: ElementFactory.createAbility({
						...
						type: ElementFactory.AbilityTypeFactory.createNoAction(),
		...
		},
		{
			...
			features: [
				...
				ElementFactory.FeatureFactory.createChoice({
					...
					options: [
						{
							feature: ElementFactory.FeatureFactory.createHeroicResourceGain({
								id: 'bPZ0jgAHVi08ZX2X',
								name: 'Melodrama #1',
								tag: '',
	...
	abilities: [
		ElementFactory.createAbility({
			...
			sections: [
				...
				ElementFactory.createAbilitySectionText('You can shift up to 3 squares.'),
		...
		ElementFactory.createAbility({
			...
			type: ElementFactory.AbilityTypeFactory.createMain(),
			keywords: [AbilityKeyword.Magic, AbilityKeyword.Melee, AbilityKeyword.Ranged, AbilityKeyword.Strike],
			distance: [ElementFactory.DistanceFactory.createMelee(), ElementFactory.DistanceFactory.createRanged(10)],
		...
		ElementFactory.createAbility({
			...
			sections: [
				...
				ElementFactory.createAbilitySectionText('Each ally in the area can shift up to 2 squares.'),
			],
		}),
		ElementFactory.createAbility({
