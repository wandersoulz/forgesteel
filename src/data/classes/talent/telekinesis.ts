...
export const telekinesis: SubClassInterface = {
	id: 'talent-sub-2',
	name: 'Telekinesis',
					...
					ability: ElementFactory.createAbility({
						...
						sections: [
							ElementFactory.createAbilitySectionText(
								'You slide the target up to a number of squares equal to your Reason score.'
							),
			...
			features: [
				ElementFactory.FeatureFactory.createAbility({
					ability: ElementFactory.createAbility({
						...
						sections: [
							ElementFactory.createAbilitySectionText(
								'You reduce the falling damage by an amount equal to 2 + your Reason score.'
							),
						],
					}),
				}),
			...
			features: [
				ElementFactory.FeatureFactory.createAbility({
					ability: ElementFactory.createAbility({
						...
						sections: [
							ElementFactory.createAbilitySectionText(
								'Each target can fly until the start of your next turn, and can immediately shift up to their speed. You can also shift up to your speed. While flying, a target’s stability is reduced to 0 and can’t be increased.'
							),
							ElementFactory.createAbilitySectionSpend({
								value: 5,
