...
export const chronopathy: SubClassInterface = {
	id: 'talent-sub-1',
	name: 'Chronopathy',
	description:
			...
			features: [
					...
					ability: ElementFactory.createAbility({
						...
						sections: [
							ElementFactory.createAbilitySectionText(
								'The target shifts up to a number of squares equal to your Reason score.'
							),
				...
				ElementFactory.FeatureFactory.createAbility({
					ability: ElementFactory.createAbility({
						...
						type: ElementFactory.AbilityTypeFactory.createTrigger('The target makes an ability roll.'),
						keywords: [AbilityKeyword.Psionic, AbilityKeyword.Ranged],
						distance: [ElementFactory.DistanceFactory.createRanged(10)],
						target: 'Self or one creature',
						sections: [
			...
			features: [
				...
				ElementFactory.FeatureFactory.createAbility({
					ability: ElementFactory.createAbility({
						...
						sections: [
							ElementFactory.createAbilitySectionText(
								'The target is teleported to an unoccupied space adjacent to you, taking no damage and suffering no additional effects if this movement would get them out of harm’s way.'
							),
							ElementFactory.createAbilitySectionField({
								name: 'Strained',
