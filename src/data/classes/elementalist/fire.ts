...
export const fire: SubClassInterface = {
					...
					ability: ElementFactory.createAbility({
						...
						sections: [
							ElementFactory.createAbilitySectionText(
								'You heat the target and cause it to melt or combust, destroying it. If the object is larger than 1 square, then only the square of the object you touch is destroyed.'
							),
						],
					}),
				}),
				ElementFactory.FeatureFactory.createAbility({
					ability: ElementFactory.createAbility({
						...
						type: ElementFactory.AbilityTypeFactory.createTrigger(
							'The target force moves a creature or object.'
						),
						...
						sections: [
							ElementFactory.createAbilitySectionText(
								'The forced movement distance gains a bonus equal to your Reason score.'
							),
...
At the start of a combat encounter, you gain a number of surges equal to your Victories. Whenever you spend a surge to deal extra damage, you can make that damage fire damage`,
				...
				ElementFactory.FeatureFactory.createDamageModifier({
					...
					modifiers: [
						ElementFactory.DamageModifierFactory.createValuePlusPerLevel({
