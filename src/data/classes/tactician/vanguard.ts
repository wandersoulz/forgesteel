...
export const vanguard: SubClassInterface = {
	id: 'tactician-sub-3',
	name: 'Vanguard',
	description:
			...
			features: [
				...
				ElementFactory.FeatureFactory.createAbility({
					ability: ElementFactory.createAbility({
						...
						type: ElementFactory.AbilityTypeFactory.createTrigger('A creature deals damage to the target.'),
						...
						},
						{
							feature: ElementFactory.FeatureFactory.createAbility({
								ability: ElementFactory.createAbility({
									...
									cost: 11,
									sections: [
										ElementFactory.createAbilitySectionText('The target is marked by you.'),
										ElementFactory.createAbilitySectionRoll(
											ElementFactory.createPowerRoll({
												characteristic: Characteristic.Might,
												tier1: '8 + M damage',
