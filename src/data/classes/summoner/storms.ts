...
export const circleofStorms: SubClassInterface = {
	id: 'summoner-sub-2',
	name: 'Circle of Storms',
	description:
		'You are a storm caster who summons elementals from Quintessence. This portfolio contains forces of nature that leave a big impact on the environment.',
	featuresByLevel: [
		{
			level: 1,
			features: [
				ElementFactory.FeatureFactory.create({
					...
					name: 'Communication',
					description:
						'You can communicate with creatures that have the Elemental keyword even if you don’t share a language.',
				}),
				ElementFactory.FeatureFactory.create({
					id: 'summoner-2-1-2',
					...
					options: [
						...
						ElementFactory.createSummon({
							monster: ElementFactory.createMonster({
								...
								speed: ElementFactory.createSpeed(4, 'climb'),
								stamina: 3,
								stability: 0,
								freeStrikeDamage: 1,
								characteristics: ElementFactory.createCharacteristics(2, -2, 0, 0, 2),
					...
					options: [
						ElementFactory.createSummon({
							monster: ElementFactory.createMonster({
								...
								stability: 0,
								freeStrikeDamage: 3,
								characteristics: ElementFactory.createCharacteristics(-1, 2, 3, 0, -1),
								features: [
									ElementFactory.FeatureFactory.createDamageModifier({
						...
						ElementFactory.createSummon({
							monster: ElementFactory.createMonster({
								...
								encounterValue: 0,
								size: ElementFactory.createSize(2),
								speed: ElementFactory.createSpeed(4, 'swim'),
								stamina: 5,
								stability: 0,
								freeStrikeDamage: 4,
								characteristics: ElementFactory.createCharacteristics(3, -2, 0, 2, -2),
								features: [
									ElementFactory.FeatureFactory.createBonus({
						...
						ElementFactory.createSummon({
							monster: ElementFactory.createMonster({
								...
								characteristics: ElementFactory.createCharacteristics(-1, 2, 0, 0, 3),
								features: [
									ElementFactory.FeatureFactory.createDamageModifier({
					...
					options: [
						...
						ElementFactory.createSummon({
							monster: ElementFactory.createMonster({
								...
								characteristics: ElementFactory.createCharacteristics(4, 2, 0, 0, 3),
								features: [
									ElementFactory.FeatureFactory.createDamageModifier({
...
As a harbinger of ruin, the dragon’s Portent has incredibly potent impact and control of the environment. Their final shape has yet to be determined; use this to your advantage and call upon the affinity that will end conflict the quickest.`,
								...
								stability: 4,
								freeStrikeDamage: 9,
								characteristics: ElementFactory.createCharacteristics(2, 2, 5, 5, 2),
								features: [
									ElementFactory.FeatureFactory.createBonus({
									...
									ElementFactory.FeatureFactory.create({
										...
										name: 'Sealing Strike',
										description:
											'The Portent’s free strikes inflict M < [strong] slowed (save ends). While slowed this way, the target takes 1d6 aﬃnity damage at the start of each of their turns.',
									}),
									ElementFactory.FeatureFactory.create({
										id: 'summoner-2-8-2a-2',
										name: 'Champion’s Ire',
