...
export const circleOfBlight: SubClassInterface = {
	id: 'summoner-sub-1',
	name: 'Circle of Blight',
	description:
		'You are a demonologist who calls forth demons from the Abyssal Waste. Your portfolio includes shapechanging demons that grow in hunger and power over time.',
	featuresByLevel: [
		{
			level: 1,
			features: [
				ElementFactory.FeatureFactory.create({
					...
					name: 'Communication',
					description:
						'You can communicate with creatures that have the Abyssal keyword even if you don’t share a language.',
				}),
				ElementFactory.FeatureFactory.create({
					id: 'summoner-1-1-2',
					name: 'Soulsense',
...
When you finish a respite, you can always perceive the soul trails of each creature that took the respite with you until your next respite.`,
					...
					options: [
						...
						ElementFactory.createSummon({
							monster: ElementFactory.createMonster({
								...
								speed: ElementFactory.createSpeed(4, 'teleport'),
								stamina: 2,
								stability: 0,
								freeStrikeDamage: 2,
								characteristics: ElementFactory.createCharacteristics(-1, 0, -1, -1, 2),
								features: [
									ElementFactory.FeatureFactory.createDamageModifier({
					...
					options: [
						ElementFactory.createSummon({
							monster: ElementFactory.createMonster({
								...
								characteristics: ElementFactory.createCharacteristics(0, 2, -1, -1, 0),
								features: [
									ElementFactory.FeatureFactory.createDamageModifier({
						...
						ElementFactory.createSummon({
							monster: ElementFactory.createMonster({
								...
								stability: 1,
								freeStrikeDamage: 5,
								characteristics: ElementFactory.createCharacteristics(2, 1, -1, -1, 0),
								features: [
									ElementFactory.FeatureFactory.createDamageModifier({
		...
		},
		{
			level: 2,
			features: [
				ElementFactory.FeatureFactory.createFixture({
					fixture: {
					...
					options: [
						ElementFactory.createSummon({
							monster: ElementFactory.createMonster({
								...
								characteristics: ElementFactory.createCharacteristics(-2, 0, -1, 3, 3),
								features: [
									ElementFactory.FeatureFactory.createDamageModifier({
									...
									ElementFactory.FeatureFactory.create({
										...
										name: 'Gushing Strike',
										description:
											'The spewler’s ranged free strikes have a distance of 10 and slide the target R + 2 squares.',
									}),
									ElementFactory.FeatureFactory.create({
						...
						ElementFactory.createSummon({
							monster: ElementFactory.createMonster({
								...
								stability: 3,
								freeStrikeDamage: 3,
								characteristics: ElementFactory.createCharacteristics(3, 0, 2, 1, 1),
								features: [
									ElementFactory.FeatureFactory.createDamageModifier({
						...
						ElementFactory.createSummon({
							monster: ElementFactory.createMonster({
								...
								characteristics: ElementFactory.createCharacteristics(2, 3, 0, -1, -1),
								features: [
									ElementFactory.FeatureFactory.createDamageModifier({
					...
					options: [
						ElementFactory.createSummon({
							monster: ElementFactory.createMonster({
								...
								freeStrikeDamage: 7,
								freeStrikeType: DamageType.Corruption,
								characteristics: ElementFactory.createCharacteristics(0, 0, -1, 4, 3),
								features: [
									ElementFactory.FeatureFactory.createDamageModifier({
						...
						ElementFactory.createSummon({
							monster: ElementFactory.createMonster({
								...
								stability: 2,
								freeStrikeDamage: 8,
								characteristics: ElementFactory.createCharacteristics(4, 3, 0, -1, 0),
								features: [
									ElementFactory.FeatureFactory.createDamageModifier({
						...
						ElementFactory.createSummon({
							monster: ElementFactory.createMonster({
								...
								freeStrikeDamage: 7,
								freeStrikeType: DamageType.Psychic,
								characteristics: ElementFactory.createCharacteristics(3, 4, 0, 0, -1),
								features: [
									ElementFactory.FeatureFactory.createDamageModifier({
...
The minions must be reassigned to a new squad if their new name differs from the other squad members.`,
				...
				ElementFactory.FeatureFactory.createSummon({
					id: 'summoner-1-8-2',
...
The demon lord’s Aspect enjoys bringing enemies in close with their appendages or flinging victims and throwing them to the gnashing horde. They’re willing to put your connection to this world at risk if it means taking one more bite.`,
								level: 0,
								role: ElementFactory.createMonsterRole(MonsterOrganizationType.Champion),
								keywords: ['Abyssal', 'Demon'],
								encounterValue: 0,
								size: ElementFactory.createSize(2),
								...
								freeStrikeDamage: 9,
								freeStrikeType: DamageType.Corruption,
								characteristics: ElementFactory.createCharacteristics(2, 5, 5, 2, 2),
								features: [
							...
							level10: [
								...
								ElementFactory.FeatureFactory.createAbility({
									ability: ElementFactory.createAbility({
										...
										type: ElementFactory.AbilityTypeFactory.createChampionAction(),
										distance: [
										...
										sections: [
											ElementFactory.createAbilitySectionText(
												'Each target teleports up to their speed and makes a free strike. If a target has a Save Ends condition, they can inflict the condition onto a creature with their strike and end the condition on themself.'
											),
										],
									}),
								}),
