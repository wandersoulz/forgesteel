...
export const circleOfGraves: SubClassInterface = {
	id: 'summoner-sub-4',
	name: 'Circle of Graves',
	description:
		'You are a necromancer who raises undead creatures from the Necropolitan Ruin. The corporeal and incorporeal creatures under your command are hardy and many.',
	featuresByLevel: [
		{
			level: 1,
			features: [
				ElementFactory.FeatureFactory.create({
					...
					name: 'Communication',
					description:
						'You can communicate with creatures that have the Undead keyword even if you don’t share a language.',
				}),
				ElementFactory.FeatureFactory.create({
					id: 'summoner-4-1-2',
					...
					options: [
						ElementFactory.createSummon({
							monster: ElementFactory.createMonster({
								...
								characteristics: ElementFactory.createCharacteristics(2, -1, 1, 3, -1),
								features: [
									ElementFactory.FeatureFactory.createDamageModifier({
									...
									ElementFactory.FeatureFactory.createAbility({
										ability: ElementFactory.createAbility({
											...
											distance: [ElementFactory.DistanceFactory.createSpecial('Melee R')],
											cost: 'signature',
											sections: [
												ElementFactory.createAbilitySectionRoll(
													ElementFactory.createPowerRoll({
						...
						ElementFactory.createSummon({
							monster: ElementFactory.createMonster({
								...
								stability: 0,
								freeStrikeDamage: 3,
								characteristics: ElementFactory.createCharacteristics(2, 3, -2, 0, 1),
								features: [
									ElementFactory.FeatureFactory.createDamageModifier({
					...
					options: [
						ElementFactory.createSummon({
							monster: ElementFactory.createMonster({
								...
								characteristics: ElementFactory.createCharacteristics(4, 1, 3, 0, 0),
								features: [
									ElementFactory.FeatureFactory.createDamageModifier({
						...
						ElementFactory.createSummon({
							monster: ElementFactory.createMonster({
								...
								stability: 1,
								freeStrikeDamage: 8,
								characteristics: ElementFactory.createCharacteristics(0, 4, 0, 0, 3),
								features: [
									ElementFactory.FeatureFactory.createDamageModifier({
						...
						ElementFactory.createSummon({
							monster: ElementFactory.createMonster({
								...
								stability: 0,
								freeStrikeDamage: 7,
								characteristics: ElementFactory.createCharacteristics(4, 3, 0, 2, 3),
								features: [
									ElementFactory.FeatureFactory.createBonus({
...
The Avatar of death weighs down their foes with conditions so their army can take care of the rest. If an enemy can’t handle it, well then maybe they should just die.`,
								...
								characteristics: ElementFactory.createCharacteristics(5, 2, 5, 2, 2),
								features: [
									ElementFactory.FeatureFactory.createBonus({
