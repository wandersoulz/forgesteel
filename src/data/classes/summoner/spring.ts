...
export const circleOfSpring: SubClassInterface = {
	id: 'summoner-sub-3',
	name: 'Circle of Spring',
	description:
		'You are a feybright who beckons pixies, nixies, and sprites from Arcadia. Your portfolio features ephemeral fey spirits surrounded by weird and powerful magic.',
	featuresByLevel: [
		{
			level: 1,
			features: [
				ElementFactory.FeatureFactory.create({
					...
					name: 'Communication',
					description:
						'You can communicate with creatures that have the Fey keyword even if you don’t share a language.',
				}),
				ElementFactory.FeatureFactory.create({
					id: 'summoner-3-1-2',
					name: 'Fairy Whispers',
					...
					options: [
						ElementFactory.createSummon({
							monster: ElementFactory.createMonster({
								...
								speed: ElementFactory.createSpeed(5, 'swim'),
								stamina: 1,
								stability: 0,
								freeStrikeDamage: 1,
								characteristics: ElementFactory.createCharacteristics(-2, -2, 0, 2, 1),
								features: [
									ElementFactory.FeatureFactory.create({
						...
						ElementFactory.createSummon({
							monster: ElementFactory.createMonster({
								...
								stability: 0,
								freeStrikeDamage: 1,
								characteristics: ElementFactory.createCharacteristics(-3, 1, 0, 0, 2),
								features: [
									ElementFactory.FeatureFactory.create({
					...
					options: [
						ElementFactory.createSummon({
							monster: ElementFactory.createMonster({
								...
								characteristics: ElementFactory.createCharacteristics(-3, 0, 1, 0, 2),
								features: [
					...
					options: [
						ElementFactory.createSummon({
							monster: ElementFactory.createMonster({
								...
								encounterValue: 0,
								size: ElementFactory.createSize(1, 'T'),
								speed: ElementFactory.createSpeed(6, 'swim'),
								stamina: 4,
								stability: 0,
								freeStrikeDamage: 3,
								freeStrikeType: DamageType.Lightning,
								characteristics: ElementFactory.createCharacteristics(-2, 0, 1, 3, 2),
								features: [
									ElementFactory.FeatureFactory.create({
						...
						ElementFactory.createSummon({
							monster: ElementFactory.createMonster({
								...
								characteristics: ElementFactory.createCharacteristics(-1, 3, 0, 1, 2),
								features: [
									ElementFactory.FeatureFactory.createDamageModifier({
						...
						ElementFactory.createSummon({
							monster: ElementFactory.createMonster({
								...
								stability: 1,
								freeStrikeDamage: 3,
								characteristics: ElementFactory.createCharacteristics(0, 2, 4, 0, 3),
								features: [
									ElementFactory.FeatureFactory.createAbility({
										ability: ElementFactory.createAbility({
					...
					options: [
						ElementFactory.createSummon({
							monster: ElementFactory.createMonster({
								...
								freeStrikeDamage: 7,
								freeStrikeType: DamageType.Lightning,
								characteristics: ElementFactory.createCharacteristics(-2, 3, 3, 4, 1),
								features: [
									ElementFactory.FeatureFactory.createDamageModifier({
						...
						ElementFactory.createSummon({
							monster: ElementFactory.createMonster({
								...
								freeStrikeDamage: 8,
								freeStrikeType: DamageType.Poison,
								characteristics: ElementFactory.createCharacteristics(-2, 2, 4, 0, 4),
								features: [
									ElementFactory.FeatureFactory.createDamageModifier({
							...
							monster: ElementFactory.createMonster({
								...
								features: [
									...
									ElementFactory.FeatureFactory.create({
										...
										name: 'Minuscule',
										description:
											'The oleyander has cover while occupying a larger creature’s space.',
									}),
								],
							}),
							cost: 7,
		...
		},
		{
			...
			features: [
				...
				ElementFactory.FeatureFactory.create({
					...
					description:
						'The area affected by your Pixie Dust feature and any of your fey minions’ traits that affect adjacent creatures and/or the area within 1 or more squares of them increase that distance by 1 square.',
				}),
...
The celestial Attendant wants to swarm the map with pixies while limiting their foes’ ability to do anything about it. A single neurotoxic strike is all it takes to move everyone into position.`,
								...
								freeStrikeDamage: 9,
								freeStrikeType: DamageType.Poison,
								characteristics: ElementFactory.createCharacteristics(2, 2, 5, 2, 5),
								features: [
									ElementFactory.FeatureFactory.createBonus({
