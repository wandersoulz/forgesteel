...
export const paragon: SubClassInterface = {
	id: 'censor-sub-3',
	name: 'Paragon',
	description:
		'Without a strong example and a firm hand, the weak will be corrupted. You specialize in setting an example for your order.',
	featuresByLevel: [
		{
			level: 1,
			features: [
				...
				ElementFactory.FeatureFactory.createPackageContent({
					...
					description:
						'The first time on a turn that you use your Judgment ability to judge a creature, you can vertical pull the judged creature up to a number of squares equal to twice your Presence score.',
					tag: 'censor-judgment',
				}),
			],
		},
								...
								ability: ElementFactory.createAbility({
									...
									sections: [
										ElementFactory.createAbilitySectionText(
											'Until the end of the encounter or until you are dying, each target in the aura gains 1 surge at the end of each of your turns.'
										),
									],
								}),
							}),
							...
							feature: ElementFactory.FeatureFactory.createAbility({
								ability: ElementFactory.createAbility({
									...
									sections: [
										...
										ElementFactory.createAbilitySectionText(
											'Each ally can shift up to 2 squares and gains 2 surges before making the strike.'
										),
									],
								}),
							}),
							...
							feature: ElementFactory.FeatureFactory.createAbility({
								ability: ElementFactory.createAbility({
									...
									type: ElementFactory.AbilityTypeFactory.createTrigger(
										'A creature makes a strike against the target.',
										{ free: true }
									),
									...
									sections: [
										ElementFactory.createAbilitySectionText(
											'The target is unaffected by the strike and you become the target instead, even if you aren’t a valid target for it. You take half the damage from the strike, and the target gains 3 surges.'
										),
									],
								}),
							}),
