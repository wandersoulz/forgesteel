...
export class EnvironmentData {
	static nomadic = ElementFactory.FeatureFactory.createSkillChoice({
		id: 'env-nomadic',
		name: 'Nomadic',
		description:
	...
	static rural = ElementFactory.FeatureFactory.createSkillChoice({
		id: 'env-rural',
		name: 'Rural',
		description:
	...
	static secluded = ElementFactory.FeatureFactory.createSkillChoice({
		id: 'env-secluded',
		name: 'Secluded',
		description:
	...
	static urban = ElementFactory.FeatureFactory.createSkillChoice({
		id: 'env-urban',
		name: 'Urban',
		description:
	...
	static wilderness = ElementFactory.FeatureFactory.createSkillChoice({
		id: 'env-wilderness',
		name: 'Wilderness',
		description:
	...
	static getEnvironments = () => {
		return [this.nomadic, this.rural, this.secluded, this.urban, this.wilderness];
	};
}

export class OrganizationData {
	static bureaucratic = ElementFactory.FeatureFactory.createSkillChoice({
		id: 'org-bureaucratic',
		name: 'Bureaucratic',
		description:
	...
	static communal = ElementFactory.FeatureFactory.createSkillChoice({
		id: 'org-communal',
		name: 'Communal',
		description:
	...
	static getOrganizations = () => {
		return [this.bureaucratic, this.communal];
	};
}

export class UpbringingData {
	static academic = ElementFactory.FeatureFactory.createSkillChoice({
		id: 'up-academic',
		name: 'Academic',
		description:
	...
	static creative = ElementFactory.FeatureFactory.createSkillChoice({
		id: 'up-creative',
		name: 'Creative',
		description:
	...
	static lawless = ElementFactory.FeatureFactory.createSkillChoice({
		id: 'up-lawless',
		name: 'Lawless',
		description:
	...
	static labor = ElementFactory.FeatureFactory.createSkillChoice({
		id: 'up-labor',
		name: 'Labor',
		description:
	...
	static martial = ElementFactory.FeatureFactory.createSkillChoice({
		id: 'up-martial',
		name: 'Martial',
		description:
	...
	static noble = ElementFactory.FeatureFactory.createSkillChoice({
		id: 'up-noble',
		name: 'Noble',
		description:
	...
	static getUpbringings = () => {
		return [this.academic, this.creative, this.lawless, this.labor, this.martial, this.noble];
	};
}

export class CultureData {
	static bespoke = ElementFactory.createCulture(
		'Bespoke Culture',
