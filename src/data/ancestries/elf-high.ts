...
export const highElf: AncestryInterface = {
			...
			options: [
				{
					feature: ElementFactory.FeatureFactory.createAbility({
						ability: ElementFactory.createAbility({
							...
							description:
								'When a foe strikes, you reverse the magic of your glamor to instill fear into their heart.',
							...
							sections: [
								ElementFactory.createAbilitySectionText(
									'Whenever you take damage from a creature, you can use a triggered action to make that creature frightened of you until the end of their next turn.'
								),
							],
						}),
					}),
