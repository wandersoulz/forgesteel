...
export const memonek: AncestryInterface = {
	id: 'ancestry-memonek',
	name: 'Memonek',
	description:
			...
			options: [
				...
				},
				{
					feature: ElementFactory.FeatureFactory.create({
						...
						name: 'Useful Emotion',
						description:
							'Velloparatha - the worldsickness - might hinder, but you know how to turn your pain into something your enemies feel. At the start of any combat, you gain 1 surge.',
					}),
					value: 1,
				},
				{
					feature: ElementFactory.FeatureFactory.createAbility({
						ability: ElementFactory.createAbility({
							...
							type: ElementFactory.AbilityTypeFactory.createTrigger(
								'You, or a creature adjacent to you, makes a power roll',
								{ free: true }
							),
							sections: [
								ElementFactory.createAbilitySectionText(
									'You can remove an edge or a bane on the roll, turn a double edge into an edge, or turn a double bane into a bane. You can only use this benefit once per round.'
								),
							],
						}),
					}),
