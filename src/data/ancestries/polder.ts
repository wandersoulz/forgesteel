...
export const polder: AncestryInterface = {
	id: 'ancestry-polder',
	name: 'Polder',
	description:
				...
				},
				{
					feature: ElementFactory.FeatureFactory.createAbility({
						ability: ElementFactory.createAbility({
							...
							type: ElementFactory.AbilityTypeFactory.createTrigger('Whenever you are force moved', {
								free: true,
							}),
							sections: [
								ElementFactory.createAbilitySectionText(
									'You shift 1 square after the forced movement is resolved.'
								),
							],
						}),
					}),
