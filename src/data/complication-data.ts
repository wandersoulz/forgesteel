...
export class ComplicationData {
	static advancedStudies: ComplicationInterface = {
	...
	static amnesia: ComplicationInterface = {
		id: 'comp-amnesia',
		name: 'Amnesia',
		description:
		...
		features: [
			ElementFactory.FeatureFactory.createItemChoice({
				id: 'comp-amnesia-b',
	...
	static animalForm: ComplicationInterface = {
		id: 'comp-animal-form',
		name: 'Animal Form',
		description:
		...
		features: [
			ElementFactory.FeatureFactory.create({
				...
				description:
					'As a manuever, you take the form of a specific 1T animal. You retain all your other statistics aside from your size, but you can’t talk or use actions, and the only maneuvers you can use are Escape Grab, Hide, and Stand Up. Based on the animal you can turn into, you might be able to burrow or fly, or to automatically climb or swim at full speed while moving. If your animal form doesn’t provide such additional movement, you have a +2 bonus to speed. Unless you use this benefit again, you return to your true form at the start of your next turn.',
			}),
			ElementFactory.FeatureFactory.create({
	...
	static antihero: ComplicationInterface = {
		id: 'comp-antihero',
		name: 'Antihero',
		description:
	...
	static artifactBonded: ComplicationInterface = {
		id: 'comp-artifactBonded',
		name: 'Artifact Bonded',
		description:
			'A powerful artifact has bonded to you. You might be destined to wield the artifact or to destroy it. You’re not powerful enough to use it at the moment, although you might be some day. For now, though, the artifact has no effect beyond getting you in trouble.',
		features: [
			ElementFactory.FeatureFactory.createItemChoice({
	...
	static bereaved: ComplicationInterface = {
		id: 'comp-bereaved',
		name: 'Bereaved',
		description:
	...
	static betrothed: ComplicationInterface = {
		id: 'comp-betrothed',
		name: 'Betrothed',
		description:
	...
	static chaosTouched: ComplicationInterface = {
		id: 'comp-chaosTouched',
		name: 'Chaos Touched',
		description:
			'You came into contact with a mote of pure chaos energy, or were subjected to a supernatural effect or object that fused chaos into your very being. Now you can sprout and retract limbs in a way that horifies unprepared onlookers.',
		features: [
			ElementFactory.FeatureFactory.create({
	...
	static chosenOne: ComplicationInterface = {
		id: 'comp-chosenOne',
		name: 'Chosen One',
		description:
	...
	static consumingInterest: ComplicationInterface = {
...
Each time you complete this project, your knowledge of your chosen field expands, and the bonus to tests provided by your chosen skill increases by 1.`,
	...
	static corruptedMentor: ComplicationInterface = {
	...
	static coward: ComplicationInterface = {
		id: 'comp-coward',
		name: 'Coward',
		description:
	...
	static crashLanded: ComplicationInterface = {
		id: 'comp-crashLanded',
		name: 'Crash Landed',
		description:
	...
	static cultVictim: ComplicationInterface = {
		id: 'comp-cult-victim',
		name: 'Cult Victim',
		description:
	...
	static curseOfCaution: ComplicationInterface = {
	...
	static curseOfImmortality: ComplicationInterface = {
	...
	static curseOfMisfortune: ComplicationInterface = {
	...
	static curseOfPoverty: ComplicationInterface = {
	...
	static curseOfPunishment: ComplicationInterface = {
	...
	static curseOfStone: ComplicationInterface = {
		id: 'comp-stoneCursed',
		name: 'Curse of Stone',
		description:
			'As a child, you met a creature that turns people to stone, such as a medusa. You escaped half-petrified, avoiding the fate of others who stand as statues now.',
		features: [
			ElementFactory.FeatureFactory.create({
	...
	static cursedWeapon: ComplicationInterface = {
	...
	static disgraced: ComplicationInterface = {
		id: 'comp-disgraced',
		name: 'Disgraced',
		description:
	...
	static dragonDreams: ComplicationInterface = {
		id: 'comp-dragonDreams',
		name: 'Dragon Dreams',
		description:
			'You sometimes have strange dreams of a raging inferno … a gleaming pile of treasure … spreading your wings and taking flight. You haven’t told anyone about the dreams, except for your one strange relative who seems to know more than they’re letting on.',
		features: [
			ElementFactory.FeatureFactory.create({
	...
	static elementalInside: ComplicationInterface = {
	...
	static evanesceria: ComplicationInterface = {
		id: 'comp-evanesceria',
		name: 'Evanesceria',
		description:
	...
	static exile: ComplicationInterface = {
		id: 'comp-exile',
		name: 'Exile',
		description:
			'Whether you’re a convicted criminal, a noble stripped of their title, or a peron who made one too many enemies, you’ve been cast forth from your homeland, never to return. At least not until you’re strong enough to set things right.',
		features: [
	...
	static fallenImmortal: ComplicationInterface = {
		id: 'comp-fallenImmortal',
		name: 'Fallen Immortal',
		description:
			'You used to be an immortal creature, dispensing justice and doing the bidding of the gods. Now, as a punishment or reward, you have been ordered to set yor true nature aside and become a mortal. Your remaining years will be short, but living aside your fellow mortals gives your life new meaning.',
		features: [
			ElementFactory.FeatureFactory.createSkillChoice({
	...
	static famousRelative: ComplicationInterface = {
...
You have a piece of magic jewelry, such as a signet ring. As a maneuver, you can use the item to summon your relative to your aid. Your relative starts with a Renown of 10 but otherwise has the same statistics you do. They make power rolls with an edge but don’t gain the benefits of any of your treasures. Your relative does their best to help you out of the current perilous situation, disappearing when the situation is resolved or after 1 hour. Once you summon your relative, you can’t do so again until you gain a level.`,
	...
	static feytouched: ComplicationInterface = {
		id: 'comp-feytouched',
		name: 'Feytouched',
		description:
			'Your birth was attended by faeries. A friendly fairy blessed you, granting you strength so that you could defend yourself. In response, an unfriendly fairy granted you a life full of peril so that you might prove your strength.',
		features: [
			ElementFactory.FeatureFactory.create({
	...
	static fieryIdeal: ComplicationInterface = {
		id: 'comp-fieryIdeal',
		name: 'Fiery Ideal',
		description:
	...
	static fireAndChaos: ComplicationInterface = {
	...
	static followingInTheFootsteps: ComplicationInterface = {
		id: 'comp-followingInTheFootsteps',
		name: 'Following in the Footsteps',
		description:
			'Your personal idol was a mighty hero, and you have modeled yourself after them. From studying the many heroic tales told of them, you hope to someday learn their most famous battle technique.',
		features: [
			ElementFactory.FeatureFactory.create({
	...
	static forbiddenRomance: ComplicationInterface = {
	...
	static frostheart: ComplicationInterface = {
		id: 'comp-frostheart',
		name: 'Frostheart',
		description:
		...
		features: [
			ElementFactory.FeatureFactory.create({
				...
				description:
					'Whwhenever you make a strike that deals untyped damage, that strike can deal cold damage instead.',
			}),
			ElementFactory.FeatureFactory.createDamageModifier({
	...
	static gettingTooOldForThis: ComplicationInterface = {
	...
	static gnollMauled: ComplicationInterface = {
		id: 'comp-gnollMauled',
		name: 'Gnoll-Mauled',
		description: `
...
You can’t take this complication if you can’t be made dazed.`,
	...
	static greening: ComplicationInterface = {
		id: 'comp-greening',
		name: 'Greening',
		description:
	...
	static grifter: ComplicationInterface = {
		id: 'comp-grifter',
		name: 'Grifter',
		description:
			'You used to be a con artist, but those days are pretty much behind you. Being a hero is an even better racket. After all, if you’re saving the world, who can be mad at you for stealing a couple of coins along the way?',
		features: [
			ElementFactory.FeatureFactory.createSkillChoice({
				id: 'comp-grifter-b',
	...
	static grounded: ComplicationInterface = {
		id: 'comp-grounded',
		name: 'Grounded',
		description:
	...
	static guiltyConscience: ComplicationInterface = {
		...
		features: [
			...
			ElementFactory.FeatureFactory.create({
				...
				description:
					'Many people blame you for the evils you caused. They may be unfriendly or hostile to you - and you can understand their point of view. You take a bane on any test made to interact with those who know what you did, and on strikes made against such creaturess.',
			}),
		],
	};

	static hawkRider: ComplicationInterface = {
		id: 'comp-hawkRider',
		name: 'Hawk Rider',
		description:
			'You travel with a giant hawk that you stole from the Hawklords. Perhaps you might once have been a Hawklord yourself, or perhaps you escaped their captivity.  Having a giant hawk companion comes with its share of inconveniences and dangers, but those are a small price to pay for the freedom of the open sky.',
		features: [
			ElementFactory.FeatureFactory.create({
				id: 'comp-hawkRider-b',
	...
	static hostBody: ComplicationInterface = {
		id: 'comp-hostBody',
		name: 'Host Body',
		description:
	...
	static hunted: ComplicationInterface = {
		id: 'comp-hunted',
		name: 'Hunted',
		description:
			'You’re one step ahead of a pursuer - perhaps a bounty hunter determined to bring you to justice, a revenant, or an assassin intent on your death. Someday, you’ll be strong enough to face your pursuer head to head. But for now, you live your life on the run.',
		features: [
			ElementFactory.FeatureFactory.createSkillChoice({
			...
			ElementFactory.FeatureFactory.create({
				...
				name: 'Hunted Benefit',
				description:
					'When one or more creatures are pursuing you, you can lay low as a respite activity. When you do so, anyone pursuing you loses track of your party’s location and must start their search again.',
			}),
			ElementFactory.FeatureFactory.create({
				id: 'comp-hunted-d',
				name: 'Hunted Drawback',
				description:
					'Each time you gain Renown, your pursuer learns your location.  Unless you lay low or move to a new location, you’ll be visited by agents of the pursuer within 1d10 days. If you linger after that, your pursuer finds you.',
			}),
		],
	};

	static hunter: ComplicationInterface = {
		id: 'comp-hunter',
		name: 'Hunter',
		description:
			'You’re hunting someone or something - perhaps a wanted criminal or someone who wronged you, or perhaps a dangerous monster or beast. You won’t rest until you face off against your quarry!',
		features: [
			ElementFactory.FeatureFactory.createSkillChoice({
				id: 'comp-hunter-b1',
				options: [
			...
			ElementFactory.FeatureFactory.create({
				...
				description:
					'You are so obsessed with finding your quarry that you have a bane on tests made to track other creatures.',
			}),
		],
	};

	static indebted: ComplicationInterface = {
		id: 'comp-indebted',
		name: 'Indebted',
		description:
		...
		features: [
			ElementFactory.FeatureFactory.create({
				...
				description:
					'You’re good with money - because you’ve had to be. Whenever you earn Wealth, you gain 1 more than usual.',
			}),
			ElementFactory.FeatureFactory.create({
				id: 'comp-indebted-d',
	...
	static infernalContract: ComplicationInterface = {
	...
	static infernalContractButLikeBad: ComplicationInterface = {
		id: 'comp-infernalContractButLikeBad',
		name: 'Infernal Contract … But, Like, Bad',
		description:
			'You made a deal with a devil. Not a very good deal, because it wasn’t a very good devil. It’s too late for regrets, though, because your soul is forfeit unless you find a loophole or convince the devil to void the deal.',
		features: [
			...
			ElementFactory.FeatureFactory.create({
				...
				description:
					'Your body bears a fiendish mark. Anyone who understands religion notes the mark can tell that your soul belongs to Hell, imposing a bane on tests made to interact with those creatures (unless they’re into that). Additionally, when you die, your soul goes to Hell and you can’t be restored to life.',
			}),
		],
	};

	static ivoryTower: ComplicationInterface = {
		id: 'comp-ivoryTower',
		name: 'Ivory Tower',
		description:
		...
		features: [
			...
			ElementFactory.FeatureFactory.create({
				...
				description:
					'The Director chooses one of the skills you learned from this complication. You lose that skill and can’t ever learn it again. Additionall, you take a bane on any test to which that skill would apply.',
			}),
		],
	};

	static lifebonded: ComplicationInterface = {
		id: 'comp-lifebonded',
		name: 'Lifebonded',
		description:
		...
		features: [
			ElementFactory.FeatureFactory.create({
				...
				description:
					'Choose another creature who doesn’t have the Lifebonded complication. When you die, your body disappears until that creature finishes a respite or earns 2 or more Victories. You then appear next to the creature, fully healed.',
			}),
			ElementFactory.FeatureFactory.create({
				id: 'comp-lifebonded-d',
				name: 'Lifebonded Drawback',
				description:
					'If the creature you’re bound to dies, you die as well, no matter what other traits or features you have.',
			}),
		],
	};

	static lightningSoul: ComplicationInterface = {
		id: 'comp-lightningSoul',
		name: 'Lightning Soul',
		description:
			'You were caught in a storm and stuck by lightning - but somthing saved you from death. Perhaps it was a gods-given miracle, a latent psionic gift, or the magic of a helpful elementalist, but you absorbed the lightning into your body. It’s always there now, simmering under the surface.',
		features: [
			ElementFactory.FeatureFactory.create({
				id: 'comp-lightningSoul-b',
				name: 'Lightning Soul Benefit',
				description:
					'When you regain Stamina in combat, you gain 1 surge. Whenever you spend a surge to deal extra damage, you can make that extra damage into lightning damage.',
			}),
			ElementFactory.FeatureFactory.create({
	...
	static loner: ComplicationInterface = {
		id: 'comp-loner',
		name: 'Loner',
		description:
		...
		features: [
			ElementFactory.FeatureFactory.create({
				...
				name: 'Loner Benefit',
				description:
					'When you finish a respite, choose a skill you don’t have. You have that skill until the end of your next respite.',
			}),
			ElementFactory.FeatureFactory.create({
				id: 'comp-loner-d',
				name: 'Loner Drawback',
				description:
					'Now that you finally have people who care about you, you won’t let anyone take them away! Whenever a creature reduces one of your allies to 0 Stamina, you are taunted by the creature until your ally’s Stamina is higher than 0, another creature makes you taunted, or the end of the encounter.',
			}),
		],
	};

	static lostInTime: ComplicationInterface = {
		id: 'comp-lostInTime',
		name: 'Lost in Time',
		description:
		...
		features: [
			ElementFactory.FeatureFactory.create({
				...
				description:
					'Choose a damage type from acid, cold, corruption, fire, holy, lightning, poison, psychic, or sonic. Whenever you use a signature ability, you can have it deal your chosen damage type instead of it’s normal damage.',
			}),
			ElementFactory.FeatureFactory.create({
				id: 'comp-lostInTime-d',
				name: 'Lost in Time Drawback',
				description:
					'You automatically fail any test made to recall information from the period during which you were suspended in time.',
			}),
		],
	};

	static lostYourHead: ComplicationInterface = {
	...
	static lucky: ComplicationInterface = {
		id: 'comp-lucky',
		name: 'Lucky',
		description:
			'You’ve always had a lucky streak. When you leave things in the hands of fate, you succeed more than you fail. But luck is fickle - when you don’t trust it, it deserts you.',
		features: [
			ElementFactory.FeatureFactory.create({
				id: 'comp-lucky-b',
				name: 'Lucky Benefit',
				description:
					'When you spend a hero token to succeed on a saving throw or reroll a test, roll a d10. On a 6 or higher, you gain the benefit but don’t spend the hero token.',
			}),
			ElementFactory.FeatureFactory.create({
				id: 'comp-lucky-d',
				name: 'Lucky Drawback',
				description:
					'Whenever you obtain a tier 1 result on a test and don’t spend a hero token to reroll, you take a bane on the next test you make.',
			}),
		],
	};

	static masterChef: ComplicationInterface = {
		id: 'comp-masterChef',
		name: 'Master Chef',
		description:
	...
	static meddlingButler: ComplicationInterface = {
		...
		features: [
			ElementFactory.FeatureFactory.createRetainer({
	...
	static medium: ComplicationInterface = {
		id: 'comp-medium',
		name: 'Medium',
		description:
			'You can perceive ghosts and spirits that others sense. These supernatural entities constantly whisper unsettling secrets in your mind - when they’re not trying to kill you.',
		features: [
			ElementFactory.FeatureFactory.create({
				id: 'comp-medium-b',
	...
	static medusaBlood: ComplicationInterface = {
		id: 'comp-medusaBlood',
		name: 'Medusa Blood',
		description:
		...
		features: [
			ElementFactory.FeatureFactory.createAbility({
				ability: ElementFactory.createAbility({
					...
					sections: [
						...
						ElementFactory.createAbilitySectionText(
							'This ability has no effect on a creature who can’t see you or who purposely avoids looking at your eyes. A creature reduced to 0 Stamina by this ability is turned to inanimate stone.'
						),
					],
				}),
			}),
			ElementFactory.FeatureFactory.create({
				...
				description:
					'Out of combat, you use Stone Eyes on anyone who meets your eye, whether you intend to or not. Your companions know not to make eye contact, but strangers are likely to trigger the ability unless you cover your eyes.',
			}),
		],
	};

	static misunderstood: ComplicationInterface = {
		id: 'comp-misunderstood',
		name: 'Misunderstood',
		description:
			'Your appearance marks you as part of a group that is universally feared. You might be a gentle soul, but you’re not often given a chance to prove it. It’s no wonder that you usually wear a hood.',
		features: [
			ElementFactory.FeatureFactory.create({
				id: 'comp-misunderstood-b',
				name: 'Misunderstood',
				description:
					'When you reveal your appearance to creatures who don’t know you personally, you gain an edge on tests where the Brag or Intimidate skill could be applied, but you take a bane on tests where the Flirt, Lead, or Persuade skills could be applied.',
			}),
		],
	};

	static mundane: ComplicationInterface = {
		id: 'comp-mundane',
		name: 'Mundane',
		description:
			'You’re hopelessly nonmagical. When you try to use magical abilities, or even when they’re used on you, they never work right. Even magical devices seem to fizzle in your presence.',
		features: [
			ElementFactory.FeatureFactory.createDamageModifier({
				id: 'comp-mundane-b',
				modifiers: [
	...
	static outlaw: ComplicationInterface = {
		id: 'comp-outlaw',
		name: 'Outlaw',
		description:
			'You might be a common bandit or an idealistic freedom fighter, but in either case, the authorities don’t approve of your actions. You’ve managed to stay one step ahead of the law so far, but until your name is cleared, you’ve got to keep a low profile.',
		features: [
			ElementFactory.FeatureFactory.createBonus({
				id: 'comp-outlaw-b',
				field: FeatureField.Renown,
	...
	static pirate: ComplicationInterface = {
		id: 'comp-pirate',
		name: 'Pirate',
		description:
	...
	static preacher: ComplicationInterface = {
		id: 'comp-preacher',
		name: 'Preacher',
		description:
	...
	static primordialSickness: ComplicationInterface = {
	...
	static prisonerOfTheSynlirii: ComplicationInterface = {
		...
		features: [
			ElementFactory.FeatureFactory.create({
				...
				description:
					'You can telepathically communicate with creatures within 10 squares of you if they share a language with you and you know of each other. TA creature you communicate with this way can respond telepathically if they choose.',
			}),
			ElementFactory.FeatureFactory.create({
				id: 'comp-prisonerOfTheSynlirii-d',
				name: 'Prisoner of the Synlirii Drawback',
				description:
					'Any voiceless talkers within 1 mile know your location, and can overhear and understand your telepathic conversations.',
			}),
		],
	};

	static promisingApprentice: ComplicationInterface = {
		...
		features: [
			...
			ElementFactory.FeatureFactory.create({
				...
				description:
					'Choose one of your skills from the crafting skill group. You gain an edge on any test that uses that skill.',
			}),
			ElementFactory.FeatureFactory.create({
				id: 'comp-promisingApprentice-d',
				name: 'Promising Apprentice Drawback',
				description:
					'Whoever killed your mentor cursed you. You take a bane on any test that doesn’t use one of your skills.',
			}),
		],
	};

	static psychicEruption: ComplicationInterface = {
		...
		features: [
			ElementFactory.FeatureFactory.createAbility({
				ability: ElementFactory.createAbility({
					...
					sections: [
						ElementFactory.createAbilitySectionText('Using this ability costs all your Heroic Resources.'),
						ElementFactory.createAbilitySectionRoll(
							ElementFactory.createPowerRoll({
								characteristic: [
									Characteristic.Might,
			...
			ElementFactory.FeatureFactory.create({
				...
				description:
					'Whenever you become bleeding, frightened, or weakened condition, you must use Psychic Blast as a free triggered action.',
			}),
		],
	};

	static raisedByBeasts: ComplicationInterface = {
		...
		features: [
			...
			ElementFactory.FeatureFactory.create({
				...
				description:
					'Choose an animal type related to the animals who helped you, such as wolf. You gain an edge on tests that use the Handle Animals skill when interacting with animals of this type. You can also communicate with animals of this type as if you shared a language, and animals of this type aren’t initially hostile to you unless they’re supernaturally compelled to be.',
			}),
			ElementFactory.FeatureFactory.create({
	...
	static refugee: ComplicationInterface = {
		id: 'comp-refugee',
		name: 'Refugee',
		description:
	...
	static rival: ComplicationInterface = {
		id: 'comp-rival',
		name: 'Rival',
		description:
	...
	static rogueTalent: ComplicationInterface = {
		id: 'comp-rogueTalent',
		name: 'Rogue Talent',
		description:
	...
	static runaway: ComplicationInterface = {
		id: 'comp-runaway',
		name: 'Runaway',
		description:
		...
		features: [
			...
			ElementFactory.FeatureFactory.create({
				...
				description:
					'Members of your extended family is looking for you, intending to drag you home - and you’ve never been able to stand up to them.',
			}),
		],
	};

	static searchingForACure: ComplicationInterface = {
	...
	static secretIdentity: ComplicationInterface = {
		id: 'comp-secretIdentity',
		name: 'Secret Identity',
		description:
			'You’re secretly very important - but it’s not safe for your true identity to be known. Perhaps you’re the witness to a crime or a royal family on the run from a usurper. Until you are no longer at risk of being hunted, you’ll maintain the guise of an ordinary adventurer.',
		features: [
			ElementFactory.FeatureFactory.createSkillChoice({
			...
			ElementFactory.FeatureFactory.create({
				...
				description:
					'You can resume your true identity temporarily. While in your true identity, your Renown and Wealth are treated as 2 higher than usual, and you might gain other benefits in consultation with the Director.',
			}),
			ElementFactory.FeatureFactory.create({
	...
	static secretTwin: ComplicationInterface = {
		id: 'comp-secretTwin',
		name: 'Secret Twin',
		description:
	...
	static selfTaught: ComplicationInterface = {
		id: 'comp-selfTaught',
		name: 'Self Taught',
		description:
			'While your peers were learning their trades in fancy schools, you whoned your capabilities on the mean streets with nothing but your own instinct as a guide. What you lost in polish and tactical acumen, you now make up for in raw power.',
		features: [
			ElementFactory.FeatureFactory.create({
	...
	static sewerFolk: ComplicationInterface = {
		id: 'comp-sewerFolk',
		name: 'Sewer Folk',
		description:
			'Impoverished or on the run, you spent formative years living in the sewers of a major city. There, you learned lessons that have served you well, although the miasma of the sewers did permanent damage to your health.',
		features: [
			ElementFactory.FeatureFactory.create({
				id: 'comp-sewerFolk-b',
	...
	static shadowBorn: ComplicationInterface = {
		id: 'comp-shadowBorn',
		name: 'Shadow Born',
		description:
	...
	static sharedSpirit: ComplicationInterface = {
		id: 'comp-sharedSpirit',
		name: 'Shared Spirit',
		description:
			'A supernatural spirit shares your body, with each of you controlling your body by turn. You and the spirit share the same short-term goals and work equally well with your companions, though you might have different personalities, mannerisms, and long-term goals.',
		features: [
			ElementFactory.FeatureFactory.create({
	...
	static shatteredLegacy: ComplicationInterface = {
		id: 'comp-shatteredLegacy',
		name: 'Shattered Legacy',
		description:
			'You’re the heir to a powerful supernatural treasure that has been in your family for generations. One problem, though: the treasure is broken. Some ancestor of yours sundered it while saving the world. Or maybe they tripped and smashed it on a rock. Either way, it’s your job to fix it.',
		features: [
			ElementFactory.FeatureFactory.createLanguageChoice({
	...
	static shipwrecked: ComplicationInterface = {
		id: 'comp-shipwrecked',
		name: 'Shipwrecked',
		description:
	...
	static siblingsShield: ComplicationInterface = {
		...
		features: [
			...
			ElementFactory.FeatureFactory.create({
				...
				description:
					'Visions of your dead sibling haunt you at night. Whenever you take a respite, make an Intuition test that can’t make use of any skill. On a tier 1 or tier 2 outcome, you gain 1 fewer Recoveries than usual when you finish the respite.',
			}),
		],
	};

	static silentSentinel: ComplicationInterface = {
		...
		features: [
			...
			ElementFactory.FeatureFactory.create({
				...
				description:
					'You can telepathically communicate with any creature provided they share a language with you and you can observe each other. A creature you communicate with this way can respond telepathically if they choose.',
			}),
			ElementFactory.FeatureFactory.create({
	...
	static slightCaseOfLycanthropy: ComplicationInterface = {
...
Note: Stormwight furies can’t take this complication.`,
		features: [
			ElementFactory.FeatureFactory.create({
				...
				description:
					'Whenever you make a non-minion creature winded or kill a non-minion creature, you gain 1 surge.',
			}),
			ElementFactory.FeatureFactory.create({
			...
			ElementFactory.FeatureFactory.create({
				...
				name: 'Special',
				description:
					'You can’t take this complication if you are a fury with the stormwight primordial aspect.',
			}),
		],
	};

	static stolenFace: ComplicationInterface = {
		id: 'comp-stolenFace',
		name: 'Stolen Face',
		description:
		...
		features: [
			ElementFactory.FeatureFactory.create({
				...
				description:
					'You can spend 5 uninterrupted minutes to rearrange your face to resemble the face of another creature of your ancestry who you’ve observed before. You have a double edge on tests made to impersonate that creature or to disguise your identity. You are unable to change your hair or other non-facial features.',
			}),
			ElementFactory.FeatureFactory.create({
	...
	static strangeInheritance: ComplicationInterface = {
		...
		features: [
			ElementFactory.FeatureFactory.create({
				...
				description:
					'You gain a somewhat inoperative 2nd echelon trinket of the Director’s choice. This trinket functions only while the total of your level plus your Victories is 5 or higher. You don’t learn what the trinket’s powers are until the first time it becomes operative.',
			}),
			ElementFactory.FeatureFactory.create({
				id: 'comp-strangeInheritance-d',
				name: 'Strange Inheritance Drawback',
				description:
					'With no other inheritance, you accumulated debts. The first time your Wealth exceeds 1, you lose 1 Wealth.',
			}),
		],
	};

	static strippedOfRank: ComplicationInterface = {
	...
	static thrillSeeker: ComplicationInterface = {
		...
		features: [
			...
			ElementFactory.FeatureFactory.create({
				...
				description:
					'At the start of a new game session, the party doesn’t earn a hero token for your character.',
			}),
		],
	};

	static vampireSire: ComplicationInterface = {
		id: 'comp-vampireSire',
		name: 'Vampire Sire',
		description:
		...
		features: [
			ElementFactory.FeatureFactory.create({
				...
				description:
					'Whenever you make a melee free strike against an adjacent creature, you can do so by biting the creature. If you obtain a tier 3 outcome on the free strike, you gain temporary Stamina equal to the damage dealt. If not lost beforehand, this temporary Stamina lasts until the end of your next respite.',
			}),
			ElementFactory.FeatureFactory.create({
	...
	static hearsVoices: ComplicationInterface = {
		id: 'comp-hearsVoices',
		...
		features: [
			ElementFactory.FeatureFactory.create({
				...
				description:
					'The Director tells you when you hear the voice. The voice seems to be aware of your surroundings, and its advice is usually vague but helpful. Someday its motivations might be different from your own, but for now it seems keen on making sure that you survive.',
			}),
			ElementFactory.FeatureFactory.create({
				id: 'comp-hearsVoices-d',
				name: 'Hears Voices Drawback',
				description:
					'Eventually, the voice may reveal that it wants something from you that you may not want to provide. If the voice is displeased with you, it can interrupt your rest during a respite, causing you to regain 2 fewer Recoveries than normal.',
			}),
		],
	};

	static vowOfDuty: ComplicationInterface = {
		id: 'comp-vowOfDuty',
		name: 'Vow of Duty',
		description:
			'You have sworn an oath to an organization. The organization is your rock, and as long as your faith in it remains unshaken, you are immovable.',
		features: [
			ElementFactory.FeatureFactory.createBonus({
				id: 'comp-vowOfDuty-b',
				field: FeatureField.Stability,
			...
			ElementFactory.FeatureFactory.create({
				...
				description:
					'If you are forced to disobey your organization’s orders, your stability becomes 0 until your doubts are resolved or you find a new organization to pledge yourself to.',
			}),
		],
	};

	static vowOfHonesty: ComplicationInterface = {
	...
	static wakingDreams: ComplicationInterface = {
		id: 'comp-waking-dreams',
		name: 'Waking Dreams',
		description:
			'You broke a magic amulet that immersed your mind in weird magic. This magic has given you the power of premonition. However, you struggle to control this new gift.  Whenever you take a respite, make a Reason test.',
		features: [
			ElementFactory.FeatureFactory.createAbility({
				ability: ElementFactory.createAbility({
	...
	static warDogCollar: ComplicationInterface = {
		...
		features: [
			ElementFactory.FeatureFactory.create({
				...
				description:
					'Even if you are a war dog yourself, other war dogs can’t use their Posthumous Promotion ability on you while you wear your collar.',
			}),
			ElementFactory.FeatureFactory.createAbility({
				ability: ElementFactory.createAbility({
					...
					sections: [
						ElementFactory.createAbilitySectionText(
							'Your loyalty collar detonates, dealing fire damage equal to 5 plus your level to each target. Once you have used this ability, you can’t use it again until you spend 1 minute out of combat resetting the collar'
						),
					],
				}),
			}),
	...
	static warOfAssassins: ComplicationInterface = {
		...
		features: [
			ElementFactory.FeatureFactory.create({
				...
				description:
					'Having gained the favor of the faction who you helped, you can call on its members three times for favors. If a favor is reasonable and within the faction’s power to grant, its members do it, no questions asked.',
			}),
			ElementFactory.FeatureFactory.create({
				id: 'comp-war-of-assassins-d',
				name: 'War Of Assassins Drawback',
				description:
					'The faction you wronged hates you, and its members would love to see you pay for your transgression.',
			}),
		],
	};

	static ward: ComplicationInterface = {
		id: 'comp-ward',
		name: 'Ward',
		description:
		...
		features: [
			...
			ElementFactory.FeatureFactory.create({
				...
				name: 'Ward Drawback',
				description:
					'Your royal ward can be a burden. When you take a respite, roll a d10. On a 1, your ward contacts you and requires your help during the respite, requiring you to spend your time helping them instead of undertaking a respite activity.',
			}),
		],
	};

	static waterborn: ComplicationInterface = {
		id: 'comp-waterborn',
		name: 'Waterborn',
		description:
			...
			ElementFactory.FeatureFactory.createAbility({
				ability: ElementFactory.createAbility({
					...
					sections: [
						...
						ElementFactory.createAbilitySectionText('You can forgo dealing damage with this ability.'),
					],
				}),
			}),
			ElementFactory.FeatureFactory.create({
				...
				description:
					'The ocean or a creature it sends to seek you can assign you a quest. If you don’t do the ocean’s bidding, it might temporarily deny you this complication’s benefits — including being able to breathe underwater — at an inconvenient time.',
			}),
			ElementFactory.FeatureFactory.createDamageModifier({
	...
	static wodewalker: ComplicationInterface = {
		id: 'comp-wodewalker',
		name: 'Wodewalker',
		description:
	...
	static wrathfulSpirit: ComplicationInterface = {
		...
		features: [
			ElementFactory.FeatureFactory.create({
				...
				description:
					'While you are taunted by a creature, you gain an edge on strikes against that creature. Aditionally, you can spend 1 Heroic Resource to have a double edge instead.',
			}),
			ElementFactory.FeatureFactory.create({
	...
	static wronglyImprisoned: ComplicationInterface = {
