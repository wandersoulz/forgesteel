...
const aranox: AncestryInterface = {
	id: 'aranox',
	name: 'Aranox',
	description: `
*By Marc Aranha*
...
It is whispered that, with the Life Oath broken, it is not a matter of 'if' but 'when' the beast takes hold again, for each Aranox can only ever have one Life Oath. Thus, an afflicted Aranox will go into self-exile to spare the larger community. It is a fate no Aranox will speak of, that each will one day become Minotaur once again. In the end, the beast within is always there. Waiting.`,
	features: [
		ElementFactory.FeatureFactory.createSize({
			...
			name: 'Beast Within',
			description:
				'Your Minotaur forebears were consumed by the beast, giving them their monstrous size. Your tenuous control has made you smaller by comparison, but the beast within is still there, waiting.',
			sizeValue: 1,
			sizeMod: 'L',
		}),
			...
			options: [
				{
					feature: ElementFactory.FeatureFactory.create({
						...
						name: 'Always Angry',
						description:
							'The beast rages within you, and its anger makes you incredibly strong. You gain an edge on tests made to lift and haul heavy objects. In addition, whenever you force move a creature or object, the forced movement distance gains a +1 bonus.',
					}),
					value: 2,
				},
				{
					feature: ElementFactory.FeatureFactory.create({
						...
						name: 'Goring Horns',
						description:
							"Your horns aren't just imposing, they're also sharp. Once per round when you make a melee strike, you can deal extra damage with the strike equal to your highest characteristic score.",
					}),
					value: 1,
				},
				{
				...
				},
				{
					feature: ElementFactory.FeatureFactory.create({
						...
						name: 'That Tickles',
						description:
							"You are able to shrug off the puny blows of your enemies. Your Might score is treated as 1 higher for the purpose of resisting potencies, and you gain an edge on Might tests when called for to resist environmental effects or a creature's traits or abilities.",
					}),
					value: 1,
				},
				{
			...
			options: [
				{
					feature: ElementFactory.FeatureFactory.create({
						...
						name: 'Dawnbreaker',
						description:
							'The rising sun grants you strength. Whenever you finish a respite, you gain temporary Stamina equal to half your recovery value that lasts until you finish a respite.',
					}),
					value: 1,
				},
				{
					feature: ElementFactory.FeatureFactory.create({
						...
						name: 'Divine Arbiter',
						description:
							'Your burning radiance empowers your attacks. Whenever you use an ability that deals untyped damage, that ability can deal fire damage or holy damage instead.',
					}),
					value: 1,
				},
				{
					feature: ElementFactory.FeatureFactory.createAbility({
						ability: ElementFactory.createAbility({
							...
							type: ElementFactory.AbilityTypeFactory.createTrigger(
								'The first time in an encounter a creature deals damage to you that leaves you dying',
								{ free: true }
							),
							...
							sections: [
								...
								ElementFactory.createAbilitySectionText(
									'If you reduce a creature to 0 Stamina with this ability, you can spend a Recovery.'
								),
							],
						}),
					}),
					...
					feature: ElementFactory.FeatureFactory.createMultiple({
						...
						features: [
							...
							ElementFactory.FeatureFactory.create({
								...
								name: 'Starscape Navigator',
								description:
									'You gain an edge on tests to navigate at night. You always know which way is north and what time of day it is.',
							}),
						],
					}),
					value: 1,
				},
				{
					feature: ElementFactory.FeatureFactory.create({
						...
						name: 'Solar Flare',
						description:
							'Your burning starlight escapes in violent bursts. The first time on a turn an enemy damages you with a free strike, you can deal fire or holy damage to them equal to your highest characteristic as a free triggered action.',
					}),
					value: 1,
				},
				{
					feature: ElementFactory.FeatureFactory.create({
						...
						name: 'Sunlight Saint',
						description:
							'Your divine visage is basked upon by believers. You gain an edge on tests made to interact with priests, acolytes, and other particularly religious individuals.',
					}),
					value: 1,
				},
				{
					feature: ElementFactory.FeatureFactory.createSize({
						id: 'solar-2-7',
						name: 'Supergiant',
				...
				},
				{
					feature: ElementFactory.FeatureFactory.create({
						...
						description:
							"You radiate solar energy that draws your enemies closer to your event horizon. Any enemy that starts its turn within 1 square of you can't shift.",
					}),
					value: 2,
				},
				{
					feature: ElementFactory.FeatureFactory.createMultiple({
						...
						features: [
							ElementFactory.FeatureFactory.create({
								...
								name: 'Flight',
								description:
									'You possess wings made of fire and light powerful enough to take you airborne. While using your wings to fly, you can stay aloft for a number of rounds equal to your Might score (minimum 1 round) before you fall. While using your wings to fly at 3rd level or lower, you have damage weakness 5.',
							}),
					...
					feature: ElementFactory.FeatureFactory.createAbility({
						ability: ElementFactory.createAbility({
							...
							sections: [
								...
								ElementFactory.createAbilitySectionText(
									"You can use this ability when you land after a fall on your turn. You reduce the effective height of the fall by twice your highest characteristic. You don't land prone from the fall, and the damage of this ability increases by 1 for each square you fell."
								),
							],
						}),
					}),
...
const scion: HeroClassInterface = {
	id: 'scion',
	name: 'Scion',
	description: `
*By Ben Shabtai*
...
As a scion, you move with purpose - each strike empowered to suit the moment, whether to wound, disrupt, or disable, your flexibility is unmatched. At the height of your mastery, you are the eye of the storm: utterly calm, yet entirely devastating.`,
	...
	subclassName: 'Art',
	subclassCount: 1,
	primaryCharacteristicsOptions: [[Characteristic.Agility, Characteristic.Reason]],
			...
			features: [
				...
				ElementFactory.FeatureFactory.createHeroicResource({
					...
					gains: [
						...
						{
							trigger:
								'The first time in a combat round that you or an ally within 10 squares of you uses an ability with a Weapon tag',
							value: '1',
							tag: 'Weapon 1',
						},
						{
							tag: 'Magic 1',
							trigger:
								'The first time in a combat round that you or an ally within 10 squares of you uses an ability with a Magic tag',
							value: '1',
						},
					],
				}),
		...
		},
		{
			...
			features: [
				ElementFactory.FeatureFactory.create({
					...
					description:
						'When using Enweave, you may spend 1 balance to make the chosen effect apply to an additional target within range 5 of the target of your next melee weapon ability. You may choose to use this spend effect more than once, each time costing 1 more balance than the previous time. Each additional target needs to be within range 5 of the previous affected target.',
				}),
				ElementFactory.FeatureFactory.createClassAbilityChoice({
					id: 'nHkXlESMAT6WMexB',
					cost: 7,
	...
	abilities: [
		ElementFactory.createAbility({
			...
			sections: [
				...
				ElementFactory.createAbilitySectionText(
					'Before choosing the target of this ability and resolving the power roll, choose a creature or object within range 5. Either vertical pull 4 the target, or vertical pull 4 yourself as if you were the target. When a creature is pulled into the air this way, they do not fall down until the end of your turn, and lose all stability while in the air.'
				),
			],
		}),
		ElementFactory.createAbility({
			...
			sections: [
				...
				ElementFactory.createAbilitySectionText(
					'This ability ignores stability. Gain damage immunity equal to your Reason until the end of your next turn.'
				),
			],
		}),
		ElementFactory.createAbility({
			...
			distance: [ElementFactory.DistanceFactory.create({ type: AbilityDistanceType.Wall, value: 3, within: 1 })],
			...
			sections: [
				...
				ElementFactory.createAbilitySectionText(
					"The wall area is only used for targeting, and does not create an actual wall. Each increase to the wall's length is doubled."
				),
			],
		}),
		ElementFactory.createAbility({
			...
			sections: [
				...
				ElementFactory.createAbilitySectionText(
					'The target’s characteristic scores are treated as lower by 1 for the sake of resisting potencies (save ends).'
				),
			],
		}),
		ElementFactory.createAbility({
			...
			name: 'Still Edge',
			description:
				'You cut into your foe, leaving potential energy in their form - threatening to snap into explosive motion.',
			type: ElementFactory.AbilityTypeFactory.createMain(),
			keywords: [AbilityKeyword.Magic, AbilityKeyword.Melee, AbilityKeyword.Strike, AbilityKeyword.Weapon],
			distance: [ElementFactory.DistanceFactory.createMelee()],
			target: 'One creature',
			...
			sections: [
				...
				ElementFactory.createAbilitySectionText(
					'If the target willingly moves before the end of their next turn, they take damage equal to twice your Reason score.'
				),
			],
		}),
		ElementFactory.createAbility({
			...
			sections: [
				...
				ElementFactory.createAbilitySectionText(
					'If the target has any condition, this ability deals an additional 10 damage.'
				),
			],
		}),
		ElementFactory.createAbility({
		...
		ElementFactory.createAbility({
			...
			sections: [
				...
				ElementFactory.createAbilitySectionText(
					'Create a 1 burst area of mist which provides concealment to allies that lasts until the end of your next turn. Allies inside the mist can hide even while observed.'
				),
			],
		}),
		ElementFactory.createAbility({
			...
			description:
				'Your blade draws a line through flesh, and a thread of life follows - woven back into your form.',
			type: ElementFactory.AbilityTypeFactory.createMain(),
			keywords: [AbilityKeyword.Magic, AbilityKeyword.Melee, AbilityKeyword.Strike, AbilityKeyword.Weapon],
			distance: [ElementFactory.DistanceFactory.createMelee()],
			target: 'One creature or object',
			...
			sections: [
				...
				ElementFactory.createAbilitySectionText(
					'You gain temporary Stamina equal to half the damage dealt by this ability.'
				),
			],
		}),
		ElementFactory.createAbility({
		...
		ElementFactory.createAbility({
			...
			type: ElementFactory.AbilityTypeFactory.createMain(),
			keywords: [AbilityKeyword.Area, AbilityKeyword.Magic, AbilityKeyword.Melee, AbilityKeyword.Weapon],
			distance: [ElementFactory.DistanceFactory.create({ type: AbilityDistanceType.Cube, value: 3, within: 1 })],
			target: 'Each enemy within area',
			cost: 5,
			sections: [
				ElementFactory.createAbilitySectionRoll(
				...
				ElementFactory.createAbilitySectionText(
					'You can jump up to 2 squares before resolving the power roll. The targets are force moved one at a time, starting with the targets nearest to you, and can be pushed into other targets in the area.'
				),
			],
		}),
		ElementFactory.createAbility({
			...
			sections: [
				...
				ElementFactory.createAbilitySectionText(
					"While dazed this way, the target's characteristic scores are treated as lower by 1 for the sake of resisting potencies."
				),
			],
		}),
		ElementFactory.createAbility({
			...
			distance: [ElementFactory.DistanceFactory.createSpecial('Four 5 x 1 lines within 1')],
			target: 'Each enemy within area',
			cost: 7,
			sections: [
				ElementFactory.createAbilitySectionRoll(
				...
				ElementFactory.createAbilitySectionText('Overlapping lines are treated as a single area.'),
			],
		}),
		ElementFactory.createAbility({
			id: 'mejqYrJQuCnj6X12',
			...
			sections: [
				ElementFactory.createAbilitySectionText(
					'For the rest of the combat encounter you have an additional maneuver per turn, and gain a +5 bonus to speed.'
				),
			],
		}),
		ElementFactory.createAbility({
			...
			sections: [
				...
				ElementFactory.createAbilitySectionText(
					'If this ability reduces a creature to 0 Stamina, gain 5 balance.'
				),
			],
		}),
		ElementFactory.createAbility({
	...
	subclasses: [
		{
			...
			name: 'Blinkblade',
			description:
				'A master of teleportation magic, the Blinkblades weave in and out of reach with uncanny speed - difficult to catch, and harder still to escape.',
			featuresByLevel: [
				{
					level: 1,
					features: [
						...
						ElementFactory.FeatureFactory.createAbility({
							ability: ElementFactory.createAbility({
								...
								target: 'Self',
								sections: [
									ElementFactory.createAbilitySectionText('You teleport up to 7 squares.'),
									ElementFactory.createAbilitySectionSpend({
										value: 5,
						...
						ElementFactory.FeatureFactory.createAbility({
							ability: ElementFactory.createAbility({
								...
								sections: [
									ElementFactory.createAbilitySectionText(
										'You take half the damage, you can then teleport up to 4 squares after the triggering effect resolves.'
									),
									ElementFactory.createAbilitySectionSpend({
							...
							options: [
								{
									feature: ElementFactory.FeatureFactory.createAbility({
										ability: ElementFactory.createAbility({
											...
											name: 'Phase Assault',
											description:
												'You blink between foes, each reappearance marked by a precise, cutting strike.',
											type: ElementFactory.AbilityTypeFactory.createMain(),
											keywords: [
											...
											sections: [
												...
												ElementFactory.createAbilitySectionText(
													'Choose a target within range 5, teleport to an unoccupied space adjacent to it, then apply the power roll result to it. Repeat this effect up to 3 more times. The same target cannot be chosen more than once.'
												),
											],
										}),
									}),
									...
									feature: ElementFactory.FeatureFactory.createAbility({
										ability: ElementFactory.createAbility({
											...
											sections: [
												...
												ElementFactory.createAbilitySectionText(
													'You may teleport to up to 15 squares before this strike.'
												),
											],
										}),
									}),
		...
		},
		{
			...
			name: 'Runewright',
			description:
				'The Runewright wields the ancient craft of runebranding to sear volatile runes onto living beings and shape the battlefield through groundlaid writs. ',
			featuresByLevel: [
				{
					level: 1,
					features: [
						...
						ElementFactory.FeatureFactory.createAbility({
							ability: ElementFactory.createAbility({
								...
								type: ElementFactory.AbilityTypeFactory.createTrigger('The target moves'),
								keywords: [AbilityKeyword.Magic],
								distance: [ElementFactory.DistanceFactory.createRanged(10)],
								target: 'One enemy',
								sections: [
									ElementFactory.createAbilitySectionText(
										'The target takes damage equal to triple your Reason score.'
									),
									ElementFactory.createAbilitySectionSpend({
				...
				},
				{
					...
					features: [
						ElementFactory.FeatureFactory.create({
							...
							name: 'Liminal Runes',
							description:
								'An enemy carrying an undetonated runebrand receives a bane on their power rolls. An ally carrying an undetonated runebrand gains an edge on their power rolls.',
						}),
						ElementFactory.FeatureFactory.createChoice({
							id: 'r7jDReOjykBnFpp2',
							...
							options: [
								{
									feature: ElementFactory.FeatureFactory.createAbility({
										ability: ElementFactory.createAbility({
											...
											name: 'Writ of Power',
											description:
												'You brand an arcane writ onto the ground, scorching foes, or soothing allies.',
											type: ElementFactory.AbilityTypeFactory.createManeuver(),
											keywords: [AbilityKeyword.Area, AbilityKeyword.Magic],
											distance: [
												ElementFactory.DistanceFactory.create({
...
* Writ of Sanctuary: Each ally, or youreslf, who enters the area for the first time in a combat round or starts their turn there may either spend a recovery, or end one effect that is ended by a saving throw or ends at the end of their turn.`),
									...
									feature: ElementFactory.FeatureFactory.createAbility({
										ability: ElementFactory.createAbility({
											...
											sections: [
												...
												ElementFactory.createAbilitySectionText(
													'While restrained this way, the target cannot teleport by any means.'
												),
											],
										}),
									}),
		...
		},
		{
			...
			name: 'Soulforged',
			description:
				'The Soulforged binds a fragment of their soul into a chosen weapon, forging a sentient extension of their will - a Soulblade. Through this bond, they shape and empower their blade, adapting its form and function to meet the shifting demands of battle. ',
			featuresByLevel: [
				{
					level: 1,
					features: [
...
By default, your Soulblade is sentient and capable of communicating with you, though you may choose to forgo this aspect of it.`,
						...
						ElementFactory.FeatureFactory.createAbility({
							ability: ElementFactory.createAbility({
								...
								name: 'Soulshape',
								description:
									'By reshaping the bound fragment of your soul, you persuade your Soulblade to take on a new form.',
								type: ElementFactory.AbilityTypeFactory.createManeuver(),
								keywords: [AbilityKeyword.Magic],
								distance: [ElementFactory.DistanceFactory.createSelf()],
								target: 'Self',
...
* Reaching: Melee weapon abilities have their distance increased by double your Reason.`),
						...
						ElementFactory.FeatureFactory.createAbility({
							ability: ElementFactory.createAbility({
								...
								sections: [
									ElementFactory.createAbilitySectionText(
										'You can shift a number of squares equal to your Reason score. If the target is you, or if you end this shift adjacent to the target, the target takes half the damage.'
									),
									ElementFactory.createAbilitySectionSpend({
										value: 2,
						...
						ElementFactory.FeatureFactory.createMultiple({
							...
							features: [
								ElementFactory.FeatureFactory.create({
									...
									name: 'Soul Instinct',
									description:
										'Once per turn, you can make a melee free strike whenever a creature moves from a square adjacent to you to another square adjacent to you.',
								}),
								ElementFactory.FeatureFactory.createBonus({
							...
							options: [
								{
									feature: ElementFactory.FeatureFactory.createAbility({
										ability: ElementFactory.createAbility({
											...
											sections: [
												ElementFactory.createAbilitySectionText(
													'Until the end of the encounter, whenever you gain the benefit of a Soulshape form, you may choose an additional form to benefit from. You can use the spend effect for no cost on both form benefits. You may use the Soulshape maneuver.'
												),
											],
										}),
									}),
								...
								},
								{
									feature: ElementFactory.FeatureFactory.createAbility({
										ability: ElementFactory.createAbility({
											...
											name: 'Soul Spiral',
											description:
												'Your Soulblade unfurls in a violent spiral, crashing through foes.',
											type: ElementFactory.AbilityTypeFactory.createMain(),
											keywords: [
												AbilityKeyword.Area,
												AbilityKeyword.Magic,
...
const vessel: HeroClassInterface = {
	id: 'vessel',
	name: 'Vessel',
	description: `
*By ChaoticGoodra*
...
As a vessel, you debilitate your enemies and bolster yourself, sacrificing long-term power for short term gain (or vice versa). You call on otherworldly gifts to rend your foes’ souls, and glimpse into the realms beyond ours.`,
	...
	subclassCount: 1,
	primaryCharacteristicsOptions: [[Characteristic.Presence]],
	primaryCharacteristics: [],
	featuresByLevel: [
		{
			level: 1,
			features: [
				...
				ElementFactory.FeatureFactory.createHeroicResource({
					...
					gains: [
						...
						{
							trigger:
								'The first time in a round a creature within 10 squares of you uses an ability with an associated potency',
							value: '1',
							tag: 'Potency 1',
						},
						{
							trigger:
								'The first time in an encounter a creature within 10 squares is reduced to 0 Stamina, or the first time in an encounter that a solo creature within 10 squares becomes winded',
							value: '2',
							tag: 'Winded 1',
						},
						{
							trigger:
								'The first time in an encounter an enemy within 10 squares makes a power roll with a bane',
							value: '2',
							tag: 'Bane 1',
						},
					],
...
* Your Magic abilities with the Area keyword have the area affected increased by 1. If the area is a line, you increase the size of one dimension, not both.`),
				...
				ElementFactory.FeatureFactory.createAbility({
					ability: ElementFactory.createAbility({
						...
						sections: [
							...
							ElementFactory.createAbilitySectionText(
								'The damage this ability deals can be your patron’s damage type.'
							),
						],
					}),
				}),
				ElementFactory.FeatureFactory.createChoice({
					...
					name: 'Boon',
					description:
						'Your patron has granted you a specific boon to enhance your defensive capabilities. You can choose one of the following boons. You can change your boon as a respite activity.',
					options: [
						{
							feature: ElementFactory.FeatureFactory.createBonus({
								id: 'vessel-1-7a',
						...
						},
						{
							feature: ElementFactory.FeatureFactory.create({
								...
								description:
									'Your soul burns with rage. When you take damage for the first time in a round, you gain 1 surge.',
							}),
							value: 1,
						},
						{
							feature: ElementFactory.FeatureFactory.createMultiple({
								...
								name: 'Boon of Shadow',
								description:
									'Your shadow encompasses your form. You gain a +1 bonus to speed and to the distance you shift when you take the Disengage move action.',
								features: [
									ElementFactory.FeatureFactory.createBonus({
										id: 'vessel-1-7f-1',
			...
			features: [
				ElementFactory.FeatureFactory.createAbility({
					ability: ElementFactory.createAbility({
						...
						sections: [
							ElementFactory.createAbilitySectionText(
								'You curse the target, causing them to have a bane on their next power roll before the end of their next turn.'
							),
							ElementFactory.createAbilitySectionSpend({
				...
				ElementFactory.FeatureFactory.create({
					...
					name: 'Soul Witness',
					description:
						'You can see the souls of those you face, peering into the true essence of their being to seek their vulnerabilities. Once per turn, you can choose a creature you can see within 10 as a free maneuver to learn which of their characteristic scores are < [weak].',
				}),
				ElementFactory.FeatureFactory.createClassAbilityChoice({
					id: 'vessel-3-3',
					cost: 7,
		...
		},
		{
			...
			features: [
				...
				ElementFactory.FeatureFactory.create({
					...
					name: 'Hear Me!',
					description:
						'When you Bargain, you can choose up to two enhancements. You lose an additional 1d6 Stamina if you choose a second.',
				}),
				ElementFactory.FeatureFactory.create({
					id: 'vessel-4-4',
					name: 'Hexbinder',
					description:
						'Once per turn, when a creature is unaffected by a potency you inflict, you gain a surge, which you can choose to immediately use on any damage associated with the ability. Alternatively, you can forgo a successful potency to gain the same benefit.',
				}),
				ElementFactory.FeatureFactory.createPerk({
					id: 'vessel-4-5',
				}),
	...
	abilities: [
		...
		ElementFactory.createAbility({
			...
			sections: [
				...
				ElementFactory.createAbilitySectionText(
					'You gain temporary Stamina equal to your Presence score until the start of your next turn. If the attack kills the target, you get temporary Stamina equal to thrice your Presence score until the start of your next turn instead.'
				),
			],
		}),
		ElementFactory.createAbility({
			...
			type: ElementFactory.AbilityTypeFactory.createMain(),
			keywords: [AbilityKeyword.Area, AbilityKeyword.Magic, AbilityKeyword.Ranged],
			distance: [ElementFactory.DistanceFactory.create({ type: AbilityDistanceType.Cube, value: 2, within: 10 })],
			target: 'All enemies',
			cost: 'signature',
			sections: [
				ElementFactory.createAbilitySectionRoll(
		...
		ElementFactory.createAbility({
			...
			sections: [
				...
				ElementFactory.createAbilitySectionText(
					'If you’ve taken damage since the start of your last turn, you gain 1 surge before making the power roll.'
				),
			],
		}),
		ElementFactory.createAbility({
		...
		ElementFactory.createAbility({
			...
			sections: [
				...
				ElementFactory.createAbilitySectionText(
					'You or an ally within range gain temporary Stamina equal to half the damage dealt.'
				),
			],
		}),
		ElementFactory.createAbility({
		...
		ElementFactory.createAbility({
			...
			sections: [
				...
				ElementFactory.createAbilitySectionText(
					'A frenzied target makes a melee free strike against all your enemies within their range, including themself.'
				),
			],
		}),
		ElementFactory.createAbility({
			...
			sections: [
				...
				ElementFactory.createAbilitySectionText(
					'While weakened this way, the creature can’t benefit from edges or a critical hit.'
				),
			],
		}),
		ElementFactory.createAbility({
			...
			sections: [
				...
				ElementFactory.createAbilitySectionText(
					'If a target is affected by the potency and is already bleeding, it takes additional damage equal to your Presence score.'
				),
			],
		}),
		ElementFactory.createAbility({
		...
		ElementFactory.createAbility({
			...
			type: ElementFactory.AbilityTypeFactory.createMain(),
			keywords: [AbilityKeyword.Area, AbilityKeyword.Magic, AbilityKeyword.Ranged],
			distance: [ElementFactory.DistanceFactory.create({ type: AbilityDistanceType.Cube, value: 5, within: 10 })],
			target: '',
			cost: 5,
			sections: [
				ElementFactory.createAbilitySectionRoll(
				...
				ElementFactory.createAbilitySectionText(
					'The area becomes difficult terrain for your enemies. Each square willingly moved through causes the enemy to take 1 patron damage.'
				),
			],
		}),
		ElementFactory.createAbility({
			...
			sections: [
				...
				ElementFactory.createAbilitySectionText(
					'While slowed this way, the target rolls two d10s on saving throws and takes the lower, and takes double damage from ending it using End Effect.'
				),
			],
		}),
		ElementFactory.createAbility({
			...
			sections: [
				...
				ElementFactory.createAbilitySectionText(
					'Until the end of the encounter, the target is harrowed. You can use a maneuver on your turn to cause all creatures harrowed by you to take patron damage equal to thrice your Presence score.'
				),
			],
		}),
		ElementFactory.createAbility({
			...
			sections: [
				...
				ElementFactory.createAbilitySectionText(
					'A target can’t be moved in a way that would harm them (such as over a cliff), leave them dying, or result in them suffering a condition or other negative effect.'
				),
			],
		}),
		ElementFactory.createAbility({
			...
			sections: [
				...
				ElementFactory.createAbilitySectionText(
					'You gain temporary Stamina equal to half the total damage dealt.'
				),
			],
		}),
		ElementFactory.createAbility({
			...
			sections: [
				ElementFactory.createAbilitySectionText(
					'The target is sent to your patron’s native manifold, removing it from the encounter until the end of their next turn, reappearing in their original space or the nearest available space. Make a power roll upon its return.'
				),
				ElementFactory.createAbilitySectionRoll(
					ElementFactory.createPowerRoll({
						characteristic: Characteristic.Presence,
		...
		ElementFactory.createAbility({
			...
			sections: [
				...
				ElementFactory.createAbilitySectionText(
					'If the target is winded after damage resolves, they die if they rely on a heart to live and aren’t a leader, solo or boss. Otherwise, a winded creature is bleeding (save ends).'
				),
			],
		}),
		ElementFactory.createAbility({
			...
			sections: [
				...
				ElementFactory.createAbilitySectionText(
					'A wracked creature must spend twice as much malice to use any ability that costs malice, at the start of their turn or as part of their statblock.'
				),
			],
		}),
		ElementFactory.createAbility({
			...
			keywords: [AbilityKeyword.Area, AbilityKeyword.Magic, AbilityKeyword.Ranged],
			distance: [
				ElementFactory.DistanceFactory.create({ type: AbilityDistanceType.Wall, value: 10, within: 10 }),
			],
			target: 'Special',
			cost: 9,
			sections: [
					...
					features: [
						...
						ElementFactory.FeatureFactory.createAbility({
							ability: ElementFactory.createAbility({
								...
								type: ElementFactory.AbilityTypeFactory.createTrigger('A creature damages the target.'),
								keywords: [AbilityKeyword.Magic, AbilityKeyword.Ranged],
								distance: [ElementFactory.DistanceFactory.createRanged(10)],
								target: 'Self or 1 ally',
								sections: [
									ElementFactory.createAbilitySectionText(
										'The damaging creature takes fire damage equal to twice your Presence score, and is pushed 1 square from the target.'
									),
								],
							}),
						}),
...
| 12 (lvl 4+) | Your Infernal Rebuke’s damage increases to four times your Presence score, and its push increases to 5 squares. |`,
				...
				},
				{
					...
					features: [
						ElementFactory.FeatureFactory.create({
							...
							name: 'Hellsight',
							description:
								'You don’t take a bane on attacks against concealed creatures. You can see in darkness.',
						}),
					],
				},
				{
				...
				},
				{
					...
					features: [
						ElementFactory.FeatureFactory.create({
							...
							name: 'Devilish Luck',
							description:
								'Your patron has taught you how to bargain with fate. Before you make a power roll, you can take 1d6 damage to gain an edge on the roll.',
						}),
					],
				},
			],
			abilities: [
				ElementFactory.createAbility({
					...
					type: ElementFactory.AbilityTypeFactory.createTrigger(
						'A creature damages you with a rolled ability.',
						{ free: true }
					),
					keywords: [AbilityKeyword.Magic, AbilityKeyword.Ranged],
					distance: [ElementFactory.DistanceFactory.createRanged(10)],
					...
					sections: [
						ElementFactory.createAbilitySectionText(
							'The target obtains a tier 1 result on the power roll against you. You can add one additional target within the range or area to the ability, including enemies or the target themself. Then, roll power.'
						),
						ElementFactory.createAbilitySectionRoll(
							ElementFactory.createPowerRoll({
								characteristic: Characteristic.Presence,
				...
				ElementFactory.createAbility({
					...
					keywords: [AbilityKeyword.Area, AbilityKeyword.Magic, AbilityKeyword.Ranged],
					distance: [
						ElementFactory.DistanceFactory.create({ type: AbilityDistanceType.Cube, value: 3, within: 10 }),
					],
					target: 'All enemies',
					cost: 5,
					sections: [
						...
						ElementFactory.createAbilitySectionText(
							'The first time an aflame target willingly moves, they take fire damage equal to twice your Presence score and the condition ends.'
						),
					],
				}),
			],
					...
					features: [
						...
						ElementFactory.FeatureFactory.createAbility({
							ability: ElementFactory.createAbility({
								...
								sections: [
									ElementFactory.createAbilitySectionText(
										'You gain temporary Stamina equal to twice your Presence score and reduce any potency of effects associated with the damage by 1.'
									),
								],
							}),
						}),
						ElementFactory.FeatureFactory.createAbility({
							ability: ElementFactory.createAbility({
								...
								sections: [
									ElementFactory.createAbilitySectionText(
										'You can sense the last things seen by a corpse or head of a dead creature that you can touch.'
									),
								],
							}),
						}),
...
| 12 (lvl 4+) | Your Incorporeality’s temporary Stamina increases to four times your Presence score. |`,
				...
				},
				{
					...
					features: [
						ElementFactory.FeatureFactory.create({
							...
							description:
								'You’re not fully alive. When you can take the Catch Breath maneuver or are the target of a Heal action, you can spend as many Recoveries as you like instead of just one. If you hold a severed body part in place and spend a recovery to regain Stamina, the body part reattaches, and any part of your dead body can count as your full remains.',
						}),
					],
				},
				{
				...
				},
				{
					...
					features: [
						ElementFactory.FeatureFactory.create({
							...
							description:
								'Your connection to death allows you to subvert it. You and allies within 10 of you die when their negative Stamina equals their Stamina total, rather than their winded total.',
						}),
					],
				},
			],
			abilities: [
				ElementFactory.createAbility({
					...
					keywords: [AbilityKeyword.Area, AbilityKeyword.Magic, AbilityKeyword.Ranged],
					distance: [
						ElementFactory.DistanceFactory.create({ type: AbilityDistanceType.Cube, value: 4, within: 10 }),
					],
					target: 'All enemies',
					cost: 5,
					sections: [
						...
						ElementFactory.createAbilitySectionText(
							'Choose Rotting Zombie or Shade. If you kill one or more creatures with this ability, they return in their spaces under your control as the chosen minion type. They can’t take their turns until your next turn.'
						),
					],
				}),
				ElementFactory.createAbility({
					...
					sections: [
						ElementFactory.createAbilitySectionText(
							'Until the end of the encounter, when you use this and at the start of your turn, you can spend any number of Recoveries. If you spend none, you gain temporary Stamina equal to thrice your Presence score that lasts until the start of your next turn.'
						),
					],
				}),
			],
					...
					features: [
						...
						ElementFactory.FeatureFactory.createAbility({
							ability: ElementFactory.createAbility({
								...
								type: ElementFactory.AbilityTypeFactory.createTrigger(
									'An enemy starts or ends their turn.'
								),
								keywords: [AbilityKeyword.Magic, AbilityKeyword.Ranged],
								distance: [ElementFactory.DistanceFactory.createRanged(10)],
								target: 'One enemy',
								sections: [
									ElementFactory.createAbilitySectionText(
										'You slide the target a number of squares up to your Presence score.'
									),
								],
							}),
						}),
...
| 12 (lvl 4+) | Your Perplex’s slide increases to thrice your Presence score. |`,
				...
				},
				{
					...
					features: [
						ElementFactory.FeatureFactory.create({
							...
							name: 'Sense Minds',
							description:
								'You know the general location of all creatures within 10 of you, regardless of line of effect. This does not impact their ability to hide from you, but you have a double edge on the Search for Hidden Creatures maneuver to find creatures in this range.',
						}),
					],
				},
				{
				...
				},
				{
					...
					features: [
						ElementFactory.FeatureFactory.create({
							...
							name: 'Mind Piercer',
							description:
								'Your increasingly alien mind allows you to slip past mental defenses as if they weren’t there. If you use an ability that has a Reason, Intuition or Presence potency associated with it, you can choose before using the ability to change the potency to another of those characteristics.',
						}),
					],
				},
			],
			abilities: [
				ElementFactory.createAbility({
					...
					sections: [
						ElementFactory.createAbilitySectionText(
							'Until the end of the encounter or you are dying, whenever an enemy uses an ability on you that requires line of effect or Searches while it can perceive you, the creature takes psychic damage equal to thrice your Presence score unless it takes a double bane on the roll.'
						),
					],
				}),
				ElementFactory.createAbility({
...
export const communityPrerelease: SourcebookInterface = {
...
export const community: SourcebookInterface = {
	id: 'community',
	name: 'Community',
	description: 'Selected community creations.',
	type: SourcebookType.Community,
	adventures: [],
	ancestries: [aranox, solar],
	careers: [],
	classes: [vessel],
	complications: [],
	cultures: [],
