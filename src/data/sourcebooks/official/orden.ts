...
export const orden: SourcebookInterface = {
	id: 'orden',
	name: 'Orden',
	description: 'The default setting for Draw Steel.',
	type: SourcebookType.Official,
	adventures: [],
	ancestries: [AncestryData.hakaan, AncestryData.memonek, AncestryData.timeRaider],
	careers: [],
	classes: [],
	complications: [],
	cultures: [],
	...
	languages: [
		...
		},
		{
			name: 'Variac',
			description:
				'Spoken by gnomes, olothecs, trolls, and voiceless talkers; the common language of the World Below.',
			type: LanguageType.Cultural,
			related: [],
		},
		{
