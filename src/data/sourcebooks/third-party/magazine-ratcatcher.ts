...
const anthousai: AncestryInterface = {
		...
		ElementFactory.FeatureFactory.createMultiple({
			...
			features: [
				ElementFactory.FeatureFactory.create({
					...
					name: 'Delicate Grace',
					description:
						'Your petals and leaves give you substantial surface area compared to your weight. Whenever you fall, you reduce the distance of the fall by 2 squares.',
				}),
			...
			options: [
				...
				},
				{
					feature: ElementFactory.FeatureFactory.create({
						...
						name: 'Natural Charm',
						description:
							'Your close affinity with the natural world allows you to influence other non-supernatural plants and animals. You gain an edge on Intuition and Presence tests made to interact with plants and animals, or when using the Handle Animals skill.',
					}),
					value: 1,
				},
				{
					feature: ElementFactory.FeatureFactory.create({
						...
						name: 'Thorned',
						description:
							'Long spines on your body let you make your point most sharply. Once per round when you make a melee strike, you can deal extra damage with the strike equal to your highest characteristic score.',
					}),
					value: 1,
				},
				{
					feature: ElementFactory.FeatureFactory.createSaveThreshold({
						...
						description:
							'You appear to persevere effortlessly. Whenever you make a saving throw, you succeed on a roll of 5 or higher.',
						value: 5,
					}),
					value: 2,
				},
				{
					feature: ElementFactory.FeatureFactory.createAbility({
						ability: ElementFactory.createAbility({
							...
							name: 'Luring Scent',
							description:
								'Enchanting blossoms emit a dangerously alluring scent, magically drawing an enemy toward them.',
...
Dryads have forms as varied as the trees they resemble. Smooth skinned or rough, dark or pale, thin or stout. Seldom seen in cities, even scholars convinced they exist cannot agree whether that is due to their rarity, or because they hold a duty to the wild forests that occupies their collective interests far from “civilization,” or prying eyes.`,
	features: [
		ElementFactory.FeatureFactory.create({
			...
			name: 'Regrowth',
			description:
				'Your body can slowly restore wounds that would have felled animals. When you spend recoveries outside of combat, you may gain an extra 3 stamina per recovery spent.',
		}),
		ElementFactory.FeatureFactory.createDamageModifier({
			id: 'dryad-feature-2',
			name: 'Toughened Wood',
			...
			options: [
				...
				},
				{
					feature: ElementFactory.FeatureFactory.createBonus({
						...
						name: 'Rooted',
						description:
							'Your dense wooden body and connection to the earth makes it difficult for others to move you.',
				...
				},
				{
					feature: ElementFactory.FeatureFactory.create({
						...
						name: 'Many Limbed',
						description:
							'Your multiple arms let you take on multiple tasks at the same time. Whenever you use the Grab or Knockback maneuver against an adjacent creature, you can target an additional adjacent creature, using the same power roll for both targets. Additionally, you can have up to two creatures grabbed at a time.',
					}),
					value: 2,
				},
				{
...
export const ratcatcher: SourcebookInterface = {
	id: 'ratcatcher',
	name: 'Ratcatcher Magazine',
	description:
		'A selection of content from [Ratcatcher Magazine](https://tidalwavegames.itch.io/ratcatcher-magazine).',
	type: SourcebookType.ThirdParty,
	adventures: [],
	ancestries: [anthousai, dryad],
	careers: [],
	complications: [],
	cultures: [],
	classes: [],
