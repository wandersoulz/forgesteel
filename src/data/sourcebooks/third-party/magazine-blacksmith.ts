...
const goblinSquad: AncestryInterface = {
...
In combat, any goblin who is out of range of the Boss (ignoring LoE) can only use movement, and can only move towards the Boss.`,
		...
		ElementFactory.FeatureFactory.create({
			...
			name: 'Tiny Stabs',
			description:
				'Whenever a goblin makes an opportunity attack, they deal damage equal to their highest characteristic plus any weapon damage bonus you have (such as from kits or treasures).',
		}),
		ElementFactory.FeatureFactory.create({
			id: 'goblin-squad-feature-4',
			name: 'Frail Constitution',
			description:
				'While together they may be mighty, individually they are very weak. When an individual goblin is suffering from being Weakened, Slowed, Frightened, Dazed, or Bleeding, they are stunned. While stunned this way, they can take no actions, manoeuvres/free manoeuvres, triggered actions/free triggered actions, movement, and cannot be made the Boss. If every goblin is stunned, then the boss can still act as normal (though still suffering normally from any conditions they might have).',
		}),
		ElementFactory.FeatureFactory.create({
			id: 'goblin-squad-feature-5',
			name: 'Goblin Turns',
			description:
				'On your turn, you can use actions, manoeuvres, and triggered actions from any goblin. If you use an ability which only affects yourself, then you can use it with ALL of your goblins (For example, the Push and Grab manoeuvres happen for one goblin, but the stand up from prone and escape grab manoeuvres apply to every goblin). When you move, you can move with every goblin, and you can individually choose to advance, disengage, or ride for each.',
		}),
		ElementFactory.FeatureFactory.create({
			id: 'goblin-squad-feature-6',
			name: 'Safety in Numbers',
			description:
				'Being a tight-knit squad is all fun and games until the Elementalist casts conflagration. Whenever multiple goblins take damage from the same ability, each goblin takes half damage. This includes being attacked by a squad of minions.',
		}),
		ElementFactory.FeatureFactory.create({
			id: 'goblin-squad-feature-7',
			name: "No, That's MY Surge!",
			description:
				'Goblins will squabble over anything. If multiple goblins in the same squad would benefit or be allowed to act by an ability, only one of them gains that benefit. When a goblin dies with a beneficial effect that has a duration, another goblin of your choice gains that effect for the remainder of the duration.',
		}),
			...
			options: [
				...
				},
				{
					feature: ElementFactory.FeatureFactory.create({
						...
						name: 'Snap Elections',
						description:
							'Goblins are masters of rapid democracy and picking the right gob for the job. You can change the Boss off your turn, and can make stunned goblins the Boss.',
					}),
					value: 1,
				},
				{
					feature: ElementFactory.FeatureFactory.create({
						...
						description:
							'For each that falls, two one will take their place. As a triggered action when a goblin is killed, you may spend a recovery.',
					}),
					value: 1,
				},
				{
				...
				},
				{
					feature: ElementFactory.FeatureFactory.create({
						...
						name: 'Sneaky',
						description:
							'Stealth comes third nature to goblins (after stabbing things and running away). You can move at full speed when sneaking.',
					}),
					value: 1,
				},
				{
					feature: ElementFactory.FeatureFactory.create({
						...
						description:
							'Each member of your band is a highly specialised expert. Assign each skill you have to a specific goblin in your group, as evenly as possible. Whenever that goblin dies, you lose those skills, and must pick different ones from the same skill groups which will be given to their replacement.',
					}),
					value: 1,
				},
				{
					feature: ElementFactory.FeatureFactory.create({
						...
						description:
							'You are practised in coordinated takedowns. When you have multiple goblins next to a target you attempt to grab, they can all take the grab maneuver against that target. The maximum size of creature you can grab is increased by the number of goblins currently or attempting to grab them beyond the first.',
					}),
					value: 2,
				},
				{
					feature: ElementFactory.FeatureFactory.create({
						...
						name: 'Crafty',
						description:
							"By weaving in between their legs, you can turn your enemies or allies into protectors. When you move into a creature's square, that movement doesn't trigger opportunity attacks.",
					}),
					value: 2,
				},
				{
					feature: ElementFactory.FeatureFactory.create({
						...
						description:
							'Like chefs in a kitchen, you know how to best work together and get the job done. Add +2 to the results of any crafting project roll. If you are crafting a consumable item, add +4 instead.',
					}),
					value: 2,
				},
			],
...
const psiBorg: AncestryInterface = {
...
Flesh and blood fused with crystal and technology, a union disdained by most timescape governance. Whether implanted through black markets or created under the tight leash of UNISOL, the life of a Psi-borg is far from comfortable. It is not uncommon for Psi-borgs to flee to lower-energy worlds in search of escape. They were outlawed in the earliest days of UNISOL, following their devastating use in the First Psychic War.`,
	features: [
		ElementFactory.FeatureFactory.createAncestry({
			id: 'psi-borg-feature-1',
			name: 'Vessel of Flesh',
			description:
				'Choose the ancestry you were before you were improved! Your size is that ancestry’s size and your speed is 5. Unless you select one of the Vestige of the Vessel traits (see below), you don’t receive any other ancestral traits from your original ancestry.',
		}),
		ElementFactory.FeatureFactory.create({
			...
			options: [
				{
					feature: ElementFactory.FeatureFactory.create({
						...
						name: 'Psi-Brand',
						description:
							'You are an agent of UNISOL and maintain direct communication with your handler. As long as you continue to support UNISOL’s interests, you may call in favours. Make sure to talk to your Director about the limits of aid given by UNISOL and how it would work in practice.',
					}),
					value: 1,
				},
				{
					feature: ElementFactory.FeatureFactory.create({
						...
						description:
							'You select an echelon 1 Psionic Implant that you have already had installed. You gain the effects of this implant.',
					}),
					value: 2,
				},
				{
					feature: ElementFactory.FeatureFactory.createAncestryFeature({
...
const abundanceOfLoveAndReticence: ItemInterface = ElementFactory.createItem({
	id: 'item-abundance',
		...
		},
		{
			...
			features: [
				ElementFactory.FeatureFactory.create({
					...
					name: '',
					description:
						'While you wield this implement, your area magic or psionic abilities with an aura or burst increase in size by 1.',
				}),
				ElementFactory.FeatureFactory.create({
...
const braidedDecay: ItemInterface = ElementFactory.createItem({
	...
	featuresByLevel: [
		{
			...
			features: [
				ElementFactory.FeatureFactory.create({
					...
					name: 'Level 1',
					description:
						'At the end of each of your turns, each enemy adjacent to you takes 2 poison damage. Damage from this belt is doubled against enemies with temporary stamina.',
				}),
		...
		},
		{
			...
			features: [
				ElementFactory.FeatureFactory.create({
					...
					name: 'Level 5',
					description:
						'The belt’s poison damage increases to 4. Enemies damaged by this belt can’t regain stamina until the end of their next turn. Additionally, you can instantly wither mundane plants that come adjacent to you.',
				}),
				ElementFactory.FeatureFactory.createBonus({
		...
		},
		{
			...
			features: [
				ElementFactory.FeatureFactory.create({
					...
					name: 'Level 9',
					description:
						'The belt’s poison damage increases to 6. Enemies damaged by this belt are weakened and can’t regain stamina until the end of their next turn. Damage from this belt can’t be reduced in any way.',
				}),
				ElementFactory.FeatureFactory.createBonus({
...
const darkStarPlate: ItemInterface = ElementFactory.createItem({
	...
	featuresByLevel: [
		{
			...
			features: [
				ElementFactory.FeatureFactory.create({
					...
					name: 'Level 1',
					description:
						'When an ally within 5 is targeted by a strike that you are not a target of, you can use a free triggered action to increase your gravitational pull relative to the strike and become the target instead of the triggering ally, using the same power roll. You must be within range and line of effect of the strike.',
				}),
			],
		},
		{
			...
			features: [
				ElementFactory.FeatureFactory.create({
					...
					name: 'Level 5',
					description:
						'You can use a maneuver to vertically pull 5 a creature or object within 5 of you. If the creature is willing, this forced movement ignores their stability.',
				}),
			],
		},
		{
			...
			features: [
				ElementFactory.FeatureFactory.create({
					...
					name: 'Level 9',
					description:
						'The range for both effects increases to 10, and the pull ignores the stability of enemies.',
				}),
			],
		},
	],
...
const shiftingTides: ItemInterface = ElementFactory.createItem({
	...
	featuresByLevel: [
		{
			...
			features: [
				ElementFactory.FeatureFactory.create({
					...
					name: 'Level 1',
					description:
						'When you use a magic or psionic ability that deals damage that isn’t untyped or holy damage, you can change the damage type to another, non-holy damage type as a free triggered action.',
				}),
			],
		},
		{
			...
			features: [
				ElementFactory.FeatureFactory.create({
					...
					name: 'Level 5',
					description:
						'While you wield this implement, you or an adjacent ally takes damage that isn’t untyped or holy damage, you can change the damage type to another, non-holy damage type as a triggered action. The first time you use this triggered action in an encounter, it is a free triggered action.',
				}),
			],
		},
		{
...
const siegeEnder: ItemInterface = ElementFactory.createItem({
	id: 'item-siege-ender',
	name: 'Siege Ender',
	description: `
*By Anna / Nathan Lee*
	...
	featuresByLevel: [
		{
			...
			features: [
				ElementFactory.FeatureFactory.create({
					...
					name: 'Level 1',
					description:
						'Any weapon ability that deals rolled damage using this weapon deals an extra 1 fire damage, or an extra 2 fire damage if the target is an object. You gain a surge the first time in a round you destroy an object or force move a target into an object with an ability that benefits from this weapon’s damage.',
				}),
			],
		},
		{
...
const titanShield: ItemInterface = ElementFactory.createItem({
	...
	featuresByLevel: [
		{
			...
			features: [
				ElementFactory.FeatureFactory.create({
					...
					name: 'Level 1',
					description:
						'When you are force moved into an object and would cause it to break, you can use a free triggered action to magically brace the object. The braced object does not break from this forced movement, but you take damage from the remainder of your forced movement as usual.',
				}),
				ElementFactory.FeatureFactory.createBonus({
		...
		},
		{
			...
			features: [
				ElementFactory.FeatureFactory.create({
					...
					name: 'Level 5',
					description:
						'You add +2 to your effective size for the purpose of interacting with creatures and objects, including determining whether you can lift an object, are affected by forced movement, and so forth. This has no effect on whether you can be grabbed.',
				}),
				ElementFactory.FeatureFactory.createBonus({
		...
		},
		{
			...
			features: [
				ElementFactory.FeatureFactory.create({
					...
					name: 'Level 9',
					description:
						'Your bonus to effective size increases to +4. When you are subjected to forced movement, you can use a free triggered action to materialize a size 1L object adjacent to you in the path of your forced movement and brace it. You decide what the object looks like and what it is made of, but it must be a fragile material similar to glass. Any such objects remaining at the end of the encounter crumble and are destroyed.',
				}),
				ElementFactory.FeatureFactory.createBonus({
...
const wingedSandals: ItemInterface = ElementFactory.createItem({
	...
	featuresByLevel: [
		{
			...
			features: [
				ElementFactory.FeatureFactory.create({
					...
					name: 'Level 1',
					description:
						'While you wear these sandals, you gain a +1 bonus to your jump distance and height. Additionally, you reduce the effective height of your falls by 2 squares.',
				}),
				ElementFactory.FeatureFactory.createBonus({
		...
		},
		{
			...
			features: [
				ElementFactory.FeatureFactory.create({
					...
					name: 'Level 5',
					description:
						'While wearing these sandals, your speed gains the Fly keyword. Additionally, the reduction of fall height increases to 4 squares. If you have Wings from your ancestry, you have a +1 bonus to speed while flying.',
				}),
			],
		},
		{
			...
			features: [
				ElementFactory.FeatureFactory.create({
					...
					name: 'Level 9',
					description:
						'While wearing these sandals, you ignore the Slowed condition while flying. Additionally, the reduction of fall height increases to 6 squares.',
				}),
			],
		},
	],
...
const arachnianImplants: ItemInterface = ElementFactory.createItem({
	...
	featuresByLevel: [
		{
			...
			features: [
				ElementFactory.FeatureFactory.create({
					...
					name: 'Arachnian Implants',
					description:
						'While extended, you can automatically climb at full speed. You also gain an edge on tests that use the Climb or Gymnastics skills. As a Triggered Action, when you use an ability with the Strike keyword, you can choose to deal damage equal to your Reason score to all adjacent enemies.',
				}),
			],
		},
	],
...
const internalSuspension: ItemInterface = ElementFactory.createItem({
	...
	featuresByLevel: [
		{
			...
			features: [
				ElementFactory.FeatureFactory.create({
					...
					name: 'Internal Suspension',
					description:
						'Whenever you become dying all conditions affecting you end. Additionally as a manoeuvre you can enter a state of suspension that is indiscernible from death. This also removes all conditions. You can only exit your suspension if another hero uses their action to reactivate your body.',
				}),
			],
		},
	],
...
const opticalMoteFocuser: ItemInterface = ElementFactory.createItem({
...
const psionicBackup: ItemInterface = ElementFactory.createItem({
...
const mauler: KitInterface = {
	id: 'kit-mauler',
	name: 'Mauler',
	description: `
*By Harmonic Hewell*

Heroes using the Mauler KitInterface charge headfirst into battle, undaunted by the dangers ahead. Wielding nothing but a medium weapon and your audacity, you are as fearsome as you are fearless.`,
	type: '',
	armor: [],
	weapon: [KitWeapon.Medium],
	stamina: 3,
		...
		ElementFactory.FeatureFactory.createAbility({
			ability: ElementFactory.createAbility({
				...
				sections: [
					...
					ElementFactory.createAbilitySectionText('You gain a surge.'),
				],
			}),
		}),
	],
		...
		ElementFactory.FeatureFactory.createAbility({
			ability: ElementFactory.createAbility({
				...
				sections: [
					...
					ElementFactory.createAbilitySectionText('The target is taunted (EoT).'),
				],
			}),
		}),
	],
...
const installImplant = ElementFactory.createProject({
...
export const blacksmith: SourcebookInterface = {
	id: 'blacksmith',
	...
	adventures: [],
	ancestries: [goblinSquad, psiBorg],
	careers: [],
	complications: [],
	cultures: [],
	classes: [],
	...
	kits: [barnacle, condor, eagle, juggernaut, mauler, sunWukong, swift],
	monsterGroups: [],
	montages: [],
	negotiations: [],
	perks: [],
	projects: [installImplant],
	subclasses: [],
	titles: [],
	skills: [],
	languages: [],
