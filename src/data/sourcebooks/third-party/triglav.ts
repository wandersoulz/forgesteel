...
const boggit: AncestryInterface = {
	id: 'boggit',
	name: 'Boggit',
	description: `
*By Triglav Games*
			...
			options: [
				{
					feature: ElementFactory.FeatureFactory.createMultiple({
						...
						name: 'Bog Immunities',
						description:
							'You lived in a swamp long enough to develop some resilience against various poisons.',
						features: [
				...
				},
				{
					feature: ElementFactory.FeatureFactory.create({
						...
						name: 'Reliable Jumps',
						description:
							"You achieved consistency when it comes to jumping. You can't obtain lower than a tier 2 outcome on any Might or Agility test made to jump.",
					}),
					value: 1,
				},
				{
					feature: ElementFactory.FeatureFactory.create({
						...
						name: 'Slippery Skin',
						description:
							'Your slippery skin makes you harder to catch. Enemies take a bane on tests and a -1 on potencies made to grab or restrain you. You have an edge on tests made to escape grabs.',
					}),
					value: 1,
				},
				{
						...
						ability: ElementFactory.createAbility({
							...
							sections: [
								...
								ElementFactory.createAbilitySectionText(
									"If you grab the target this way, they don't count towards your limit of grabbed creatures."
								),
							],
						}),
					}),
				...
				},
				{
					feature: ElementFactory.FeatureFactory.create({
						...
						description:
							'Your limbs are adapted for digging. You can automatically burrow horizontally at full speed while moving and you can use the Dig maneuver.',
					}),
					value: 2,
				},
				{
							...
							},
							{
								feature: ElementFactory.FeatureFactory.createAbility({
									ability: ElementFactory.createAbility({
										...
										sections: [
											ElementFactory.createAbilitySectionText(
												'Each target gains temporary Stamina equal to your Reason, Intuition, or Presence score.'
											),
										],
									}),
								}),
							...
							},
							{
								feature: ElementFactory.FeatureFactory.createAbility({
									ability: ElementFactory.createAbility({
										...
										cost: 'signature',
										sections: [
											ElementFactory.createAbilitySectionText('Each target gains a surge.'),
										],
									}),
								}),
								value: 1,
...
* You can breathe underwater.`,
				...
				},
				{
					feature: ElementFactory.FeatureFactory.create({
						...
						name: 'Swarm Tactics',
						description:
							"Your abilities gain an edge when used against creatures that are adjacent to at least one of your non-minion allies, but you don't gain another edge when the same ally is also flanking the creature with you.",
					}),
					value: 1,
				},
				{
					feature: ElementFactory.FeatureFactory.create({
						...
						description:
							'Your abilities gain an edge when used against creatures affected by difficult terrain. Additionally, you have concealment when you are in water or difficult terrain.',
					}),
					value: 1,
				},
			],
...
const vampireAncestry: AncestryInterface = {
	id: 'vampire-ancestry',
	name: 'Vampire',
	description: `
*By Triglav Games*
...
When choosing an ancestry, you can choose to be a vampire. A hero with the vampire ancestry can't use the vampire class.`,
	features: [
		ElementFactory.FeatureFactory.create({
			...
			name: 'Bloodthirst',
			description:
				'You gain an edge on ability rolls made against bleeding, winded, or dying creatures. If there is a bleeding, winded, or dying creature within 10 squares of you, you take a bane on ability rolls against creatures not suffering from any of these conditions. Using the Sanguine Kiss maneuver suppresses the drawback of this feature until the start of your next turn.',
		}),
		...
		ElementFactory.FeatureFactory.createAbility({
			ability: ElementFactory.createAbility({
				...
				sections: [
					ElementFactory.createAbilitySectionText(
						"The target takes corruption damage equal to your highest characteristic score. This damage can't be reduced in any way. You gain temporary Stamina equal to your level + 2. For each condition the target is suffering, increase the damage taken and temporary Stamina gained by 1."
					),
				],
			}),
		}),
			...
			options: [
				{
					feature: ElementFactory.FeatureFactory.create({
						...
						description:
							'Your bites sap strength from your prey. When you use the Sanguine Kiss maneuver, the target is M < Average weakened (save ends).',
					}),
					value: 1,
				},
				{
					feature: ElementFactory.FeatureFactory.create({
						...
						description:
							'Once per round, when you deal damage to a bleeding, winded, or dying creature, you gain 1 surge.',
					}),
					value: 1,
				},
				{
					feature: ElementFactory.FeatureFactory.create({
						...
						description:
							'When you are winded and use the Sanguine Kiss maneuver, you can spend a Recovery as part of the ability.',
					}),
					value: 1,
				},
				{
					feature: ElementFactory.FeatureFactory.create({
						...
						name: 'Out for Blood',
						description:
							"Your senses are sensitive to blood. You don't take a bane on strikes made against bleeding, dying or winded creatures with concealment, and such creatures can't be hidden from you.",
					}),
					value: 1,
				},
				{
				...
				},
				{
					feature: ElementFactory.FeatureFactory.createBonus({
						...
						description:
							'The dark magic keeping you alive surges within you, allowing you to keep fighting longer.',
				...
				},
				{
					feature: ElementFactory.FeatureFactory.create({
						...
						description:
							'Whenever you start your turn within 10 squares of a bleeding, winded, or dying creature, you gain a +2 bonus to speed until the start of your next turn.',
					}),
					value: 1,
				},
				{
...
const vampireClass: HeroClassInterface = {
	id: 'vampire-class',
	name: 'Vampire',
	description: `
*By Triglav Games*
				...
				ElementFactory.FeatureFactory.createHeroicResource({
					...
					gains: [
						...
						},
						{
							tag: 'bleeding',
							trigger:
								'The first time each round that a non-minion creature within 10 squares of you is made bleeding, winded, or dying, or reduced to 0 Stamina',
							value: '1',
						},
						{
							tag: 'deal-damage-self',
							trigger:
								'The first time each round that you deal damage to a bleeding, winded, or dying creature',
							value: '1',
						},
					],
				}),
...
Additionally, when your Stamina reaches the negative of your winded value, you become inert instead of dying. You fall prone and can’t stand. You continue to observe your surroundings, but you can’t speak, take main actions, maneuvers, move actions, or triggered actions. While inert this way, if you take any holy damage, or if your body is exposed to sunlight for a long period of time (as decided by the Director, typically a few days), your body is destroyed and you die. Otherwise, after 12 hours, you regain Stamina equal to your recovery value. You can't regain Stamina this way while inert and exposed to sunlight.`,
				...
				ElementFactory.FeatureFactory.createAbility({
					ability: ElementFactory.createAbility({
						...
						sections: [
							ElementFactory.createAbilitySectionText(
								"The target takes corruption damage equal to your level + 2. This damage can't be reduced in any way. You gain temporary Stamina equal to your level + 2."
							),
	...
	abilities: [
		ElementFactory.createAbility({
			...
			sections: [
				...
				ElementFactory.createAbilitySectionText(
					"Slide the target first. You can't slide them beyond your melee distance. Until the start of your next turn, objects (including walls) count as your allies for the purposes of flanking. If the target is flanked, you gain 1 surge which you can use immediately."
				),
			],
		}),
		ElementFactory.createAbility({
		...
		ElementFactory.createAbility({
			...
			sections: [
				...
				ElementFactory.createAbilitySectionText(
					'You shift up to your speed while using this ability. This movement can be broken up before, after, and in between striking each target however you wish.'
				),
			],
		}),
		ElementFactory.createAbility({
			...
			sections: [
				...
				ElementFactory.createAbilitySectionText(
					"If you use this ability as part of the Charge action, you gain an edge. If you don't, you can move up to half your speed before you make the strike. Each enemy adjacent to the target is pushed away from the target up to a number of squares equal to your Presence score."
				),
			],
		}),
		ElementFactory.createAbility({
			...
			sections: [
				...
				ElementFactory.createAbilitySectionText(
					'You gain temporary Stamina equal to your Presence score for each enemy in the area.'
				),
			],
		}),
		ElementFactory.createAbility({
	...
	subclasses: [
		{
			...
			description:
				'You are a master of darkness and shadows do your bidding. You use your dark tools to bind and wound your victims, as well as to escape their retaliation, hide, and patiently wait for the best moment to strike.',
			featuresByLevel: [
				{
					level: 1,
					features: [
...
Some of your abilities have a shroud effect entry. Whenever you use a shroud ability, the ability gains extra effects specified in the shroud entry if you have concealment when using the ability.`,
						...
						ElementFactory.FeatureFactory.createAbility({
							ability: ElementFactory.createAbility({
								...
								sections: [
									ElementFactory.createAbilitySectionText(
										'You teleport up to a number of squares equal to twice your Presence score.'
									),
									ElementFactory.createAbilitySectionSpend({
						...
						ElementFactory.FeatureFactory.createAbility({
							ability: ElementFactory.createAbility({
								...
								sections: [
									ElementFactory.createAbilitySectionText(
										'You take half the triggering damage, then can teleport up to a number of squares equal to your Presence score after the triggering effect resolves.'
									),
									ElementFactory.createAbilitySectionSpend({
										effect: 'You gain concealment until the start of your next turn and automatically become hidden.',
									}),
			...
			abilities: [
				ElementFactory.createAbility({
					...
					sections: [
						...
						ElementFactory.createAbilitySectionText(
							'You can shift up to half your speed after the strike.'
						),
						ElementFactory.createAbilitySectionField({
							name: 'Shroud',
				...
				ElementFactory.createAbility({
					...
					sections: [
						ElementFactory.createAbilitySectionText(
							'You can teleport up to a number of squares equal to 10 + your Presence score. You have concealment until the start of your next turn. After you teleport, you can make a free strike as a free maneuver.'
						),
						ElementFactory.createAbilitySectionField({
							name: 'Shroud',
				...
				ElementFactory.createAbility({
					...
					sections: [
						...
						ElementFactory.createAbilitySectionText(
							'While the target is restrained this way, at the start of each of their turns, they take shadow damage equal to your Presence score.'
						),
					],
				}),
				ElementFactory.createAbility({
					...
					sections: [
						...
						ElementFactory.createAbilitySectionText(
							'Each target standing on the ground takes 1d3 extra damage, and the potency of this ability increases by 1 against them.'
						),
					],
				}),
				ElementFactory.createAbility({
					...
					sections: [
						...
						ElementFactory.createAbilitySectionText(
							"A blind target treats all other creatures and objects as if they are invisible, and doesn't have line of effect to creatures or objects more than 5 squares away. A target made frightened this way is frightened as long as they are blind."
						),
					],
				}),
				ElementFactory.createAbility({
					...
					sections: [
						ElementFactory.createAbilitySectionText(
							'Each target has concealment until the end of the encounter or until you are dying.'
						),
						ElementFactory.createAbilitySectionField({
							name: 'Shroud',
				...
				ElementFactory.createAbility({
					...
					sections: [
						...
						ElementFactory.createAbilitySectionText(
							'Until the end of the encounter or until you are dying, each enemy who enters the area for the first time in a combat round or starts their turn there takes shadow damage equal to your Presence score. In addition, the area blocks line of effect for enemies.'
						),
					],
				}),
				ElementFactory.createAbility({
					...
					sections: [
						...
						ElementFactory.createAbilitySectionText(
							'If you pull the target adjacent to you, you can use a signature ability or your Drink Most Exquisite ability against them as a free maneuver.'
						),
					],
				}),
			],
		...
		},
		{
			...
			name: 'Spore Bearer',
			description:
				'You are a host to innumerable parasites that prey upon both the dead and the living. Infectious spores swirl around you, poisoning and wearing down your victims as well as nourishing and bolstering your allies.',
			featuresByLevel: [
				{
					level: 1,
					features: [
...
Some of your abilities have the Spore keyword. Abilities with the Spore keyword don't need line of effect to affect a target within distance.`,
						...
						ElementFactory.FeatureFactory.createAbility({
							ability: ElementFactory.createAbility({
								...
								sections: [
									ElementFactory.createAbilitySectionText(
										'The size of your Spore Cloud aura increases by 1 until the start of your next turn.'
									),
									ElementFactory.createAbilitySectionSpend({
						...
						ElementFactory.FeatureFactory.createAbility({
							ability: ElementFactory.createAbility({
								...
								type: ElementFactory.AbilityTypeFactory.createTrigger(
									'An enemy targets you or an ally with an ability.'
								),
								keywords: [AbilityKeyword.Area, AbilityKeyword.Magic, AbilityKeyword.Ranged],
								distance: [ElementFactory.DistanceFactory.createRanged(10)],
				...
				},
				{
					...
					features: [
						ElementFactory.FeatureFactory.create({
							...
							description:
								"You can infect plants, fungi and animals with your spores and make them spread throughout the environment. The spores spread at a rate of 1 mile per hour while you actively focus on them and do nothing else. You perceive everything in the area at once. You can hear things happening, but you cannot determine the position, tone, or quality of the sound. You can see things happening, but you can't make out fine details such as the events' surroundings, creatures' facial features, or emblems or insignias. You can influence an area with a radius of up to a number of miles equal to your Presence score. The spreading spores recede after an hour of you not focusing on spreading or maintaining them.",
						}),
					],
				},
				{
			...
			abilities: [
				ElementFactory.createAbility({
					...
					sections: [
						...
						ElementFactory.createAbilitySectionText(
							'The target becomes infected and takes extra poison damage equal to your virulence.'
						),
					],
				}),
				ElementFactory.createAbility({
					...
					distance: [ElementFactory.DistanceFactory.create({ type: AbilityDistanceType.Burst, value: 10 })],
					...
					sections: [
						...
						ElementFactory.createAbilitySectionText(
							'The target takes extra poison damage equal to your virulence. This ability ignores an amount of damage immunity equal to your Presence score.'
						),
					],
				}),
				ElementFactory.createAbility({
					...
					cost: 3,
					sections: [
						ElementFactory.createAbilitySectionText('Each target can spend a Recovery.'),
						ElementFactory.createAbilitySectionField({
							name: 'Virulence 3',
				...
				ElementFactory.createAbility({
					...
					sections: [
						...
						ElementFactory.createAbilitySectionText(
							'This ability ignores an amount of damage immunity equal to your Presence score.'
						),
						ElementFactory.createAbilitySectionField({
							name: 'Virulence 3',
				...
				ElementFactory.createAbility({
					...
					sections: [
						...
						ElementFactory.createAbilitySectionText(
							'An appendage originating from each target can strike the target themselves, a creature adjacent to the target, or not strike at all. After the strike, the appendage withers and dies. Creatures hit with the strike becomes infected. A creature can be hit with only one such strike.'
						),
						ElementFactory.createAbilitySectionField({
							name: 'Virulence 3',
...
If the target is an enemy, the appendage doesn't immediately wither down and is making the target weakened until it is removed by the target or their ally with a maneuver. The appendage withers down and dies at the end of the encounter.`,
				...
				ElementFactory.createAbility({
					...
					sections: [
						ElementFactory.createAbilitySectionText(
							'Each target gains temporary Stamina equal to twice your virulence. While the temporary Stamina persists, they have immunity to acid, cold, corruption, and poison damage equal to your Presence score.'
						),
					],
				}),
				ElementFactory.createAbility({
					...
					sections: [
						ElementFactory.createAbilitySectionText(
							'Each target gains 1 surge and a bonus to speed equal to your Presence score until the end of their next turn.'
						),
						ElementFactory.createAbilitySectionField({
							name: 'Virulence 4',
				...
				ElementFactory.createAbility({
					...
					sections: [
						...
						ElementFactory.createAbilitySectionText(
							"While slowed or restrained this way, at the start of each target's turn, they take damage equal to your Presence score + your virulence."
						),
						ElementFactory.createAbilitySectionField({
							name: 'Virulence 3',
...
const crimsonKnight: KitInterface = {
		...
		ElementFactory.FeatureFactory.createAbility({
			ability: ElementFactory.createAbility({
				...
				sections: [
					...
					ElementFactory.createAbilitySectionText(
						'You gain temporary Stamina equal to your highest characteristic score.'
					),
				],
			}),
		}),
		...
		ElementFactory.FeatureFactory.createAbility({
			ability: ElementFactory.createAbility({
				...
				sections: [
					...
					ElementFactory.createAbilitySectionText(
						'If you target two targets, this ability deals 2 extra damage to both of them. If you target only one target, this ability deals extra damage equal to 3 + your Might or Agility score.'
					),
				],
			}),
		}),
...
const deceptiveAppearance: PerkInterface = {
...
const insidiousMist: PerkInterface = {
	id: 'insidious-mist',
	name: 'Insidious Mist',
	list: PerkList.Special,
	description: `
...
const nightSpeech: PerkInterface = {
	id: 'night-speech',
	name: 'Night Speech',
	list: PerkList.Special,
	description: `
...
const oneWithTheShadows: PerkInterface = {
...
export const triglav: SourcebookInterface = {
	id: 'triglav',
	name: 'Triglav Games',
	description: 'Third-party content from Triglav Games.',
	type: SourcebookType.ThirdParty,
	adventures: [],
	ancestries: [boggit, vampireAncestry],
	careers: [],
	classes: [vampireClass],
	complications: [],
	cultures: [],
	domains: [],
	encounters: [],
	imbuements: [],
	items: [],
	kits: [crimsonKnight, lasher, mangler, slasher],
	monsterGroups: [],
	montages: [],
	negotiations: [],
	perks: [deceptiveAppearance, insidiousMist, nightSpeech, oneWithTheShadows],
	projects: [],
	subclasses: [],
	titles: [],
	skills: [],
