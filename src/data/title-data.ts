...
export class TitleData {
	static ancientLoremaster: TitleInterface = {
	...
	static battleaxeDiplomat: TitleInterface = {
			...
			ElementFactory.FeatureFactory.createAbility({
				ability: ElementFactory.createAbility({
					...
					type: ElementFactory.AbilityTypeFactory.createTrigger(
						'An enemy strikes you while a second creature is flanking you'
					),
					distance: [ElementFactory.DistanceFactory.createSpecial('Adjacent')],
					target: 'One enemy',
					sections: [
						ElementFactory.createAbilitySectionText(
							'You redirect the strike against the second creature. Once you use this benefit, you can’t use it again until you earn 1 or more Victories.'
						),
					],
				}),
			}),
	...
	static dwarfLegionnaire: TitleInterface = {
			...
			ElementFactory.FeatureFactory.createAbility({
				ability: ElementFactory.createAbility({
					...
					type: ElementFactory.AbilityTypeFactory.createManeuver({
						qualifiers: ['Adjacent to a stone wall'],
					}),
					distance: [ElementFactory.DistanceFactory.createSelf()],
					target: 'Self',
					sections: [
						ElementFactory.createAbilitySectionText(
							'You gain concealment. This concealment lasts until you leave the square or use an ability.'
						),
					],
				}),
			}),
	...
	static elementalDabbler: TitleInterface = {
		...
		features: [
			ElementFactory.FeatureFactory.create({
				...
				description:
					'Choose a damage type to which the defeated monster had an immunity. You have the Elementalist 1st-level Hurl Element feature, dealing the chosen damage type.',
			}),
			ElementFactory.FeatureFactory.create({
				id: 'title-elemental-dabbler-2',
				name: 'Elemental Immunity',
				description:
					'Choose a damage type to which the defeated monster had an immunity. You have immunity to the chosen damage type equal to your highest characteristic score.',
			}),
			ElementFactory.FeatureFactory.create({
				id: 'title-elemental-dabbler-3',
				name: 'Elemental Weapons',
				description:
					'Choose a damage type to which the defeated monster had an immunity. Whenever you use a damage-dealing weapon ability, that ability can deal damage of the chosen type instead of its usual damage type.',
			}),
		],
		selectedFeatureID: '',
	};

	static factionMember: TitleInterface = {
...
You find an agent who can provide you with three pieces of information about the settlement you’re in, such as the location of a hidden person, a secret entrance into a guarded area, or the negotiation motivation or pitfall of an important person.`,
	...
	static goldenrod: TitleInterface = {
		id: 'title-goldenrod',
		name: 'Goldenrod',
		description: 'You gain the following benefit.',
		echelon: 1,
	...
	static localHero: TitleInterface = {
		id: 'title-local-hero',
		name: 'Local Hero',
	...
	static mageHunter: TitleInterface = {
		...
		features: [
			...
			ElementFactory.FeatureFactory.createAbility({
				ability: ElementFactory.createAbility({
					...
					type: ElementFactory.AbilityTypeFactory.createTrigger(
						'Target uses an ability with the Magic keyword'
					),
					distance: [ElementFactory.DistanceFactory.createSpecial('Adjacent')],
					target: 'One creature',
					sections: [ElementFactory.createAbilitySectionText('Make a free strike.')],
				}),
			}),
				...
				features: [
					ElementFactory.FeatureFactory.createAbility({
						ability: ElementFactory.createAbility({
							...
							sections: [
								ElementFactory.createAbilitySectionText(
									'Until the end of your next turn, you are aware of whether each target is a construct, an undead, or a creature from another world, and whether they have used a magic ability in the previous hour.'
								),
							],
						}),
					}),
		...
		features: [
			...
			ElementFactory.FeatureFactory.createAbility({
				ability: ElementFactory.createAbility({
					...
					sections: [
						ElementFactory.createAbilitySectionText(
							'You deal yourself 1d6 damage that can’t be reduced in any way. When you do, you ignore difficult terrain and you can increase the distance of any jump you make by 1 square, both until the end of your turn.'
						),
					],
				}),
			}),
	...
	static masterOfReels: TitleInterface = {
		...
		features: [
			ElementFactory.FeatureFactory.create({
				...
				name: 'Master of Reels',
				description:
					'Whenever you deal damage to a target who is 2 or more squares away from you and that target isn’t also force moved, you can pull the target a number of squares equal to your Agility, Reason, or Intuition score (your choice).',
			}),
		],
		selectedFeatureID: '',
	};

	static monsterBane: TitleInterface = {
	...
	static owedAFavor: TitleInterface = {
...
Additionally, the faction is a good source of information. The Director chooses a skill from the crafting or lore skill groups appropriate to the faction, such as the Criminal Underworld skill for an outlaw gang, the Blacksmithing skill for a blacksmith’s guild, or the Society skill for a noble house. While in a settlement where the faction has a presence, you gain this skill if you don’t already have it. If you already have the skill, you instead gain an edge on tests made using the skill.`,
	...
	static presumedDead: TitleInterface = {
...
At a dramatic moment determined by the Director, you rejoin your party with an explanation for your narrow escape, and how you found your new trinket along the way.`,
	...
	static ratcatcher: TitleInterface = {
		id: 'title-ratcatcher',
		name: 'Ratcatcher',
		...
		features: [
			...
			ElementFactory.FeatureFactory.createAbility({
				ability: ElementFactory.createAbility({
					...
					sections: [
						ElementFactory.createAbilitySectionText(
							'Each target who has P < [average] is taunted by you until the end of their next turn, and you know the location of each creature taunted in this way.'
						),
					],
				}),
			}),
	...
	static savedForAWorseFate: TitleInterface = {
	...
	static shipCaptain: TitleInterface = {
	...
	static troupeTactics: TitleInterface = {
		...
		features: [
			ElementFactory.FeatureFactory.createAbility({
				ability: ElementFactory.createAbility({
					...
					name: 'Flying Circus',
					type: ElementFactory.AbilityTypeFactory.createTrigger("During target's turn"),
					distance: [ElementFactory.DistanceFactory.createSpecial('Adjacent')],
					target: 'One ally',
					sections: [
						ElementFactory.createAbilitySectionText(
							'You push the target up to 2 squares if their size is the same as yours, or 4 squares if they are smaller. If this push causes the ally to fall, they can use a maneuver before they fall to reduce the height of the fall by 2.'
						),
					],
				}),
			}),
	...
	static wantedDeadOrAlive: TitleInterface = {
	...
	static zombieSlayer: TitleInterface = {
		...
		features: [
			...
			ElementFactory.FeatureFactory.createAbility({
				ability: ElementFactory.createAbility({
					...
					sections: [
						ElementFactory.createAbilitySectionText(
							'Each target takes holy damage equal to your Reason, Intuition, or Presence score (your choice). Additionally, each target who has P < [strong] is frightened (save ends).'
						),
					],
				}),
			}),
	...
	static arenaFighter: TitleInterface = {
			...
			ElementFactory.FeatureFactory.createAbility({
				ability: ElementFactory.createAbility({
					...
					sections: [
						...
						ElementFactory.createAbilitySectionText(
							'If you kill a non-minion opponent using this ability, each enemy within 3 squares of you is frightened (save ends).'
						),
					],
				}),
			}),
	...
	static awakened: TitleInterface = {
		id: 'title-awakened',
		name: 'Awakened',
		...
		features: [
			...
			ElementFactory.FeatureFactory.createAbility({
				ability: ElementFactory.createAbility({
					...
					sections: [
						ElementFactory.createAbilitySectionText(
							'You communicate telepathically with the target. The targer can respond telepathically as part of the same maneuver.'
						),
					],
				}),
			}),
	...
	static battlefieldCommander: TitleInterface = {
		...
		features: [
			ElementFactory.FeatureFactory.createAbility({
				ability: ElementFactory.createAbility({
					...
					cost: 9,
					sections: [ElementFactory.createAbilitySectionText('Each target can use the Charge main action.')],
				}),
			}),
			ElementFactory.FeatureFactory.createBonus({
	...
	static bloodMagic: TitleInterface = {
	...
	static factionOfficer: TitleInterface = {
	...
	static feyFriend: TitleInterface = {
		id: 'title-fey-friend',
		name: 'Fey Friend',
		description:
	...
	static giantSlayer: TitleInterface = {
		...
		features: [
			...
			ElementFactory.FeatureFactory.createAbility({
				ability: ElementFactory.createAbility({
					...
					sections: [
						...
						ElementFactory.createAbilitySectionText(
							'If the target is size 2 or larger, you gain an edge on this ability.'
						),
					],
				}),
			}),
			ElementFactory.FeatureFactory.create({
				...
				description:
					'You have the Climb skill. If you already have this skill, you instead gain an edge on tests made using the Climb skill. Whileyou’re climbing a creature, the creature has a double bane on strikes against you and you have a double edge on tests made to stay on the creature.',
			}),
		],
		selectedFeatureID: '',
	};

	static godsworn: TitleInterface = {
		id: 'title-godsworn',
		name: 'Godsworn',
		description:
		...
		features: [
			...
			ElementFactory.FeatureFactory.createAbility({
				ability: ElementFactory.createAbility({
					...
					sections: [
						ElementFactory.createAbilitySectionText(
							'You recite a prayer for help, gaining a pool of 2d10 of the Heroic Resource granted by your class. This pool disappears at the end of your turn if you haven’t used it. Once you use this benefit, you can’t use it again until you perform another service for a god or saint, or until you gain a level.'
						),
					],
				}),
			}),
			ElementFactory.FeatureFactory.createMultiple({
				...
				features: [
					ElementFactory.FeatureFactory.createDomainChoice({
						id: 'title-godsworn-3a',
						count: 1,
					}),
					ElementFactory.FeatureFactory.createDomainFeature({
	...
	static heistHero: TitleInterface = {
		id: 'title-heist-hero',
		name: 'Heist Hero',
...
I better watch out for that banana peel!`,
					type: ElementFactory.AbilityTypeFactory.createTrigger(
						'An ally makes a test to lie to, pick the pocket of, hide from, or sneak by the target and doesn’t like the outcome.'
					),
					...
					sections: [
						ElementFactory.createAbilitySectionText(
							'You momentarily attract the target’s notice to let your ally reroll their test. Once you use this ability, you can’t use it again against the same target for 1 hour.'
						),
					],
				}),
			}),
			...
			ElementFactory.FeatureFactory.createAbility({
				ability: ElementFactory.createAbility({
					...
					sections: [
						...
						ElementFactory.createAbilitySectionText(
							'You can end the taunted condition on the target as a free maneuver.'
						),
						ElementFactory.createAbilitySectionText(
							'If you take this title, you might occasionally be called upon to perform duties for the person who knighted you.'
						),
					],
				}),
			}),
	...
	static masterLibrarian: TitleInterface = {
		...
		features: [
			...
			ElementFactory.FeatureFactory.create({
				...
				description:
					'If you start a Discover Lore project in your hero’s stronghold or other a permanent base of operations you immediately gain 60 project points toward the completion of that project. If the project costs 60 or fewer points, you complete it in 10 uninterrupted minutes without needing to use a respite activity.',
			}),
			ElementFactory.FeatureFactory.create({
	...
	static specialAgent: TitleInterface = {
...
* You throw the boffin up to 10 squares, where it explodes in a 5 cube. Each creature in the area takes fire damage equal to 2d10 + your level. The boffin is permanently destroyed but can be replaced by your spymaster … though they don’t like doing so too often.`,
	...
	static swornHunter: TitleInterface = {
		...
		features: [
			ElementFactory.FeatureFactory.createAbility({
				ability: ElementFactory.createAbility({
					...
					sections: [
						ElementFactory.createAbilitySectionText(
							'You swear a hunter’s oath against the target. This oath lasts until the target dies or until you swear a hunter’s oath against a different creature. As long as the hunter’s oath lasts, you magically know the direction to the target if they are within 50 miles of you, and your damage-dealing abilities gain a +5 damage bonus against the target.'
						),
					],
				}),
			}),
	...
	static undeadSlain: TitleInterface = {
...
When you are reduced to 0 Stamina by damage that isn’t fire or holy damage and your body isn’t destroyed, you can regain half your Stamina and fall prone. Once you use this benefit, you can’t use it again until you earn 10 or more Victories.`,
	...
	static unstoppable: TitleInterface = {
	...
	static armedAndDangerous: TitleInterface = {
	...
	static backFromTheGrave: TitleInterface = {
	...
	static demonSlayer: TitleInterface = {
		...
		features: [
			...
			ElementFactory.FeatureFactory.create({
				...
				name: 'Special',
				description:
					'When you make a Presence test and roll a natural 5 or lower, you are cursed to communicate in only Proto-Ctholl for 1 minute, whether you know that language or not.',
			}),
		],
		selectedFeatureID: '',
	};

	static diabolist: TitleInterface = {
		id: 'title-diabolist',
		name: 'Diabolist',
	...
	static dragonBlooded: TitleInterface = {
	...
	static fleetAdmiral: TitleInterface = {
 ...
 *Storm: The crew of an unsheltered wind-powered vessel must make a medium group Reason test. On a failure, the vessel needs repairs and moves at half speed until those repairs are made.`,
			...
			ElementFactory.FeatureFactory.createAbility({
				ability: ElementFactory.createAbility({
					...
					sections: [
						...
						ElementFactory.createAbilitySectionText(
							'The soul of any creature killed by this ability is dragged to Hell.'
						),
					],
				}),
			}),
	...
	static masterCrafter: TitleInterface = {
	...
	static noble: TitleInterface = {
		...
		features: [
			...
			ElementFactory.FeatureFactory.create({
				...
				name: 'Special',
				description:
					'If you take this title, you might occasionally be called upon to perform duties for the person who granted your noble rank.',
			}),
		],
		selectedFeatureID: '',
	};

	static planarVoyager: TitleInterface = {
	...
	static scarred: TitleInterface = {
		...
		features: [
			...
			ElementFactory.FeatureFactory.create({
				...
				name: 'Special',
				description:
					'You can gain this title multiple times. The second and each subsequent time that you gain it, your Stamima maximum doesn’t increase.',
			}),
		],
		selectedFeatureID: '',
	};

	static siegeBreaker: TitleInterface = {
	...
	static championCompetitor: TitleInterface = {
		...
		features: [
			ElementFactory.FeatureFactory.create({
				...
				description:
					'A characteristic used during the competition increases by 1 (to a maximum of 6). Choose a skill you used during the competition. You gain a +4 bonus to tests made using that skill instead of a +2 bonus.',
			}),
			ElementFactory.FeatureFactory.create({
				id: 'title-champion-competitor-2',
				name: 'Glory and Riches',
				description:
					'A characteristic used during the competition increases by 1 (to a maximum of 6). You earn 2 Renown and 1 Wealth.',
			}),
			ElementFactory.FeatureFactory.create({
				id: 'title-champion-competitor-3',
				name: 'I’ll Just Take the Prize',
				description:
					'A characteristic used during the competition increases by 1 (to a maximum of 6). You gain a trinket or leveled treasure of the Director’s choice.',
			}),
		],
		selectedFeatureID: '',
	};

	static demigod: TitleInterface = {
		id: 'title-demigod',
		name: 'Demigod',
	...
	static enlightened: TitleInterface = {
		...
		features: [
			ElementFactory.FeatureFactory.create({
				...
				description:
					'Your choice of your Reason or Intuition increases by 1 (to a maximum of 6). When you make a test with a skill from the lore skill group and obtain a tier 1 or tier 2 outcome, you can instead obtain a tier 3 outcome. Once you use this benefit, you can’t use it again until you earn 1 or more Victories.',
			}),
			ElementFactory.FeatureFactory.create({
				id: 'title-enlightened-2',
				name: 'Longevity',
				description:
					'Your choice of your Reason or Intuition increases by 1 (to a maximum of 6). Whenever you spend a Recovery, you can end one condition on yourself.',
			}),
			ElementFactory.FeatureFactory.create({
				id: 'title-enlightened-3',
				name: 'Worshippers',
				description:
					'Your choice of your Reason or Intuition increases by 1 (to a maximum of 6). You can reach behind the curtain and alter reality. At the start of combat, choose yourself or any creature within 5 squares. The chosen target must move up to their speed to a space you choose, but can’t enter damaging terrain or terrain that could impose a condition on them. The target doesn’t appear to move or teleport to that space—they are simply there. No one but you has any memory of the target’s previous position.',
			}),
		],
		selectedFeatureID: '',
	};

	static forsaken: TitleInterface = {
		id: 'title-forsaken',
		name: 'Forsaken',
		description:
		...
		features: [
			ElementFactory.FeatureFactory.create({
				...
				name: 'Brief Reunion',
				description:
					'A characteristic of your choice increases by 1 (to a maximum of 6). While you’re winded, you can use a maneuver to summon the artifact to your hand. It disappears at the end of your next turn. Once you use this benefit, you can’t use it again until you earn 1 or more Victories.',
			}),
			ElementFactory.FeatureFactory.create({
				id: 'title-forsaken-2',
				name: 'Perfect Protection',
				description:
					'A characteristic of your choice increases by 1 (to a maximum of 6). The Director chooses a damage type that is dealt by or thematically related to the artifact—for instance, holy for the Blade of a Thousand Years, psychic for the Encepter, or corruption for the Mortal Coil. You have immunity all to the chosen damage type.',
			}),
			ElementFactory.FeatureFactory.create({
				id: 'title-forsaken-3',
	...
	static monarch: TitleInterface = {
		...
		features: [
			ElementFactory.FeatureFactory.create({
				...
				name: 'Crown Jewels',
				description:
					'Inhabitants of your nation must obey your lawful orders or suffer the consequences. Your choice of your Might or Presence increases by 1 (to a maximum of 6). You gain one of your nation’s treasures—a trinket of the Director’s choice.',
			}),
			ElementFactory.FeatureFactory.create({
				id: 'title-monarch-2',
				name: 'Royal Fame',
				description:
					'Inhabitants of your nation must obey your lawful orders or suffer the consequences. Your choice of your Might or Presence increases by 1 (to a maximum of 6). You earn 2 Renown.',
			}),
			ElementFactory.FeatureFactory.create({
				id: 'title-monarch-3',
				name: 'Royal Retinue',
				description:
					'Inhabitants of your nation must obey your lawful orders or suffer the consequences. Your choice of your Might or Presence increases by 1 (to a maximum of 6). The number of followers you can recruit increases by 2.',
			}),
			ElementFactory.FeatureFactory.create({
				id: 'title-monarch-4',
				name: 'Royal Wealth',
				description:
					'Inhabitants of your nation must obey your lawful orders or suffer the consequences. Your choice of your Might or Presence increases by 1 (to a maximum of 6). You earn 2 Wealth.',
			}),
		],
		selectedFeatureID: '',
	};

	static peaceBringer: TitleInterface = {
		...
		features: [
			ElementFactory.FeatureFactory.create({
				...
				description:
					'Your choice of your Reason or Presence increases by 1 (to a maximum of 6). When you make a test to stop combat and start a negotiation, you always obtain a tier 3 outcome.',
			}),
			ElementFactory.FeatureFactory.create({
				id: 'title-peace-bringer-2',
				name: 'Drop Your Sword',
				description:
					'Your choice of your Reason or Presence increases by 1 (to a maximum of 6). When you succeed on a test using the Intimidate skill, you can cause affected creatures to drop any items they are holding.',
			}),
			ElementFactory.FeatureFactory.create({
				id: 'title-peace-bringer-3',
				name: 'Hear Me Out',
				description:
					'Your choice of your Reason or Presence increases by 1 (to a maximum of 6). While you are present in a negotiation, an NPC’s starting patience increases by 3 (to a maximum of 5).',
			}),
			ElementFactory.FeatureFactory.create({
				id: 'title-peace-bringer-4',
				name: 'Many Paths to Peace',
				description:
					'Your choice of your Reason or Presence increases by 1 (to a maximum of 6). When you make a test with a skill from the interpersonal skill group, you can use any characteristic of your choice for the test.',
			}),
		],
		selectedFeatureID: '',
	};

	static theoreticalWarrior: TitleInterface = {
		...
		features: [
			ElementFactory.FeatureFactory.create({
				...
				name: 'Effect',
				description:
					'Your choice of your Reason or Intuition increases by 1 (to a maximum of 6). Additionally, choose a heroic ability belonging to any class. You gain this heroic ability, which can be paid for using the Heroic Resource of your class. You can’t use a heroic ability that requires a class feature you don’t have.',
			}),
		],
		selectedFeatureID: '',
	};

	static tireless: TitleInterface = {
		id: 'title-tireless',
		name: 'Tireless',
		...
		features: [
			ElementFactory.FeatureFactory.create({
				...
				description:
					'Your choice of your Might or Agility increases by 1 (to a maximum of 6). Whenever you rest for 8 hours or more, you can gain the benefit of a respite. Once you use this benefit, you can’t use it again until you have taken a regular respite.',
			}),
			ElementFactory.FeatureFactory.create({
				id: 'title-tireless-2',
				name: 'Reserves of Strength',
				description:
					'Your choice of your Might or Agility increases by 1 (to a maximum of 6). Your recovery value is half your Stamina.',
			}),
			ElementFactory.FeatureFactory.create({
				id: 'title-tireless-3',
				name: 'Undying',
				description:
					'Your choice of your Might or Agility increases by 1 (to a maximum of 6). You can’t be affected by the bleeding condition.',
			}),
		],
		selectedFeatureID: '',
	};

	static unchained: TitleInterface = {
		id: 'title-unchained',
		name: 'Unchained',
		...
		features: [
			ElementFactory.FeatureFactory.create({
				...
				name: 'Bye-Bye',
				description:
					'Your choice of your Might or Agility increases by 1 (to a maximum of 6). You can use a maneuver to teleport yourself and each willing ally within 5 squares of you to new positions within 10 squares of your original starting point. Once you use this benefit, you can’t use it again until you earn 1 or more Victories.',
			}),
			ElementFactory.FeatureFactory.create({
				id: 'title-unchained-2',
				name: 'Laughs at Locks',
				description:
					'Your choice of your Might or Agility increases by 1 (to a maximum of 6). Whenever you make a test to open a lock or break a restraint, you don’t need any tools and you automatically obtain a tier 3 outcome.',
			}),
			ElementFactory.FeatureFactory.create({
				id: 'title-unchained-3',
				name: 'Slippery',
				description:
					'Your choice of your Might or Agility increases by 1 (to a maximum of 6). You can’t be grabbed against your will.',
			}),
		],
		selectedFeatureID: '',
	};
	...
	static safeguarded: TitleInterface = {
...
**Special**: If two or more heroes in the party have this title from the same source, the party starts combat encounters with a squad of six minions instead. At the start of each round of combat, the heroes decide who controls the squad as a part of their turn.`,
	...
	static sigilwright: TitleInterface = {
		...
		features: [
			ElementFactory.FeatureFactory.create({
				...
				name: 'Quick Gate',
				description:
					'As a maneuver, you can etch an arcane circle in an adjacent square on the ground. Until the end of the encounter, you can use magic abilities and treat your Summoner’s Range as if you were in that space. Each time you etch an arcane circle, your last circle fades and becomes inactive.',
			}),
			ElementFactory.FeatureFactory.create({
				id: 'title-sigilwright-2',
				name: 'Ritual Circle',
				description:
					'As a respite activity, you can draw a minor summoning circle to temporarily call forth a creature you’ve contacted previously, regardless of manifold. If the creature is willing and able to answer your call, they appear to you for the remainder of the respite. You can ask the creature for information or a service in exchange for ending the respite with two fewer Recoveries or a demand of their choosing. If the creature doesn’t appear, you can choose to take a different respite activity.',
			}),
			ElementFactory.FeatureFactory.create({
				id: 'title-sigilwright-3',
				name: 'Sigil Eye',
				description:
					'You have an edge on tests made to identify summoning circles and who or where they’re connected to. You also have an edge on strikes made against creatures not native to the manifold in which you’re currently located.',
			}),
		],
		selectedFeatureID: '',
	};

	static summonerSuccessor: TitleInterface = {
		...
		echelon: 2,
		prerequisites:
			'You can’t use the Call Forth ability, and you defeat a leader or solo creature with a Summon or Call Forth ability, such as a high elf ordinator.',
		features: [
			ElementFactory.FeatureFactory.create({
...
Additionally, you can summon up to two of your signature minion while outside of combat to do simple tasks.`,
	...
	static ringleader: TitleInterface = {
		id: 'title-ringleader',
		name: 'Ringleader',
	...
	static delegator: TitleInterface = {
		id: 'title-delegator',
		name: 'Delegator',
...
If your champion would die while taking your place, you lose access to your Return to the Source feature and can only summon signature minions until you revive your champion as a respite activity.`,
	...
	static highSummoner: TitleInterface = {
		id: 'title-high-summoner',
		name: 'High Summoner of the Circle',
		description: 'As I was taught, so I pass on to you.',
		echelon: 4,
		prerequisites:
			'You are a summoner, and you teach someone how to call forth two or more minions from your portfolio.',
		features: [
			ElementFactory.FeatureFactory.createMultiple({
				...
				features: [
					ElementFactory.FeatureFactory.create({
						...
						name: 'Effect',
						description:
							'You are considered a master that can be learned from using the Learn from a Master downtime project. Anyone that makes a project roll using you as the source gains a bonus to their roll equal to your Reason.',
					}),
					ElementFactory.FeatureFactory.createChoice({
						...
						options: [
							...
							},
							{
								feature: ElementFactory.FeatureFactory.create({
									...
									description:
										'Your Summoner’s Range increases by 5. You can use your minions’ senses as your own as long as they’re on the same manifold as you.',
								}),
								value: 1,
							},
							{
								feature: ElementFactory.FeatureFactory.create({
									...
									description:
										'Select a 3-Essence minion you can call forth. At the start of each of your turns in combat, you summon the set number of minions listed on the stat block in place of your signature minions at no cost.',
								}),
								value: 1,
							},
						],
